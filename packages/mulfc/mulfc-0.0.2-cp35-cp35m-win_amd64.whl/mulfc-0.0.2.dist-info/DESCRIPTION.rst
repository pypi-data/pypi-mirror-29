...
Description: Î¼LFC
        ...
        Î¼LFC is a small library to facilitate the evaluation of the local field
        ...
        The Î¼LFC C library has no dependencies. CMake is used as a building tool.
        ...
        * Python 2.7 âžœ Numpy 1.8+
        * Python 3.5 âžœ Numpy 1.10+
        * Python 3.6 âžœ Numpy 1.12+
