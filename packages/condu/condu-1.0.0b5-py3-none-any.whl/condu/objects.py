...
class WorkflowTaskDef(object):
    def __init__(self, name: str, task_reference: str, description: str, input_parameters: dict,
        ...
        self.taskReferenceName = task_reference
...
class SubWorkflowTaskDef(WorkflowTaskDef):
    def __init__(self, name: str, task_reference: str, description: str, input_parameters: dict, optional: bool = False,
                 c3_type: str = 'SUB_WORKFLOW') -> None:
...
class DynamicForkTaskDef(WorkflowTaskDef):
    def __init__(self, name: str, task_reference: str, description: str, input_parameters: dict, optional: bool = False,
                 c3_type: str = 'FORK_JOIN_DYNAMIC') -> None:
        super().__init__(name, task_reference, description, input_parameters, optional, c3_type)
    ...
    def get_dict(self) -> dict:
        _dict = super().get_dict()
        _dict['dynamicForkTasksParam'] = [task.get_dict() for task in self.dynamicForkTasksParam]
