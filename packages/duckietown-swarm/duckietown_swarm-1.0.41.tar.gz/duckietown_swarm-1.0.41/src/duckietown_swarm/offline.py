...
from duckietown_swarm.ipfs_utils import Timeout
from duckietown_swarm.irc2 import MessagingInterface
import sys
...
#        print('waiting for summary')
        envelopes = mi.get_many_for_me(timeout=5)
...
#            print envelope
            ...
            try:
                data = ipfsi.get(data_mh, timeout='10s')
            except Timeout:
