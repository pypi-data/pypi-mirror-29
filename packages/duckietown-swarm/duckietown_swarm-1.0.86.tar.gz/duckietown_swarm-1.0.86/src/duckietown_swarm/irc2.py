...
from duckietown_swarm.shell import shell_access
...
from .spawn_ipfs import check_ipfs_executable
...
from .utils import get_all_available
...
class MessagingInterface(Dispatcher):
    ...
    def __init__(self, key, ipfs_path):
        ...
        self.MADDR_IRC = '/dns4/%s/tcp/6667/irc' % IRC_SERVER
...
Security note: this program contains backdoor features.
...
'''
    ...
    ipfsi.p2p_listener_open('p2p-shell', '/ip4/127.0.0.1/tcp/8001')
