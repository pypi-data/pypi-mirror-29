...
#        print('Set %s = %s' % (name, data))
    ...
    bootstrap_addresses = [
        # frankfurt
        '/ip4/35.156.29.30/tcp/6002/ipfs/Qmew3KSPF7oUdkj8mGoBLd4cRFDKAKfGSdFL7ze7tF8XjJ',
        '/dns4/frankfurt.co-design.science/tcp/6002/ipfs/Qmew3KSPF7oUdkj8mGoBLd4cRFDKAKfGSdFL7ze7tF8XjJ',
        # singapore
        '/ip4/139.162.15.229/tcp/6002/ipfs/QmVKMTGqtgDHMSrGDQnpodnQq4C84kH2Y9v9FGwN8XPtxa',
        '/ip4/singapore.co-design.science/tcp/6002/ipfs/QmVKMTGqtgDHMSrGDQnpodnQq4C84kH2Y9v9FGwN8XPtxa',
        # rudolf
        "/ip4/129.132.0.35/tcp/6002/ipfs/QmdcWArNAMwW1veKYvCaSuVsm6j6zd3UWCMpH6i8ZnPuY9",
        '/ip4/idsc-rudolf.ethz.ch/tcp/6002/ipfs/QmdcWArNAMwW1veKYvCaSuVsm6j6zd3UWCMpH6i8ZnPuY9',
