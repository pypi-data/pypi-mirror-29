...
from duckietown_swarm.dcache_wire import create_propose_message, put_in_queue
...
def directory_watcher(watch_dir, stream_name, queue):
    seen = {}
    ...
    def look_for_files(d, pattern='*'):
        ...
        for f in filenames:
            ...
            if not f in seen:
                ...
                msg = create_propose_message('files', hashed)
                put_in_queue(queue, (stream_name, msg))
