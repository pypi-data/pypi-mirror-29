...
def pubsub_friendship(stream_name, to_brain):
...
#    token = res.stdout.strip()
    ...
    while True:
        ...
        for h in hosts:
            ...
            put_in_queue(to_brain, (stream_name, create_propose_message('peer', h, interval)))
            ...
            if ok:
                ...
                put_in_queue(to_brain, (stream_name, msg))
