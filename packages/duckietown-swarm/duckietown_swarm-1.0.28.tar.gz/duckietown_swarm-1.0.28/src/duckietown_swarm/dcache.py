...
class Envelope(object):
    ...
    def __init__(self, maddr_from, maddr_to, contents):
        self.maddr_from = maddr_from
        self.maddr_to = maddr_to
        self.contents = contents

    def __repr__(self):
        return 'Envelope(from: %s, to: %s, %s)' % (self.maddr_from if self.maddr_from else '@',
        ...
        for data in datas:
            ...
            for channel in channels:
                ...
                if need_update:
                    ...
                    options.append((last, Envelope('', channel, msg)))
