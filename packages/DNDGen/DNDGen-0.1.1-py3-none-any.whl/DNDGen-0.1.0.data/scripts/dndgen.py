...
if __name__ == '__main__':
    names = yaml.safe_load(open('default_names.yml'))
    ...
    p = Player(name=args.name, namelist=names.get('Names'), charisma=args.charisma, wisdom=args.wisdom, dexterity=args.dexterity, health=args.health, intelligence=args.intelligence, strength=args.strength, constitution=args.constitution)
    print(p)
