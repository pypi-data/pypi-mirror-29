...
if __name__ == '__main__':
    ...
    p = Player(name=args.name, charisma=args.charisma, wisdom=args.wisdom, dexterity=args.dexterity, health=args.health, intelligence=args.intelligence, strength=args.strength, constitution=args.constitution)
    print(p)
