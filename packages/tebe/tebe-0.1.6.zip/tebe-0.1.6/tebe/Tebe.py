...
class MainWindow(QtGui.QMainWindow):
    ...
    def setupActions(self):
        ...
        self.saveAsAction = QtGui.QAction(QtGui.QIcon(abspath("icons/save_as.png")), "Save File As", self)
        self.saveAsAction.setShortcut("Ctrl+Shift+S")
        self.saveAsAction.setStatusTip("It saves current file with new name")
        self.saveAsAction.triggered.connect(self.saveFileAs)

        self.autoSaveAction = QtGui.QAction(QtGui.QIcon(abspath("icons/auto.png")), "Auto save", self, checkable=True)
        self.autoSaveAction.setStatusTip("If pushed file will always be saved before closing")   

        self.newAction = QtGui.QAction(QtGui.QIcon(abspath("icons/new.png")), "New File", self)
        ...
        self.sphinx_buildPDFAction = QtGui.QAction(QtGui.QIcon(abspath("icons/pdf_sphinx.png")), "Sphinx PDF build", self)
        ...
        self.sphinx_createIndexFile = QtGui.QAction(QtGui.QIcon(abspath("icons/index.png")), "Create index file", self)
        ...
        self.sphinx_theme = QtGui.QAction(QtGui.QIcon(abspath("icons/theme.png")), "Select sphinx theme", self)
        ...
        self.this_buildPDFAction = QtGui.QAction(QtGui.QIcon(abspath("icons/pdf_this.png")), "Current file to PDF", self)
        ...
        self.printAction = QtGui.QAction(QtGui.QIcon(abspath("icons/print.png")), "Print current file preview", self)
        ...
        self.PreviewRefreshAction = QtGui.QAction(QtGui.QIcon(abspath("icons/refresh_preview.png")), "Refresh current file preview", self)
        ...
        self.synchronizeScrollsSwitch = QtGui.QAction(QtGui.QIcon(abspath("icons/scroll.png")), "Synchronize scrolls", self, checkable=True)
        self.synchronizeScrollsSwitch.setStatusTip("If pushed editor and live preview scrolls will be synchronized") 
    
        self.autoPreviewRefreshAction = QtGui.QAction(QtGui.QIcon(abspath("icons/auto.png")), "Current file preview auto refresh", self, checkable=True)
        ...
        self.helpAction = QtGui.QAction(QtGui.QIcon(abspath("icons/help.png")), "Learn about..", self)
    ...
    def saveFile(self):
        if Document.has_data():
            ...
            text_in_editor = unicode(text_in_editor)
    ...
    def newFile(self):
        ...
        file_path = QtGui.QFileDialog.getSaveFileName(  caption = 'New markup file',
                                                        directory = directory,
                                                        filter = "Markup File (*.rst *.md)")
        if file_path:
            file_path = str(file_path)
    ...
    def buildHTML(self):
        ...
        if Content.is_ready_to_build():
            ...
            QtGui.QMessageBox.information(None, 'Info', 'No data to sphinx build - try to open some sphinx content')
    ...
    def buildPDF(self):
        ...
        if Content.is_ready_to_build():
            ...
            file_path = QtGui.QFileDialog.getSaveFileName(  caption = 'New pdf file',
    ...
    def build_this_PDF(self):
        if Document.is_rst_file():
            ...
            pdf_file_path = QtGui.QFileDialog.getSaveFileName(  caption = 'New pdf file',
                                                                directory = init_directory,
                                                                filter = "Pdf file (*.pdf)")
            ...
            QtGui.QMessageBox.information(None, 'Info', 'This option available only for rst file')
            
    def create_index_file(self):
        if Content.index_file_path:
            reply = QtGui.QMessageBox.question(None, "Index file already exist!",
            ...
            reply = QtGui.QMessageBox.question(None, "Index file will be created!",
    ...
    def custom_theme(self):
        ...
        theme_selected = QtGui.QInputDialog.getItem(None, 'Sphinx theme', 'Select theme for sphinx build', available_theme_list, current_theme_index , False)[0]
        ...
        if Content.conf_file_path:
            QtGui.QMessageBox.information(None, 'Info', 'Please not that you already have theme defined by conf.py file in your project folder. Tebe build in theme will be not used!')  
        #---Sphinx rebuilt
        if SphinxBuilder.is_html_builded():
            self.buildHTML()
    ...
    def directPrint(self):
        ...
        if dialog.exec_() == QtGui.QDialog.Accepted:
            self.CurrentFilePreview.print_(dialog.printer())
    ...
    def help(self):
        ...
        topic_selected = QtGui.QInputDialog.getItem(None, 'Help content', 'Select topic', available_topics, 0 , False)[0]
    ...
    def scrols_load_position_from_archive(self):
        if window.scrolls_data.has_key(Document.file_path):
...
def main():
    ...
    #window.openFile('/home/lul/Desktop/SOURCE_TEBE/source/tests/example_sphinx_dir_content/index.rst')
    sys.exit(app.exec_())
