...
api_instance = cythereal_magic.CytherealMagicApi()
...
try:
    ...
    api_response = api_instance.create_category(file_hash, category)
    pprint(api_response)
except ApiException as e:
    print("Exception when calling CytherealMagicApi->create_category: %s\n" % e)
