...
To install CPF Validator, run this command in your terminal:

.. code-block:: console

    $ pip install vm_cpf_validator

This is the preferred method to install CPF Validator, as it will always install the most recent stable release.
...
The sources for CPF Validator can be downloaded from the `Github repo`_.
