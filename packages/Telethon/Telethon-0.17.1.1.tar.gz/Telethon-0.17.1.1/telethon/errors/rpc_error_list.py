...
class AdminsTooMuchError(BadRequestError):
    def __init__(self, **kwargs):
        super(Exception, self).__init__(self, 'Too many admins')
...
class ApiIdPublishedFloodError(BadRequestError):
    def __init__(self, **kwargs):
        super(Exception, self).__init__(self, "This API id was published somewhere, you can't use it now")
...
class BotChannelsNaError(BadRequestError):
    def __init__(self, **kwargs):
        super(Exception, self).__init__(self, "Bots can't edit admin privileges")
...
class ChannelsAdminPublicTooMuchError(BadRequestError):
    def __init__(self, **kwargs):
        super(Exception, self).__init__(self, "You're admin of too many public channels, make some channels private to change the username of this channel")
...
class ChatAboutTooLongError(BadRequestError):
    def __init__(self, **kwargs):
        super(Exception, self).__init__(self, 'Chat about too long')
...
class ConnectionDeviceModelEmptyError(BadRequestError):
    def __init__(self, **kwargs):
        super(Exception, self).__init__(self, 'Device model empty')
...
class ConnectionNotInitedError(BadRequestError):
    def __init__(self, **kwargs):
        super(Exception, self).__init__(self, 'Connection not initialized')


class ConnectionSystemEmptyError(BadRequestError):
    def __init__(self, **kwargs):
        super(Exception, self).__init__(self, 'Connection system empty')
...
class EmailUnconfirmedError(BadRequestError):
    def __init__(self, **kwargs):
        super(Exception, self).__init__(self, 'Email unconfirmed')
...
class EncryptionDeclinedError(BadRequestError):
    def __init__(self, **kwargs):
        super(Exception, self).__init__(self, 'The secret chat was declined')
...
class ExternalUrlInvalidError(BadRequestError):
    def __init__(self, **kwargs):
        super(Exception, self).__init__(self, 'External URL invalid')
...
class GroupedMediaInvalidError(BadRequestError):
    def __init__(self, **kwargs):
        super(Exception, self).__init__(self, 'Invalid grouped media')
...
class MediaInvalidError(BadRequestError):
    def __init__(self, **kwargs):
        super(Exception, self).__init__(self, 'Media invalid')
...
class PackShortNameOccupiedError(BadRequestError):
    def __init__(self, **kwargs):
        super(Exception, self).__init__(self, 'A stickerpack with this name already exists')
...
class PhotoInvalidError(BadRequestError):
    def __init__(self, **kwargs):
        super(Exception, self).__init__(self, 'Photo invalid')
...
class StickerEmojiInvalidError(BadRequestError):
    def __init__(self, **kwargs):
        super(Exception, self).__init__(self, 'Sticker emoji invalid')


class StickerFileInvalidError(BadRequestError):
    def __init__(self, **kwargs):
        super(Exception, self).__init__(self, 'Sticker file invalid')
...
class StickerPngDimensionsError(BadRequestError):
    def __init__(self, **kwargs):
        super(Exception, self).__init__(self, 'Sticker png dimensions invalid')
...
class WcConvertUrlInvalidError(BadRequestError):
    def __init__(self, **kwargs):
        super(Exception, self).__init__(self, 'WC convert URL invalid')
...
class WebpageMediaEmptyError(BadRequestError):
    def __init__(self, **kwargs):
        super(Exception, self).__init__(self, 'Webpage media empty')
...
class MemberNoLocationError(ServerError):
    def __init__(self, **kwargs):
        super(Exception, self).__init__(self, "An internal failure occurred while fetching user info (couldn't find location)")
