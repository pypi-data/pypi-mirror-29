...
from beatle.tran import TransactionStack, TransactionalMethod, GetCurrentTransactionName, SetCurrentTransactionName
...
class ModelsView(BaseView, ui.ModelsView):
    ...
    _editOpen = Identifiers.register("ID_EDIT_OPEN")
    _editContext = Identifiers.register("ID_EDIT_CONTEXT")
    _editUserSections = Identifiers.register("ID_EDIT_USER_SECTIONS")
    ...
    def can_paste(self):
        ...
        if not selected or clipboard.info != CLIP_FORMAT_MODEL:
            return False
        data = clipboard.data
        if selected.project and getattr(selected.project, "_language",True) != getattr(data, 'lang', False):
            return False
        if data.lang == 'python':
    ...
    def can_edit_user_sections(self):
        ...
        if not selected or selected.read_only:
            return False
        return type(selected) in [model.cc.Class, model.py.Class, model.cc.Module]
    ...
    def _create_menus(self):
        ...
        self._addFolder.SetBitmap(wx.Bitmap(localpath("app/res/folder.xpm"), wx.BITMAP_TYPE_ANY))
        ...
        self._addClassDiagram.SetBitmap(wx.Bitmap(localpath("app/res/classdiagram.xpm"), wx.BITMAP_TYPE_ANY))
        ...
        self._addModule.SetBitmap(wx.Bitmap(localpath("app/res/module.xpm"), wx.BITMAP_TYPE_ANY))
        ...
        self._addNamespace.SetBitmap(wx.Bitmap(localpath("app/res/namespace.xpm"), wx.BITMAP_TYPE_ANY))
        ...
        self._addType.SetBitmap(wx.Bitmap(localpath("app/res/type.xpm"), wx.BITMAP_TYPE_ANY))
        ...
        self._addEnum.SetBitmap(wx.Bitmap(localpath("app/res/enum.xpm"), wx.BITMAP_TYPE_ANY))
        ...
        self._addClass.SetBitmap(wx.Bitmap(localpath("app/res/class.xpm"), wx.BITMAP_TYPE_ANY))
        ...
        self._addInheritance.SetBitmap(wx.Bitmap(localpath("app/res/inheritance.xpm"), wx.BITMAP_TYPE_ANY))
        ...
        self._setFriendship.SetBitmap(wx.Bitmap(localpath("app/res/friend.xpm"), wx.BITMAP_TYPE_ANY))
        ...
        self._addMember.SetBitmap(wx.Bitmap(localpath("app/res/argument.xpm"), wx.BITMAP_TYPE_ANY))
        ...
        self._addConstructor.SetBitmap(wx.Bitmap(localpath("app/res/constructor.xpm"), wx.BITMAP_TYPE_ANY))
        ...
        self._addMethod.SetBitmap(wx.Bitmap(localpath("app/res/method.xpm"), wx.BITMAP_TYPE_ANY))
        ...
        self._addDestructor.SetBitmap(wx.Bitmap(localpath("app/res/destructor.xpm"), wx.BITMAP_TYPE_ANY))
        ...
        self._addArgument.SetBitmap(wx.Bitmap(localpath("app/res/argument.xpm"), wx.BITMAP_TYPE_ANY))
        ...
        self._addFunction.SetBitmap(wx.Bitmap(localpath("app/res/function.xpm"), wx.BITMAP_TYPE_ANY))
        ...
        self._addVariable.SetBitmap(wx.Bitmap(localpath("app/res/data.xpm"), wx.BITMAP_TYPE_ANY))
        ...
        self._addVirtualMethod.SetBitmap(wx.Bitmap(localpath("app/res/virtual.xpm"), wx.BITMAP_TYPE_ANY))
        ...
        self._addIsclassMethod.SetBitmap(wx.Bitmap(localpath("app/res/is_class.xpm"), wx.BITMAP_TYPE_ANY))
        self._menuAddCCGenerators.AppendItem(self._addIsclassMethod)

        self._addRelation = wx.MenuItem(self._menuAddCCGenerators, ID_ADD_RELATION,
            u"Relation ...\tCtrl+Alt+R", u"add relation", wx.ITEM_NORMAL)
        self._addRelation.SetBitmap(wx.Bitmap(localpath("app/res/relation.xpm"), wx.BITMAP_TYPE_ANY))
        ...
        self._applyRule3.SetBitmap(wx.Bitmap(localpath("app/res/tres.xpm"), wx.BITMAP_TYPE_ANY))
        ...
        self._pyboostInterface.SetBitmap(wx.Bitmap(localpath("app/res/pyboost.xpm"), wx.BITMAP_TYPE_ANY))
        ...
        self._projectContexts.SetBitmap(wx.Bitmap(localpath("app/res/context.xpm"), wx.BITMAP_TYPE_ANY))
        ...
        self._projectLibraries.SetBitmap(wx.Bitmap(localpath("app/res/library.xpm"), wx.BITMAP_TYPE_ANY))
        ...
        self._addPyPackage.SetBitmap(wx.Bitmap(localpath("app/res/py_package.xpm"), wx.BITMAP_TYPE_ANY))

        self._menuAddPython.AppendItem(self._addPyPackage)
        self._addPyModule = wx.MenuItem(self._menuAddPython, self._menuAddPythonId,
            u"Module ...\tShift+Ctrl+M", u"add module", wx.ITEM_NORMAL)
        self._addPyModule.SetBitmap(wx.Bitmap(localpath("app/res/py_module.xpm"), wx.BITMAP_TYPE_ANY))
        ...
        self._addImportFolder.SetBitmap(wx.Bitmap(localpath("app/res/folderI.xpm"), wx.BITMAP_TYPE_ANY))
        ...
        self._addPyImport.SetBitmap(wx.Bitmap(localpath("app/res/import.xpm"), wx.BITMAP_TYPE_ANY))
        self._menuAddPython.AppendItem(self._addPyImport)

        self._addPyClass = wx.MenuItem(self._menuAddPython, self._addPyClassId,
            u"Class ...\tCtrl+Alt+C", u"add class", wx.ITEM_NORMAL)
        self._addPyClass.SetBitmap(wx.Bitmap(localpath("app/res/py_class.xpm"), wx.BITMAP_TYPE_ANY))
        ...
        self._addPyInheritance = wx.MenuItem(self._menuAddPython, self._addPyInheritanceId,
            u"Inheritance ...\tCtrl+Alt+I", u"add inheritance", wx.ITEM_NORMAL)
        self._addPyInheritance.SetBitmap(wx.Bitmap(localpath("app/res/py_inheritance.xpm"), wx.BITMAP_TYPE_ANY))
        ...
        self._addPyInit.SetBitmap(wx.Bitmap(localpath("app/res/py_init.xpm"), wx.BITMAP_TYPE_ANY))
        self._menuAddPython.AppendItem(self._addPyInit)

        self._addPyMethod = wx.MenuItem(self._menuAddPython, self._addPyMethodId,
            u"Method ...\tCtrl+Alt+F", u"add method", wx.ITEM_NORMAL)
        self._addPyMethod.SetBitmap(wx.Bitmap(localpath("app/res/py_method.xpm"), wx.BITMAP_TYPE_ANY))
        ...
        self._addPyArgument = wx.MenuItem(self._menuAddPython, self._addPyArgumentId,
            u"Argument ...\tCtrl+Shift+A", u"add argument", wx.ITEM_NORMAL)
        self._addPyArgument.SetBitmap(wx.Bitmap(localpath("app/res/py_argument.xpm"), wx.BITMAP_TYPE_ANY))
        ...
        self._addargs.SetBitmap(wx.Bitmap(localpath("app/res/py_args.xpm"), wx.BITMAP_TYPE_ANY))
        ...
        self._addkwargs.SetBitmap(wx.Bitmap(localpath("app/res/py_kwargs.xpm"), wx.BITMAP_TYPE_ANY))
        self._menuAddPython.AppendItem(self._addkwargs)

        self._addPyMember = wx.MenuItem(self._menuAddPython, self._addPyMemberId,
            u"Member ...\tCtrl+Alt+M", u"add member", wx.ITEM_NORMAL)
        self._addPyMember.SetBitmap(wx.Bitmap(localpath("app/res/py_member.xpm"), wx.BITMAP_TYPE_ANY))
        ...
        self._addPyFunction = wx.MenuItem(self._menuAddPython, self._addPyFunctionId,
            u"Function ...\tCtrl+F", u"add function", wx.ITEM_NORMAL)
        self._addPyFunction.SetBitmap(wx.Bitmap(localpath("app/res/py_function.xpm"), wx.BITMAP_TYPE_ANY))
        ...
        self._addPyVariable = wx.MenuItem(self._menuAddPython, self._addPyVariableId,
            u"Variable ...\tCtrl+Alt+V", u"add variable", wx.ITEM_NORMAL)
        self._addPyVariable.SetBitmap(wx.Bitmap(localpath("app/res/py_variable.xpm"), wx.BITMAP_TYPE_ANY))
        ...
        self._editDecorators.SetBitmap(wx.Bitmap(localpath("app/res/decorator.xpm"), wx.BITMAP_TYPE_ANY))
    ...
    def _set_accelerators(self):
        ...
        #overload menu accelerators
            ...
            wx.AcceleratorEntry(ctrl_shf, ord('R'), ID_ADD_RELATION),
    ...
    def OnTreeMenu(self, event):
        ...
        if clone_mnu(self._menuAdd, parent=menu, enabled=True, separator=separator):
            separator = False
        if clone_mnu(self._menuAddCC, parent=menu, enabled=True, separator=separator):
            separator = False
        clone_mnu(self._menuAddPython, parent=menu, enabled=True, separator=separator)
    ...
    def OnTreeOpenItem(self, event):
        ...
        if hasattr(obj, '_pane') and obj._pane is not None:
            ...
            return
        t = type(obj)
        from beatle.model import ClassDiagram, cc, py, database
        handle_map = {
            self.OpenConstructor: [cc.Constructor],
            self.OpenMethod: [cc.MemberMethod, cc.IsClassMethod,
                cc.InitMethod, cc.ExitMethod, cc.Destructor,
                cc.Function],
            self.OpenPythonMethod: [py.MemberMethod, py.InitMethod,
                model.py.Function],
            self.OpenPythonModule: [py.Module],
            self.OpenClassDiagram: [ClassDiagram],
            self.OpenDatabaseTable: [database.Table]
        }
        try:
    ...
    def OnTreeSelChanged(self, event):
        ...
        if not isinstance(self.selected, TComponent):
            self.selected = None
            return None
    ...
    def OnDelete(self, event):
        ...
        TransactionStack.DoBeginTransaction("delete " +
    ...
    @TransactionalMethod('add folder {0}')
    ...
    @TransactionalMethod('add c++ function {0}')
    ...
    @with_python_export
    @TransactionalMethod('add python pakage {0}')
    ...
    @TransactionalMethod('set python entry')
