...
class TCommon(object):
    ...
    def __call__(self, *args, **kwargs):
        ...
        """
        from beatle.app.utils import isclass
        r = []
    ...
    def inner(self, t, self_include=True):
        ...
        from beatle.app import isclass
        if self_include:
    ...
    def diagrams(self):
        ...
        from beatle.model._ClassDiagram import ClassDiagram
    ...
    def outer_folder(self):
        ...
        from beatle.model.Folder import Folder
    ...
    def level_classes(self):
        ...
        from beatle.model.cc import Class as ccClass
        from beatle.model.cc import Class as pyClass
