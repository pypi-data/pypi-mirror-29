...
class GitView(BaseView, ui.GitView):
    ...
    _openRepo = IdentifiersHandler.register("ID_OPEN_REPO")
    _newRepo = IdentifiersHandler.register("ID_NEW_REPO")
    _addItem = IdentifiersHandler.register("ID_ADD_ITEM")
    _stageItem = IdentifiersHandler.register("ID_STAGE_ITEM")
    _commitItem = IdentifiersHandler.register("ID_COMMIT_ITEM")
    _refreshRepo = IdentifiersHandler.register("ID_REFRES_REPO")
    _addRemote = IdentifiersHandler.register("ID_ADD_REMOTE")
    _pushRemote = IdentifiersHandler.register("ID_PUSH_REMOTE")
    ...
    def _create_menus(self):
        ...
        self._menu = wxx.Menu(
            ...
            [],
            [self._addRemote, u"Add remote", u"add remote repository", wx.ITEM_NORMAL, wx.Bitmap(u"app/res/git_remote.xpm", wx.BITMAP_TYPE_ANY)],
            [self._pushRemote, u"Push remote", u"push remote repository", wx.ITEM_NORMAL, wx.Bitmap(u"app/res/git_push.xpm", wx.BITMAP_TYPE_ANY)],
            [],
