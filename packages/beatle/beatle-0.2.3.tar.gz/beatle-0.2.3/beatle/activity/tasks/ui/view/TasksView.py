...
class TasksView(BaseView, ui.TasksView):
    ...
    _addFolder = IdentifiersHandler.register('add-folder')  # add folder
    _newTask = IdentifiersHandler.register('add-task')      # add task
    ...
    def _create_menus(self):
        ...
        self._menu = wxx.Menu(
            [self._addFolder, u"Add folder ...\tShift+Ctrl+F", u"add folder", wx.ITEM_NORMAL, wx.Bitmap(u"app/res/folder.xpm", wx.BITMAP_TYPE_ANY)],
            [self._newTask, u"New task", u"create new task repository", wx.ITEM_NORMAL, wx.Bitmap(u"app/res/new_task.xpm", wx.BITMAP_TYPE_ANY)],
            )
    ...
    def _create_toolbars(self):
        ...
        bar.AddTool(self._addFolder, u"Add folder", wx.Bitmap(u"app/res/folder.xpm", wx.BITMAP_TYPE_ANY))
        bar.AddTool(self._newTask, u"New task", wx.Bitmap(u"app/res/new_task.xpm", wx.BITMAP_TYPE_ANY))
