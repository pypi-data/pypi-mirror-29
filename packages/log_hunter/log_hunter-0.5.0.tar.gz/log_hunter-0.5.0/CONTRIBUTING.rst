...
Report bugs at https://github.com/ptillemans/log_hunter/issues.
...
The best way to send feedback is to file an issue at https://github.com/ptillemans/log_hunter/issues.
...
1. Fork the `log_hunter` repo on GitHub.
2. Clone your fork locally::

    $ git clone git@github.com:your_name_here/log_hunter.git
...
3. The pull request should work for Python 2.6, 2.7, 3.3, 3.4 and 3.5, and for PyPy. Check
   https://travis-ci.org/ptillemans/log_hunter/pull_requests
