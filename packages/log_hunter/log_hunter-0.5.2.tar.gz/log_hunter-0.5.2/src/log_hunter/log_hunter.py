...
def match_message_results(term, image=None, after='now-1h', before='now', env=None):
    """
    ...
    :param env: a term used to match the environment which logged the line (test, uat or prod)
    ...
    for hit in s.scan():
        ...
        add_field_to_result(hit, 'host', result)
