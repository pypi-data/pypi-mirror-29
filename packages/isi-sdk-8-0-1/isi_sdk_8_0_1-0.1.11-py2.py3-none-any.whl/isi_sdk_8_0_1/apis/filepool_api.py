...
class FilepoolApi(object):
    ...
    def create_filepool_policy(self, filepool_policy, **kwargs):
        ...
        resource_path = '/platform/4/filepool/policies'.replace('{format}', 'json')
        path_params = {}
    ...
    def delete_filepool_policy(self, filepool_policy_id, **kwargs):
        ...
        resource_path = '/platform/4/filepool/policies/{FilepoolPolicyId}'.replace('{format}', 'json')
        path_params = {}
    ...
    def get_filepool_default_policy(self, **kwargs):
        ...
        resource_path = '/platform/4/filepool/default-policy'.replace('{format}', 'json')
        path_params = {}
    ...
    def get_filepool_template(self, filepool_template_id, **kwargs):
        ...
        resource_path = '/platform/4/filepool/templates/{FilepoolTemplateId}'.replace('{format}', 'json')
        path_params = {}
    ...
    def get_filepool_templates(self, **kwargs):
        ...
        resource_path = '/platform/4/filepool/templates'.replace('{format}', 'json')
        path_params = {}
