...
_METRICS_USER_METRICKEY = _descriptor.Descriptor(
  name='MetricKey',
  full_name='org.apache.beam.model.fn_execution.v1.Metrics.User.MetricKey',
  filename=None,
  file=DESCRIPTOR,
  containing_type=None,
  fields=[
    _descriptor.FieldDescriptor(
      name='step', full_name='org.apache.beam.model.fn_execution.v1.Metrics.User.MetricKey.step', index=0,
      number=1, type=9, cpp_type=9, label=1,
      has_default_value=False, default_value=_b("").decode('utf-8'),
      message_type=None, enum_type=None, containing_type=None,
      is_extension=False, extension_scope=None,
      options=None, file=DESCRIPTOR),
    _descriptor.FieldDescriptor(
      name='namespace', full_name='org.apache.beam.model.fn_execution.v1.Metrics.User.MetricKey.namespace', index=1,
      number=2, type=9, cpp_type=9, label=1,
      has_default_value=False, default_value=_b("").decode('utf-8'),
      message_type=None, enum_type=None, containing_type=None,
      is_extension=False, extension_scope=None,
      options=None, file=DESCRIPTOR),
    _descriptor.FieldDescriptor(
      name='name', full_name='org.apache.beam.model.fn_execution.v1.Metrics.User.MetricKey.name', index=2,
...
_METRICS_USER = _descriptor.Descriptor(
  ...
  fields=[
    _descriptor.FieldDescriptor(
      name='key', full_name='org.apache.beam.model.fn_execution.v1.Metrics.User.key', index=0,
      number=1, type=11, cpp_type=10, label=1,
      has_default_value=False, default_value=None,
      message_type=None, enum_type=None, containing_type=None,
      is_extension=False, extension_scope=None,
  ...
  nested_types=[_METRICS_USER_METRICKEY, _METRICS_USER_COUNTERDATA, _METRICS_USER_DISTRIBUTIONDATA, ],
  enum_types=[
  ],
  options=None,
  is_extendable=False,
...
_METRICS = _descriptor.Descriptor(
  ...
  fields=[
    _descriptor.FieldDescriptor(
      ...
      options=None, file=DESCRIPTOR),
    _descriptor.FieldDescriptor(
      name='user', full_name='org.apache.beam.model.fn_execution.v1.Metrics.user', index=1,
      number=2, type=11, cpp_type=10, label=3,
      has_default_value=False, default_value=[],
      message_type=None, enum_type=None, containing_type=None,
      is_extension=False, extension_scope=None,
...
_METRICS_USER_METRICKEY.containing_type = _METRICS_USER
_METRICS_USER_COUNTERDATA.containing_type = _METRICS_USER
_METRICS_USER_DISTRIBUTIONDATA.containing_type = _METRICS_USER
_METRICS_USER.fields_by_name['key'].message_type = _METRICS_USER_METRICKEY
...
_METRICS.fields_by_name['user'].message_type = _METRICS_USER
...
Metrics = _reflection.GeneratedProtocolMessageType('Metrics', (_message.Message,), dict(
  ...
  User = _reflection.GeneratedProtocolMessageType('User', (_message.Message,), dict(
    ...
    MetricKey = _reflection.GeneratedProtocolMessageType('MetricKey', (_message.Message,), dict(
      DESCRIPTOR = _METRICS_USER_METRICKEY,
      __module__ = 'beam_fn_api_pb2'
      # @@protoc_insertion_point(class_scope:org.apache.beam.model.fn_execution.v1.Metrics.User.MetricKey)
      ))
    ,
...
_sym_db.RegisterMessage(Metrics.User.MetricKey)
