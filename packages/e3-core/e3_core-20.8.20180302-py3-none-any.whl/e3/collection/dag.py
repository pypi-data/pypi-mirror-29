...
class DAG(object):
    ...
    def check(self):
        ...
        for node, preds in self.vertex_predecessors.items():
    ...
    def reverse_graph(self):
        ...
        for node, predecessors in self.vertex_predecessors.items():
    ...
    def as_dot(self):
        ...
        for vertex, predecessors in self.vertex_predecessors.items():
