...
class BaseGetSignature(generics.CreateAPIView):
    ...
    def _call_post_post(self, data):
        post_post_method = getattr(self, 'post_post', None)
        if post_post_method is not None:
            self.post_post(self.request, data)
