...
from amaasinfra.authorization.errors import (
    AmidAuthorizationError, BookAuthorizationError,
    SystemUserAuthorizationError
)
...
class AMaaSUser(object):
    ...
    def check_system_user_permissions(self):
        if not self.system_user:
            raise SystemUserAuthorizationError(self)
