...
class MessageGameToEngine(object):
  ...
  class Tag(object):
    ...
    PerfMetricCommand                       = 0xe1 # Anki.Cozmo.ExternalInterface.PerfMetricCommand
    PerfMetricGetStatus                     = 0xe2 # Anki.Cozmo.ExternalInterface.PerfMetricGetStatus
    BlockPoolEnabledMessage                 = 0xe3 # Anki.Cozmo.ExternalInterface.BlockPoolEnabledMessage
    BlockSelectedMessage                    = 0xe4 # Anki.Cozmo.ExternalInterface.BlockSelectedMessage
    GetBlockPoolMessage                     = 0xe5 # Anki.Cozmo.ExternalInterface.GetBlockPoolMessage
    SendAvailableObjects                    = 0xe6 # Anki.Cozmo.ExternalInterface.SendAvailableObjects
    BlockPoolResetMessage                   = 0xe7 # Anki.Cozmo.ExternalInterface.BlockPoolResetMessage
    SaveCalibrationImage                    = 0xe8 # Anki.Cozmo.ExternalInterface.SaveCalibrationImage
    ClearCalibrationImages                  = 0xe9 # Anki.Cozmo.ExternalInterface.ClearCalibrationImages
    ComputeCameraCalibration                = 0xea # Anki.Cozmo.ExternalInterface.ComputeCameraCalibration
    ContinueFreeplayFromIdle                = 0xeb # Anki.Cozmo.ExternalInterface.ContinueFreeplayFromIdle
    EnableDroneMode                         = 0xec # Anki.Cozmo.ExternalInterface.EnableDroneMode
    EnterSdkMode                            = 0xed # Anki.Cozmo.ExternalInterface.EnterSdkMode
    ExitSdkMode                             = 0xee # Anki.Cozmo.ExternalInterface.ExitSdkMode
    SetStopRobotOnSdkDisconnect             = 0xef # Anki.Cozmo.ExternalInterface.SetStopRobotOnSdkDisconnect
    StopRobotForSdk                         = 0xf0 # Anki.Cozmo.ExternalInterface.StopRobotForSdk
    SetShouldAutoConnectToCubesAtStart      = 0xf1 # Anki.Cozmo.ExternalInterface.SetShouldAutoConnectToCubesAtStart
    SetShouldAutoDisconnectFromCubesAtEnd   = 0xf2 # Anki.Cozmo.ExternalInterface.SetShouldAutoDisconnectFromCubesAtEnd
    TransferFile                            = 0xf3 # Anki.Cozmo.ExternalInterface.TransferFile
    NVStorageEraseEntry                     = 0xf4 # Anki.Cozmo.ExternalInterface.NVStorageEraseEntry
    NVStorageWipeAll                        = 0xf5 # Anki.Cozmo.ExternalInterface.NVStorageWipeAll
    NVStorageWriteEntry                     = 0xf6 # Anki.Cozmo.ExternalInterface.NVStorageWriteEntry
    NVStorageClearPartialPendingWriteEntry  = 0xf7 # Anki.Cozmo.ExternalInterface.NVStorageClearPartialPendingWriteEntry
    NVStorageReadEntry                      = 0xf8 # Anki.Cozmo.ExternalInterface.NVStorageReadEntry
    SetCameraSettings                       = 0xf9 # Anki.Cozmo.ExternalInterface.SetCameraSettings
    RequestRobotSettings                    = 0xfa # Anki.Cozmo.ExternalInterface.RequestRobotSettings
  ...
  _tags_by_name = dict(
    ...
    LogRawCliffData=224,
    PerfMetricCommand=225,
    PerfMetricGetStatus=226,
    BlockPoolEnabledMessage=227,
    BlockSelectedMessage=228,
    GetBlockPoolMessage=229,
    SendAvailableObjects=230,
    BlockPoolResetMessage=231,
    SaveCalibrationImage=232,
    ClearCalibrationImages=233,
    ComputeCameraCalibration=234,
    ContinueFreeplayFromIdle=235,
    EnableDroneMode=236,
    EnterSdkMode=237,
    ExitSdkMode=238,
    SetStopRobotOnSdkDisconnect=239,
    StopRobotForSdk=240,
    SetShouldAutoConnectToCubesAtStart=241,
    SetShouldAutoDisconnectFromCubesAtEnd=242,
    TransferFile=243,
    NVStorageEraseEntry=244,
    NVStorageWipeAll=245,
    NVStorageWriteEntry=246,
    NVStorageClearPartialPendingWriteEntry=247,
    NVStorageReadEntry=248,
    SetCameraSettings=249,
    RequestRobotSettings=250,
  )
  ...
  _tags_by_value[225] = 'PerfMetricCommand'
  _tags_by_value[226] = 'PerfMetricGetStatus'
  _tags_by_value[227] = 'BlockPoolEnabledMessage'
  _tags_by_value[228] = 'BlockSelectedMessage'
  _tags_by_value[229] = 'GetBlockPoolMessage'
  _tags_by_value[230] = 'SendAvailableObjects'
  _tags_by_value[231] = 'BlockPoolResetMessage'
  _tags_by_value[232] = 'SaveCalibrationImage'
  _tags_by_value[233] = 'ClearCalibrationImages'
  _tags_by_value[234] = 'ComputeCameraCalibration'
  _tags_by_value[235] = 'ContinueFreeplayFromIdle'
  _tags_by_value[236] = 'EnableDroneMode'
  _tags_by_value[237] = 'EnterSdkMode'
  _tags_by_value[238] = 'ExitSdkMode'
  _tags_by_value[239] = 'SetStopRobotOnSdkDisconnect'
  _tags_by_value[240] = 'StopRobotForSdk'
  _tags_by_value[241] = 'SetShouldAutoConnectToCubesAtStart'
  _tags_by_value[242] = 'SetShouldAutoDisconnectFromCubesAtEnd'
  _tags_by_value[243] = 'TransferFile'
  _tags_by_value[244] = 'NVStorageEraseEntry'
  _tags_by_value[245] = 'NVStorageWipeAll'
  _tags_by_value[246] = 'NVStorageWriteEntry'
  _tags_by_value[247] = 'NVStorageClearPartialPendingWriteEntry'
  _tags_by_value[248] = 'NVStorageReadEntry'
  _tags_by_value[249] = 'SetCameraSettings'
  _tags_by_value[250] = 'RequestRobotSettings'
  ...
  _tag_unpack_methods[225] = lambda reader: reader.read_object(Anki.Cozmo.ExternalInterface.PerfMetricCommand.unpack_from)
  _tag_unpack_methods[226] = lambda reader: reader.read_object(Anki.Cozmo.ExternalInterface.PerfMetricGetStatus.unpack_from)
  _tag_unpack_methods[227] = lambda reader: reader.read_object(Anki.Cozmo.ExternalInterface.BlockPoolEnabledMessage.unpack_from)
  _tag_unpack_methods[228] = lambda reader: reader.read_object(Anki.Cozmo.ExternalInterface.BlockSelectedMessage.unpack_from)
  _tag_unpack_methods[229] = lambda reader: reader.read_object(Anki.Cozmo.ExternalInterface.GetBlockPoolMessage.unpack_from)
  _tag_unpack_methods[230] = lambda reader: reader.read_object(Anki.Cozmo.ExternalInterface.SendAvailableObjects.unpack_from)
  _tag_unpack_methods[231] = lambda reader: reader.read_object(Anki.Cozmo.ExternalInterface.BlockPoolResetMessage.unpack_from)
  _tag_unpack_methods[232] = lambda reader: reader.read_object(Anki.Cozmo.ExternalInterface.SaveCalibrationImage.unpack_from)
  _tag_unpack_methods[233] = lambda reader: reader.read_object(Anki.Cozmo.ExternalInterface.ClearCalibrationImages.unpack_from)
  _tag_unpack_methods[234] = lambda reader: reader.read_object(Anki.Cozmo.ExternalInterface.ComputeCameraCalibration.unpack_from)
  _tag_unpack_methods[235] = lambda reader: reader.read_object(Anki.Cozmo.ExternalInterface.ContinueFreeplayFromIdle.unpack_from)
  _tag_unpack_methods[236] = lambda reader: reader.read_object(Anki.Cozmo.ExternalInterface.EnableDroneMode.unpack_from)
  _tag_unpack_methods[237] = lambda reader: reader.read_object(Anki.Cozmo.ExternalInterface.EnterSdkMode.unpack_from)
  _tag_unpack_methods[238] = lambda reader: reader.read_object(Anki.Cozmo.ExternalInterface.ExitSdkMode.unpack_from)
  _tag_unpack_methods[239] = lambda reader: reader.read_object(Anki.Cozmo.ExternalInterface.SetStopRobotOnSdkDisconnect.unpack_from)
  _tag_unpack_methods[240] = lambda reader: reader.read_object(Anki.Cozmo.ExternalInterface.StopRobotForSdk.unpack_from)
  _tag_unpack_methods[241] = lambda reader: reader.read_object(Anki.Cozmo.ExternalInterface.SetShouldAutoConnectToCubesAtStart.unpack_from)
  _tag_unpack_methods[242] = lambda reader: reader.read_object(Anki.Cozmo.ExternalInterface.SetShouldAutoDisconnectFromCubesAtEnd.unpack_from)
  _tag_unpack_methods[243] = lambda reader: reader.read_object(Anki.Cozmo.ExternalInterface.TransferFile.unpack_from)
  _tag_unpack_methods[244] = lambda reader: reader.read_object(Anki.Cozmo.ExternalInterface.NVStorageEraseEntry.unpack_from)
  _tag_unpack_methods[245] = lambda reader: reader.read_object(Anki.Cozmo.ExternalInterface.NVStorageWipeAll.unpack_from)
  _tag_unpack_methods[246] = lambda reader: reader.read_object(Anki.Cozmo.ExternalInterface.NVStorageWriteEntry.unpack_from)
  _tag_unpack_methods[247] = lambda reader: reader.read_object(Anki.Cozmo.ExternalInterface.NVStorageClearPartialPendingWriteEntry.unpack_from)
  _tag_unpack_methods[248] = lambda reader: reader.read_object(Anki.Cozmo.ExternalInterface.NVStorageReadEntry.unpack_from)
  _tag_unpack_methods[249] = lambda reader: reader.read_object(Anki.Cozmo.ExternalInterface.SetCameraSettings.unpack_from)
  _tag_unpack_methods[250] = lambda reader: reader.read_object(Anki.Cozmo.ExternalInterface.RequestRobotSettings.unpack_from)
  ...
  _type_by_tag_value[225] = lambda : Anki.Cozmo.ExternalInterface.PerfMetricCommand
  _type_by_tag_value[226] = lambda : Anki.Cozmo.ExternalInterface.PerfMetricGetStatus
  _type_by_tag_value[227] = lambda : Anki.Cozmo.ExternalInterface.BlockPoolEnabledMessage
  _type_by_tag_value[228] = lambda : Anki.Cozmo.ExternalInterface.BlockSelectedMessage
  _type_by_tag_value[229] = lambda : Anki.Cozmo.ExternalInterface.GetBlockPoolMessage
  _type_by_tag_value[230] = lambda : Anki.Cozmo.ExternalInterface.SendAvailableObjects
  _type_by_tag_value[231] = lambda : Anki.Cozmo.ExternalInterface.BlockPoolResetMessage
  _type_by_tag_value[232] = lambda : Anki.Cozmo.ExternalInterface.SaveCalibrationImage
  _type_by_tag_value[233] = lambda : Anki.Cozmo.ExternalInterface.ClearCalibrationImages
  _type_by_tag_value[234] = lambda : Anki.Cozmo.ExternalInterface.ComputeCameraCalibration
  _type_by_tag_value[235] = lambda : Anki.Cozmo.ExternalInterface.ContinueFreeplayFromIdle
  _type_by_tag_value[236] = lambda : Anki.Cozmo.ExternalInterface.EnableDroneMode
  _type_by_tag_value[237] = lambda : Anki.Cozmo.ExternalInterface.EnterSdkMode
  _type_by_tag_value[238] = lambda : Anki.Cozmo.ExternalInterface.ExitSdkMode
  _type_by_tag_value[239] = lambda : Anki.Cozmo.ExternalInterface.SetStopRobotOnSdkDisconnect
  _type_by_tag_value[240] = lambda : Anki.Cozmo.ExternalInterface.StopRobotForSdk
  _type_by_tag_value[241] = lambda : Anki.Cozmo.ExternalInterface.SetShouldAutoConnectToCubesAtStart
  _type_by_tag_value[242] = lambda : Anki.Cozmo.ExternalInterface.SetShouldAutoDisconnectFromCubesAtEnd
  _type_by_tag_value[243] = lambda : Anki.Cozmo.ExternalInterface.TransferFile
  _type_by_tag_value[244] = lambda : Anki.Cozmo.ExternalInterface.NVStorageEraseEntry
  _type_by_tag_value[245] = lambda : Anki.Cozmo.ExternalInterface.NVStorageWipeAll
  _type_by_tag_value[246] = lambda : Anki.Cozmo.ExternalInterface.NVStorageWriteEntry
  _type_by_tag_value[247] = lambda : Anki.Cozmo.ExternalInterface.NVStorageClearPartialPendingWriteEntry
  _type_by_tag_value[248] = lambda : Anki.Cozmo.ExternalInterface.NVStorageReadEntry
  _type_by_tag_value[249] = lambda : Anki.Cozmo.ExternalInterface.SetCameraSettings
  _type_by_tag_value[250] = lambda : Anki.Cozmo.ExternalInterface.RequestRobotSettings
