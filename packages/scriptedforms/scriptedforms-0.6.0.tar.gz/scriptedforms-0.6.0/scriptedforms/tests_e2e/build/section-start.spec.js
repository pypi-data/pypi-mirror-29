...
var TEMPLATE_FILE = 'section-start.md';
describe(TEMPLATE_FILE, function () {
    ...
    it('should successfully run on start', function () {
        var elem = protractor_1.element(protractor_1.by.css('.check-me .jp-OutputArea-output'));
        protractor_1.browser.wait(protractor_1.ExpectedConditions.presenceOf(elem));
