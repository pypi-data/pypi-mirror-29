...
def remember(name):
    ...
    # First, see if there is already a server for this object.
    # Try to connect to the server and get a proxy of the object.
    try:
    ...
    # If that failed, create the object. Put in a memory server for next time
        ...
        # Define a function which starts a memory server that will build and
        # serve the desired object.
