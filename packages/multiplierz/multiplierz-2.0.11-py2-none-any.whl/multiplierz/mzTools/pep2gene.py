...
if __name__ == '__main__':
    ...
    add_gene_ids(typeInDir(r'C:\Users\Max\Desktop\Projects', 'serum_peptide_table.xlsx'),
                 r'\\rc-data1\blaise\ms_data_share\Databases\Human_Uniprot.pep2gene',
                 leucine_equals_isoleucine=False,
