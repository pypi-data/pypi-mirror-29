...
This module provides an API for creating a virDomain controlling a XEN Virtual Machine.
...
class XENResources(resources.Resources):
    """Libvirt resources wrapper for Xen.
    ...
    def __init__(self, identifier, configuration):
        super(XENResources, self).__init__(identifier, configuration)
        self._domain = None
        self._network = None
    ...
    def _initialize(self):
        ...
        network_name = None
        url = 'hypervisor' in self.configuration and self.configuration['hypervisor'] or 'xen:///system'
