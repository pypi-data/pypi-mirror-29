...
def blobs(centers=5, cluster_std=1.0):
    ...
    Same observation number as in krumsiek11, to compare with the latter.
    """
    import sklearn.datasets
    X, y = sklearn.datasets.make_blobs(n_observations=640,
                                       n_features=11,
                                       centers=centers,
...
moignard15_dbscan_params = {'eps': 3, 'min_observations': 30}
