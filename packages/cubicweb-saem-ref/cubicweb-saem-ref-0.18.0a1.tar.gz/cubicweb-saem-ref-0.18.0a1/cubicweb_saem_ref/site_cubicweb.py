...
def init_seda_scheme(cnx, title, _count=[]):
    ...
    naa_what = 25651
    ark = u'{}/{}'.format(naa_what, generate_ark(cnx, naa_what))
    return cnx.create_entity('ConceptScheme', title=title, description=description, ark=ark)
