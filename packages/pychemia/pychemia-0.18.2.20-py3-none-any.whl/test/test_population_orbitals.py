...
class PopulationTest(unittest.TestCase):
    def test_orbital(self):
        ...
        abiinput = pychemia.code.abinit.AbinitInput('test/data/abinit_dmatpawu/abinit.in')
        ...
        with self.assertRaises(ValueError) as context:
            pychemia.population.orbitaldftu.OrbitalDFTU('test', input_path='test/data/abinit_01/abinit.in')

        popu = pychemia.population.orbitaldftu.OrbitalDFTU('test', input_path='test/data/abinit_dmatpawu/abinit.in')
        popu.pcdb.clean()
