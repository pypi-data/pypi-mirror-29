...
class NodeStateNode(object):
    ...
    def error(self):
        """
        Gets the error of this NodeStateNode.
        Error message, if the HTTP status returned from this node was not 200.

        :return: The error of this NodeStateNode.
        :rtype: str
        """
        return self._error
    ...
    def error(self, error):
        ...
        :param error: The error of this NodeStateNode.
        :type: str
        """
    ...
    def status(self, status):
        ...
        :param status: The status of this NodeStateNode.
        :type: int
        """
