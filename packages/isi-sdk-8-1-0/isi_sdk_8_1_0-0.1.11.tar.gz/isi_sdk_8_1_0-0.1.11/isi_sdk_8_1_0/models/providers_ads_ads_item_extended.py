...
class ProvidersAdsAdsItemExtended(object):
    ...
    def check_online_interval(self, check_online_interval):
        ...
        if check_online_interval is not None  and check_online_interval > 86400.0:
            raise ValueError("Invalid value for `check_online_interval`, must be a value less than or equal to `86400.0`")
        if check_online_interval is not None and check_online_interval < 60.0:
            raise ValueError("Invalid value for `check_online_interval`, must be a value greater than or equal to `60.0`")
    ...
    def controller_time(self, controller_time):
        ...
        if controller_time is not None  and controller_time > 4.294967295E9:
            raise ValueError("Invalid value for `controller_time`, must be a value less than or equal to `4.294967295E9`")
        if controller_time is not None and controller_time < 0.0:
            raise ValueError("Invalid value for `controller_time`, must be a value greater than or equal to `0.0`")
    ...
    def forest(self, forest):
        ...
        if forest is not None and len(forest) > 255: 
            raise ValueError("Invalid value for `forest`, length must be less than `255`")
        if forest is not None and len(forest) < 0:
            raise ValueError("Invalid value for `forest`, length must be greater than or equal to `0`")
    ...
    def hostname(self, hostname):
        ...
        if hostname is not None and len(hostname) > 255: 
            raise ValueError("Invalid value for `hostname`, length must be less than `255`")
        if hostname is not None and len(hostname) < 0:
            raise ValueError("Invalid value for `hostname`, length must be greater than or equal to `0`")
    ...
    def instance(self, instance):
        ...
        if instance is not None and len(instance) > 255: 
            raise ValueError("Invalid value for `instance`, length must be less than `255`")
        if instance is not None and len(instance) < 0:
            raise ValueError("Invalid value for `instance`, length must be greater than or equal to `0`")
    ...
    def machine_account(self, machine_account):
        ...
        if machine_account is not None and len(machine_account) > 255: 
            raise ValueError("Invalid value for `machine_account`, length must be less than `255`")
        if machine_account is not None and len(machine_account) < 0:
            raise ValueError("Invalid value for `machine_account`, length must be greater than or equal to `0`")
    ...
    def netbios_domain(self, netbios_domain):
        ...
        if netbios_domain is not None and len(netbios_domain) > 15: 
            raise ValueError("Invalid value for `netbios_domain`, length must be less than `15`")
        if netbios_domain is not None and len(netbios_domain) < 1:
            raise ValueError("Invalid value for `netbios_domain`, length must be greater than or equal to `1`")
    ...
    def node_dc_affinity(self, node_dc_affinity):
        ...
        if node_dc_affinity is not None and len(node_dc_affinity) > 255: 
            raise ValueError("Invalid value for `node_dc_affinity`, length must be less than `255`")
        if node_dc_affinity is not None and len(node_dc_affinity) < 0:
            raise ValueError("Invalid value for `node_dc_affinity`, length must be greater than or equal to `0`")
    ...
    def node_dc_affinity_timeout(self, node_dc_affinity_timeout):
        ...
        if node_dc_affinity_timeout is not None  and node_dc_affinity_timeout > 4.294967295E9:
            raise ValueError("Invalid value for `node_dc_affinity_timeout`, must be a value less than or equal to `4.294967295E9`")
        if node_dc_affinity_timeout is not None and node_dc_affinity_timeout < 0.0:
            raise ValueError("Invalid value for `node_dc_affinity_timeout`, must be a value greater than or equal to `0.0`")
    ...
    def primary_domain(self, primary_domain):
        ...
        if primary_domain is not None and len(primary_domain) > 255: 
            raise ValueError("Invalid value for `primary_domain`, length must be less than `255`")
        if primary_domain is not None and len(primary_domain) < 2:
            raise ValueError("Invalid value for `primary_domain`, length must be greater than or equal to `2`")
    ...
    def site(self, site):
        ...
        if site is not None and len(site) > 63: 
            raise ValueError("Invalid value for `site`, length must be less than `63`")
