...
class SettingsMappingMappingSettings(object):
    ...
    def cache_entry_expiry(self, cache_entry_expiry):
        ...
        if cache_entry_expiry is not None  and cache_entry_expiry > 1.5552E7:
            raise ValueError("Invalid value for `cache_entry_expiry`, must be a value less than or equal to `1.5552E7`")
        if cache_entry_expiry is not None and cache_entry_expiry < 0.0:
            raise ValueError("Invalid value for `cache_entry_expiry`, must be a value greater than or equal to `0.0`")
