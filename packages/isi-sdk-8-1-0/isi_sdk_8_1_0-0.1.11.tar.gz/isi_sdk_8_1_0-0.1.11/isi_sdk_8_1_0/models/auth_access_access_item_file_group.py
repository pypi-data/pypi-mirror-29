...
class AuthAccessAccessItemFileGroup(object):
    ...
    def __init__(self):
        """
        AuthAccessAccessItemFileGroup - a model defined in Swagger
    ...
    def id(self, id):
        ...
        :param id: The id of this AuthAccessAccessItemFileGroup.
        :type: str
        """
    ...
    def name(self):
        """
        Gets the name of this AuthAccessAccessItemFileGroup.
        Specifies the persona name, which must be combined with a type.

        :return: The name of this AuthAccessAccessItemFileGroup.
        :rtype: str
        """
        return self._name
    ...
    def name(self, name):
        ...
        :param name: The name of this AuthAccessAccessItemFileGroup.
        :type: str
        """
    ...
    def type(self):
        """
        Gets the type of this AuthAccessAccessItemFileGroup.
        Specifies the type of persona, which must be combined with a name.

        :return: The type of this AuthAccessAccessItemFileGroup.
        :rtype: str
        """
        return self._type
    ...
    def type(self, type):
        ...
        :param type: The type of this AuthAccessAccessItemFileGroup.
        :type: str
        """
