...
class ClusterIdentity(object):
    ...
    def mttdl_level_msg(self):
        """
        Gets the mttdl_level_msg of this ClusterIdentity.
        ...
        :return: The mttdl_level_msg of this ClusterIdentity.
        :rtype: str
        """
    ...
    def mttdl_level_msg(self, mttdl_level_msg):
        ...
        :param mttdl_level_msg: The mttdl_level_msg of this ClusterIdentity.
        :type: str
        """
        allowed_values = ["warn", "none"]
        if mttdl_level_msg not in allowed_values:
            raise ValueError(
                "Invalid value for `mttdl_level_msg`, must be one of {0}"
