...
class ProvidersFileIdParams(object):
    ...
    def group_file(self, group_file):
        ...
        if group_file is not None and len(group_file) > 255: 
            raise ValueError("Invalid value for `group_file`, length must be less than `255`")
        if group_file is not None and len(group_file) < 0:
            raise ValueError("Invalid value for `group_file`, length must be greater than or equal to `0`")
    ...
    def netgroup_file(self, netgroup_file):
        ...
        if netgroup_file is not None and len(netgroup_file) > 4096: 
            raise ValueError("Invalid value for `netgroup_file`, length must be less than `4096`")
        if netgroup_file is not None and len(netgroup_file) < 0:
            raise ValueError("Invalid value for `netgroup_file`, length must be greater than or equal to `0`")
    ...
    def password_file(self, password_file):
        ...
        if password_file is not None and len(password_file) > 4096: 
            raise ValueError("Invalid value for `password_file`, length must be less than `4096`")
        if password_file is not None and len(password_file) < 0:
            raise ValueError("Invalid value for `password_file`, length must be greater than or equal to `0`")
