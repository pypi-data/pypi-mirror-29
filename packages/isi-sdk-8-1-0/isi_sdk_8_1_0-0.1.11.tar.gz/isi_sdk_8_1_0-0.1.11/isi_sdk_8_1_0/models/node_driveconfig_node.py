...
class NodeDriveconfigNode(object):
    ...
    def __init__(self):
        """
        NodeDriveconfigNode - a model defined in Swagger
    ...
    def alert(self):
        """
        Gets the alert of this NodeDriveconfigNode.
        Configuration setting for drive alerts.

        :return: The alert of this NodeDriveconfigNode.
    ...
    def alert(self, alert):
        ...
        :param alert: The alert of this NodeDriveconfigNode.
    ...
    def allow(self):
        """
        Gets the allow of this NodeDriveconfigNode.
        Configuration settings for drive formatting.

        :return: The allow of this NodeDriveconfigNode.
    ...
    def allow(self, allow):
        ...
        :param allow: The allow of this NodeDriveconfigNode.
    ...
    def automatic_replacement_recognition(self):
        """
        Gets the automatic_replacement_recognition of this NodeDriveconfigNode.
        Configuration settings for automatic replacement recognition (ARR).

        :return: The automatic_replacement_recognition of this NodeDriveconfigNode.
    ...
    def automatic_replacement_recognition(self, automatic_replacement_recognition):
        ...
        :param automatic_replacement_recognition: The automatic_replacement_recognition of this NodeDriveconfigNode.
    ...
    def id(self):
        """
        Gets the id of this NodeDriveconfigNode.
        Node ID (Device Number) of this node.

        :return: The id of this NodeDriveconfigNode.
        :rtype: int
        """
        return self._id
    ...
    def id(self, id):
        ...
        :param id: The id of this NodeDriveconfigNode.
        :type: int
        """
    ...
    def lnn(self):
        """
        Gets the lnn of this NodeDriveconfigNode.
        Logical Node Number (LNN) of this node.

        :return: The lnn of this NodeDriveconfigNode.
        :rtype: int
        """
        return self._lnn
    ...
    def lnn(self, lnn):
        ...
        :param lnn: The lnn of this NodeDriveconfigNode.
        :type: int
        """
    ...
    def log(self):
        """
        Gets the log of this NodeDriveconfigNode.
        Configuration settings for drive statistics logs.

        :return: The log of this NodeDriveconfigNode.
    ...
    def log(self, log):
        ...
        :param log: The log of this NodeDriveconfigNode.
    ...
    def reboot(self):
        """
        Gets the reboot of this NodeDriveconfigNode.
        Configuration settings for a node reboot due to a drive error.

        :return: The reboot of this NodeDriveconfigNode.
    ...
    def reboot(self, reboot):
        ...
        :param reboot: The reboot of this NodeDriveconfigNode.
    ...
    def spin_wait(self):
        """
        Gets the spin_wait of this NodeDriveconfigNode.
        Configuration settings for sleeping the drive daemon before node is rescanned.

        :return: The spin_wait of this NodeDriveconfigNode.
    ...
    def spin_wait(self, spin_wait):
        ...
        :param spin_wait: The spin_wait of this NodeDriveconfigNode.
    ...
    def stall(self):
        """
        Gets the stall of this NodeDriveconfigNode.
        Configuration settings to evaluate a drive stall.

        :return: The stall of this NodeDriveconfigNode.
    ...
    def stall(self, stall):
        ...
        :param stall: The stall of this NodeDriveconfigNode.
