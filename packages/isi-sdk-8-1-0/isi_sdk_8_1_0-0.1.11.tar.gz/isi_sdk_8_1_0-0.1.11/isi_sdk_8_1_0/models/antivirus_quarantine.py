...
class AntivirusQuarantine(object):
    ...
    def file(self, file):
        ...
        if len(file) > 255: 
            raise ValueError("Invalid value for `file`, length must be less than `255`")
        if len(file) < 0:
    ...
    def last_istag(self, last_istag):
        ...
        if last_istag is not None and len(last_istag) > 255: 
            raise ValueError("Invalid value for `last_istag`, length must be less than `255`")
        if last_istag is not None and len(last_istag) < 0:
            raise ValueError("Invalid value for `last_istag`, length must be greater than or equal to `0`")
    ...
    def last_scan(self, last_scan):
        ...
        if last_scan is not None  and last_scan > 4.294967295E9:
            raise ValueError("Invalid value for `last_scan`, must be a value less than or equal to `4.294967295E9`")
        if last_scan is not None and last_scan < 0.0:
            raise ValueError("Invalid value for `last_scan`, must be a value greater than or equal to `0.0`")
    ...
    def scan_result(self, scan_result):
        ...
        if scan_result is None:
            raise ValueError("Invalid value for `scan_result`, must not be `None`")
        if len(scan_result) > 255: 
            raise ValueError("Invalid value for `scan_result`, length must be less than `255`")
        if len(scan_result) < 0:
            raise ValueError("Invalid value for `scan_result`, length must be greater than or equal to `0`")
