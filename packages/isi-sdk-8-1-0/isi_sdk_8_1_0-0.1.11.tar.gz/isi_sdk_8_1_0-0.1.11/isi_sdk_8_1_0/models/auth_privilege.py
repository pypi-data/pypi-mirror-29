...
class AuthPrivilege(object):
    ...
    def category(self, category):
        ...
        if len(category) > 255: 
            raise ValueError("Invalid value for `category`, length must be less than `255`")
        if len(category) < 0:
            raise ValueError("Invalid value for `category`, length must be greater than or equal to `0`")
