...
class AuthIdNtoken(object):
    ...
    def local_address(self, local_address):
        ...
        if local_address is not None and len(local_address) > 255: 
            raise ValueError("Invalid value for `local_address`, length must be less than `255`")
        if local_address is not None and len(local_address) < 0:
            raise ValueError("Invalid value for `local_address`, length must be greater than or equal to `0`")
    ...
    def protocol(self, protocol):
        ...
        if protocol is not None  and protocol > 128.0:
            raise ValueError("Invalid value for `protocol`, must be a value less than or equal to `128.0`")
        if protocol is not None and protocol < 0.0:
            raise ValueError("Invalid value for `protocol`, must be a value greater than or equal to `0.0`")
    ...
    def remote_address(self, remote_address):
        ...
        if remote_address is not None and len(remote_address) > 255: 
            raise ValueError("Invalid value for `remote_address`, length must be less than `255`")
        if remote_address is not None and len(remote_address) < 0:
            raise ValueError("Invalid value for `remote_address`, length must be greater than or equal to `0`")
    ...
    def zid(self, zid):
        ...
        if zid is not None  and zid > 4.294967295E9:
            raise ValueError("Invalid value for `zid`, must be a value less than or equal to `4.294967295E9`")
        if zid is not None and zid < 0.0:
            raise ValueError("Invalid value for `zid`, must be a value greater than or equal to `0.0`")
    ...
    def zone_id(self, zone_id):
        ...
        if zone_id is not None and len(zone_id) > 255: 
            raise ValueError("Invalid value for `zone_id`, length must be less than `255`")
        if zone_id is not None and len(zone_id) < 0:
            raise ValueError("Invalid value for `zone_id`, length must be greater than or equal to `0`")
