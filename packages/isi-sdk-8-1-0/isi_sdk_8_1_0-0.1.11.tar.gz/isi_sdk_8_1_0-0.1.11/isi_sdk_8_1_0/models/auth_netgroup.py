...
class AuthNetgroup(object):
    ...
    def domainname(self, domainname):
        ...
        if domainname is not None and len(domainname) > 255: 
            raise ValueError("Invalid value for `domainname`, length must be less than `255`")
        if domainname is not None and len(domainname) < 0:
            raise ValueError("Invalid value for `domainname`, length must be greater than or equal to `0`")
    ...
    def netgroup(self, netgroup):
        ...
        if netgroup is not None and len(netgroup) > 255: 
            raise ValueError("Invalid value for `netgroup`, length must be less than `255`")
        if netgroup is not None and len(netgroup) < 0:
            raise ValueError("Invalid value for `netgroup`, length must be greater than or equal to `0`")
    ...
    def username(self, username):
        ...
        if username is not None and len(username) > 255: 
            raise ValueError("Invalid value for `username`, length must be less than `255`")
        if username is not None and len(username) < 0:
            raise ValueError("Invalid value for `username`, length must be greater than or equal to `0`")
