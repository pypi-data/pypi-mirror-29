...
class ProvidersNisItem(object):
    ...
    def nis_domain(self, nis_domain):
        ...
        if nis_domain is None:
            raise ValueError("Invalid value for `nis_domain`, must not be `None`")
        if len(nis_domain) > 255: 
            raise ValueError("Invalid value for `nis_domain`, length must be less than `255`")
        if len(nis_domain) < 0:
            raise ValueError("Invalid value for `nis_domain`, length must be greater than or equal to `0`")
    ...
    def request_timeout(self, request_timeout):
        ...
        if request_timeout is not None  and request_timeout > 3600.0:
            raise ValueError("Invalid value for `request_timeout`, must be a value less than or equal to `3600.0`")
        if request_timeout is not None and request_timeout < 0.0:
            raise ValueError("Invalid value for `request_timeout`, must be a value greater than or equal to `0.0`")
    ...
    def retry_time(self, retry_time):
        ...
        if retry_time is not None  and retry_time > 3600.0:
            raise ValueError("Invalid value for `retry_time`, must be a value less than or equal to `3600.0`")
        if retry_time is not None and retry_time < 0.0:
            raise ValueError("Invalid value for `retry_time`, must be a value greater than or equal to `0.0`")
