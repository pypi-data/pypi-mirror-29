...
class NodeSledsNode(object):
    ...
    def __init__(self):
        """
        NodeSledsNode - a model defined in Swagger
    ...
    def error(self):
        """
        Gets the error of this NodeSledsNode.
        Error message, if the HTTP status returned from this node was not 200.

        :return: The error of this NodeSledsNode.
        :rtype: str
        """
        return self._error
    ...
    def error(self, error):
        ...
        :param error: The error of this NodeSledsNode.
        :type: str
        """
    ...
    def id(self):
        """
        Gets the id of this NodeSledsNode.
        Node ID of the node reporting this information.

        :return: The id of this NodeSledsNode.
        :rtype: int
        """
        return self._id
    ...
    def id(self, id):
        ...
        :param id: The id of this NodeSledsNode.
        :type: int
        """
    ...
    def lnn(self):
        """
        Gets the lnn of this NodeSledsNode.
        Logical node number of the node reporting this information.

        :return: The lnn of this NodeSledsNode.
        :rtype: int
        """
        return self._lnn
    ...
    def lnn(self, lnn):
        ...
        :param lnn: The lnn of this NodeSledsNode.
        :type: int
        """
    ...
    def sleds(self):
        """
        Gets the sleds of this NodeSledsNode.
        List of the sleds in this node.

        :return: The sleds of this NodeSledsNode.
    ...
    def sleds(self, sleds):
        ...
        :param sleds: The sleds of this NodeSledsNode.
    ...
    def status(self, status):
        ...
        :param status: The status of this NodeSledsNode.
        :type: int
        """
