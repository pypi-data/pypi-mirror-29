...
class AuthCacheItem(object):
    ...
    def all(self, all):
        ...
        if all is not None and len(all) > 255: 
            raise ValueError("Invalid value for `all`, length must be less than `255`")
        if all is not None and len(all) < 0:
            raise ValueError("Invalid value for `all`, length must be greater than or equal to `0`")
    ...
    def gid(self, gid):
        ...
        if gid is not None  and gid > 4.294967295E9:
            raise ValueError("Invalid value for `gid`, must be a value less than or equal to `4.294967295E9`")
        if gid is not None and gid < 0.0:
            raise ValueError("Invalid value for `gid`, must be a value greater than or equal to `0.0`")
    ...
    def group_name(self, group_name):
        ...
        if group_name is not None and len(group_name) > 255: 
            raise ValueError("Invalid value for `group_name`, length must be less than `255`")
        if group_name is not None and len(group_name) < 0:
            raise ValueError("Invalid value for `group_name`, length must be greater than or equal to `0`")
    ...
    def user_name(self, user_name):
        ...
        if user_name is not None and len(user_name) > 255: 
            raise ValueError("Invalid value for `user_name`, length must be less than `255`")
        if user_name is not None and len(user_name) < 0:
            raise ValueError("Invalid value for `user_name`, length must be greater than or equal to `0`")
