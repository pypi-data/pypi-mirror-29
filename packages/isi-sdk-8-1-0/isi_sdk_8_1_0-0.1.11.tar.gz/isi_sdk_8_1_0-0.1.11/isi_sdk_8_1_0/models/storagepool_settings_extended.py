...
class StoragepoolSettingsExtended(object):
    ...
    def ssd_qab_mirrors(self):
        """
        Gets the ssd_qab_mirrors of this StoragepoolSettingsExtended.
        Controls number of mirrors of QAB blocks to place on SSDs.

        :return: The ssd_qab_mirrors of this StoragepoolSettingsExtended.
        :rtype: str
        """
    ...
    def ssd_qab_mirrors(self, ssd_qab_mirrors):
        ...
        :param ssd_qab_mirrors: The ssd_qab_mirrors of this StoragepoolSettingsExtended.
        :type: str
        """
        allowed_values = ["one", "all"]
        if ssd_qab_mirrors is not None and ssd_qab_mirrors not in allowed_values:
            raise ValueError(
                "Invalid value for `ssd_qab_mirrors`, must be one of {0}"
                .format(allowed_values)
            )
    ...
    def ssd_system_btree_mirrors(self):
        """
        Gets the ssd_system_btree_mirrors of this StoragepoolSettingsExtended.
        Controls number of mirrors of system B-tree blocks to place on SSDs.

        :return: The ssd_system_btree_mirrors of this StoragepoolSettingsExtended.
        :rtype: str
        """
    ...
    def ssd_system_btree_mirrors(self, ssd_system_btree_mirrors):
        ...
        :param ssd_system_btree_mirrors: The ssd_system_btree_mirrors of this StoragepoolSettingsExtended.
        :type: str
        """
        allowed_values = ["one", "all"]
        if ssd_system_btree_mirrors is not None and ssd_system_btree_mirrors not in allowed_values:
            raise ValueError(
                "Invalid value for `ssd_system_btree_mirrors`, must be one of {0}"
                .format(allowed_values)
            )
    ...
    def ssd_system_delta_mirrors(self):
        """
        Gets the ssd_system_delta_mirrors of this StoragepoolSettingsExtended.
        Controls number of mirrors of system delta blocks to place on SSDs.

        :return: The ssd_system_delta_mirrors of this StoragepoolSettingsExtended.
        :rtype: str
        """
    ...
    def ssd_system_delta_mirrors(self, ssd_system_delta_mirrors):
        ...
        :param ssd_system_delta_mirrors: The ssd_system_delta_mirrors of this StoragepoolSettingsExtended.
        :type: str
        """
        allowed_values = ["one", "all"]
        if ssd_system_delta_mirrors is not None and ssd_system_delta_mirrors not in allowed_values:
            raise ValueError(
                "Invalid value for `ssd_system_delta_mirrors`, must be one of {0}"
                .format(allowed_values)
            )
