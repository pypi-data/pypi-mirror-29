...
class AuthGroupsApi(object):
    ...
    def list_group_members(self, group, **kwargs):
        ...
        all_params = ['group', 'resolve_names', 'resume', 'limit', 'zone', 'provider']
        all_params.append('callback')
        ...
        if 'limit' in params and params['limit'] > 4.294967295E9: 
            raise ValueError("Invalid value for parameter `limit` when calling `list_group_members`, must be a value less than or equal to  `4.294967295E9`")
