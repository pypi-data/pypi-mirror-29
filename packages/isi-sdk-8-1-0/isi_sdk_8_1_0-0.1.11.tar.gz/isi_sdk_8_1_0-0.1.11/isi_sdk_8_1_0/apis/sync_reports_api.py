...
class SyncReportsApi(object):
    ...
    def get_report_subreport(self, report_subreport_id, rid, **kwargs):
        ...
        resource_path = '/platform/4/sync/reports/{Rid}/subreports/{ReportSubreportId}'.replace('{format}', 'json')
        path_params = {}
    ...
    def get_report_subreports(self, rid, **kwargs):
        ...
        if 'limit' in params and params['limit'] > 4.294967295E9: 
            raise ValueError("Invalid value for parameter `limit` when calling `get_report_subreports`, must be a value less than or equal to  `4.294967295E9`")
        ...
        resource_path = '/platform/4/sync/reports/{Rid}/subreports'.replace('{format}', 'json')
        path_params = {}
        if 'rid' in params:
            path_params['Rid'] = params['rid']
