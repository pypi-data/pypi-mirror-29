...
class StatisticsApi(object):
    ...
    def get_statistics_current(self, **kwargs):
        ...
        all_params = ['timeout', 'show_nodes', 'keys', 'devid', 'substr', 'stale', 'type_info', 'raw', 'key', 'degraded', 'nodes']
        ...
        if 'show_nodes' in params:
            query_params['show_nodes'] = params['show_nodes']
        if 'keys' in params:
        ...
        if 'stale' in params:
            query_params['stale'] = params['stale']
        if 'type_info' in params:
            query_params['type_info'] = params['type_info']
        if 'raw' in params:
            query_params['raw'] = params['raw']
        if 'key' in params:
    ...
    def get_statistics_history(self, **kwargs):
        ...
        all_params = ['begin', 'interval', 'end', 'timeout', 'raw', 'keys', 'devid', 'substr', 'stale', 'type_info', 'memory_only', 'key', 'degraded', 'show_nodes', 'resolution', 'nodes']
        all_params.append('callback')
    ...
    def get_statistics_keys(self, **kwargs):
        ...
        if 'limit' in params and params['limit'] > 4.294967295E9: 
            raise ValueError("Invalid value for parameter `limit` when calling `get_statistics_keys`, must be a value less than or equal to  `4.294967295E9`")
    ...
    def get_summary_protocol_stats(self, **kwargs):
        """
        ...
        >>>     pprint(response)
        >>>
        >>> thread = api.get_summary_protocol_stats(callback=callback_function)
        ...
        all_params = ['degraded', 'protocol', 'nodes', 'timeout']
        all_params.append('callback')
        ...
        resource_path = '/platform/3/statistics/summary/protocol-stats'.replace('{format}', 'json')
        path_params = {}
        ...
        response = self.api_client.call_api(resource_path, 'GET',
                                            ...
                                            post_params=form_params,
                                            files=local_var_files,
                                            response_type='SummaryProtocolStats',
                                            auth_settings=auth_settings,
                                            callback=params.get('callback'))
        return response
    ...
    def get_summary_workload(self, **kwargs):
        ...
        all_params = ['sort', 'job_types', 'totalby', 'timeout', 'degraded', 'nodes', 'system_names']
        all_params.append('callback')
        ...
        if 'job_types' in params:
            query_params['job_types'] = params['job_types']
        if 'totalby' in params:
            query_params['totalby'] = params['totalby']
        if 'timeout' in params:
            query_params['timeout'] = params['timeout']
