...
class SnapshotApi(object):
    ...
    def get_snapshot_changelist(self, snapshot_changelist_id, **kwargs):
        ...
        all_params = ['snapshot_changelist_id', 'limit', 'resume']
        all_params.append('callback')
        ...
        if 'limit' in params and params['limit'] > 4.294967295E9: 
            raise ValueError("Invalid value for parameter `limit` when calling `get_snapshot_changelist`, must be a value less than or equal to  `4.294967295E9`")
        if 'limit' in params and params['limit'] < 1.0: 
            raise ValueError("Invalid value for parameter `limit` when calling `get_snapshot_changelist`, must be a value greater than or equal to `1.0`")
    ...
    def get_snapshot_license(self, **kwargs):
        ...
        resource_path = '/platform/5/snapshot/license'.replace('{format}', 'json')
        path_params = {}
    ...
    def get_snapshot_repstate(self, snapshot_repstate_id, **kwargs):
        ...
        all_params = ['snapshot_repstate_id', 'limit', 'resume']
        all_params.append('callback')
        ...
        if 'limit' in params and params['limit'] > 4.294967295E9: 
            raise ValueError("Invalid value for parameter `limit` when calling `get_snapshot_repstate`, must be a value less than or equal to  `4.294967295E9`")
        if 'limit' in params and params['limit'] < 1.0: 
            raise ValueError("Invalid value for parameter `limit` when calling `get_snapshot_repstate`, must be a value greater than or equal to `1.0`")
    ...
    def list_snapshot_aliases(self, **kwargs):
        ...
        if 'limit' in params and params['limit'] > 4.294967295E9: 
            raise ValueError("Invalid value for parameter `limit` when calling `list_snapshot_aliases`, must be a value less than or equal to  `4.294967295E9`")
        if 'limit' in params and params['limit'] < 1.0: 
    ...
    def list_snapshot_changelists(self, **kwargs):
        ...
        if 'limit' in params and params['limit'] > 4.294967295E9: 
            raise ValueError("Invalid value for parameter `limit` when calling `list_snapshot_changelists`, must be a value less than or equal to  `4.294967295E9`")
        if 'limit' in params and params['limit'] < 1.0: 
            raise ValueError("Invalid value for parameter `limit` when calling `list_snapshot_changelists`, must be a value greater than or equal to `1.0`")
    ...
    def list_snapshot_repstates(self, **kwargs):
        ...
        if 'limit' in params and params['limit'] > 4.294967295E9: 
            raise ValueError("Invalid value for parameter `limit` when calling `list_snapshot_repstates`, must be a value less than or equal to  `4.294967295E9`")
        if 'limit' in params and params['limit'] < 1.0: 
            raise ValueError("Invalid value for parameter `limit` when calling `list_snapshot_repstates`, must be a value greater than or equal to `1.0`")
    ...
    def list_snapshot_schedules(self, **kwargs):
        ...
        if 'limit' in params and params['limit'] > 4.294967295E9: 
            raise ValueError("Invalid value for parameter `limit` when calling `list_snapshot_schedules`, must be a value less than or equal to  `4.294967295E9`")
        if 'limit' in params and params['limit'] < 1.0: 
    ...
    def list_snapshot_snapshots(self, **kwargs):
        ...
        if 'limit' in params and params['limit'] > 4.294967295E9: 
            raise ValueError("Invalid value for parameter `limit` when calling `list_snapshot_snapshots`, must be a value less than or equal to  `4.294967295E9`")
        if 'limit' in params and params['limit'] < 1.0: 
