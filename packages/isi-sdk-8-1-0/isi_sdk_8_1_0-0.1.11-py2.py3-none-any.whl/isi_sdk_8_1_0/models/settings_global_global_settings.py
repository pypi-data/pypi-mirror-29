...
class SettingsGlobalGlobalSettings(object):
    ...
    def alloc_retries(self, alloc_retries):
        ...
        if alloc_retries is not None  and alloc_retries > 4.294967295E9:
            raise ValueError("Invalid value for `alloc_retries`, must be a value less than or equal to `4.294967295E9`")
        if alloc_retries is not None and alloc_retries < 0.0:
            raise ValueError("Invalid value for `alloc_retries`, must be a value greater than or equal to `0.0`")
    ...
    def gid_range_max(self, gid_range_max):
        ...
        if gid_range_max is not None  and gid_range_max > 4.294967295E9:
            raise ValueError("Invalid value for `gid_range_max`, must be a value less than or equal to `4.294967295E9`")
        if gid_range_max is not None and gid_range_max < 0.0:
            raise ValueError("Invalid value for `gid_range_max`, must be a value greater than or equal to `0.0`")
    ...
    def gid_range_min(self, gid_range_min):
        ...
        if gid_range_min is not None  and gid_range_min > 4.294967295E9:
            raise ValueError("Invalid value for `gid_range_min`, must be a value less than or equal to `4.294967295E9`")
        if gid_range_min is not None and gid_range_min < 0.0:
            raise ValueError("Invalid value for `gid_range_min`, must be a value greater than or equal to `0.0`")
    ...
    def gid_range_next(self, gid_range_next):
        ...
        if gid_range_next is not None  and gid_range_next > 4.294967295E9:
            raise ValueError("Invalid value for `gid_range_next`, must be a value less than or equal to `4.294967295E9`")
        if gid_range_next is not None and gid_range_next < 0.0:
            raise ValueError("Invalid value for `gid_range_next`, must be a value greater than or equal to `0.0`")
    ...
    def group_uid(self, group_uid):
        ...
        if group_uid is not None  and group_uid > 4.294967295E9:
            raise ValueError("Invalid value for `group_uid`, must be a value less than or equal to `4.294967295E9`")
        if group_uid is not None and group_uid < 0.0:
            raise ValueError("Invalid value for `group_uid`, must be a value greater than or equal to `0.0`")
    ...
    def min_mapped_rid(self, min_mapped_rid):
        ...
        if min_mapped_rid is not None  and min_mapped_rid > 4.294967295E9:
            raise ValueError("Invalid value for `min_mapped_rid`, must be a value less than or equal to `4.294967295E9`")
        if min_mapped_rid is not None and min_mapped_rid < 0.0:
            raise ValueError("Invalid value for `min_mapped_rid`, must be a value greater than or equal to `0.0`")
    ...
    def null_gid(self, null_gid):
        ...
        if null_gid is not None  and null_gid > 4.294967295E9:
            raise ValueError("Invalid value for `null_gid`, must be a value less than or equal to `4.294967295E9`")
        if null_gid is not None and null_gid < 0.0:
            raise ValueError("Invalid value for `null_gid`, must be a value greater than or equal to `0.0`")
    ...
    def null_uid(self, null_uid):
        ...
        if null_uid is not None  and null_uid > 4.294967295E9:
            raise ValueError("Invalid value for `null_uid`, must be a value less than or equal to `4.294967295E9`")
        if null_uid is not None and null_uid < 0.0:
            raise ValueError("Invalid value for `null_uid`, must be a value greater than or equal to `0.0`")
    ...
    def rpc_block_time(self, rpc_block_time):
        ...
        if rpc_block_time is not None  and rpc_block_time > 4.294967295E9:
            raise ValueError("Invalid value for `rpc_block_time`, must be a value less than or equal to `4.294967295E9`")
        if rpc_block_time is not None and rpc_block_time < 0.0:
            raise ValueError("Invalid value for `rpc_block_time`, must be a value greater than or equal to `0.0`")
    ...
    def rpc_max_requests(self, rpc_max_requests):
        ...
        if rpc_max_requests is not None  and rpc_max_requests > 4.294967295E9:
            raise ValueError("Invalid value for `rpc_max_requests`, must be a value less than or equal to `4.294967295E9`")
        if rpc_max_requests is not None and rpc_max_requests < 0.0:
            raise ValueError("Invalid value for `rpc_max_requests`, must be a value greater than or equal to `0.0`")
    ...
    def rpc_timeout(self, rpc_timeout):
        ...
        if rpc_timeout is not None  and rpc_timeout > 3600.0:
            raise ValueError("Invalid value for `rpc_timeout`, must be a value less than or equal to `3600.0`")
        if rpc_timeout is not None and rpc_timeout < 10.0:
            raise ValueError("Invalid value for `rpc_timeout`, must be a value greater than or equal to `10.0`")
    ...
    def space_replacement(self, space_replacement):
        ...
        if space_replacement is not None and len(space_replacement) > 255: 
            raise ValueError("Invalid value for `space_replacement`, length must be less than `255`")
        if space_replacement is not None and len(space_replacement) < 0:
            raise ValueError("Invalid value for `space_replacement`, length must be greater than or equal to `0`")
    ...
    def system_gid_threshold(self, system_gid_threshold):
        ...
        if system_gid_threshold is not None  and system_gid_threshold > 4.294967295E9:
            raise ValueError("Invalid value for `system_gid_threshold`, must be a value less than or equal to `4.294967295E9`")
        if system_gid_threshold is not None and system_gid_threshold < 0.0:
            raise ValueError("Invalid value for `system_gid_threshold`, must be a value greater than or equal to `0.0`")
    ...
    def system_uid_threshold(self, system_uid_threshold):
        ...
        if system_uid_threshold is not None  and system_uid_threshold > 4.294967295E9:
            raise ValueError("Invalid value for `system_uid_threshold`, must be a value less than or equal to `4.294967295E9`")
        if system_uid_threshold is not None and system_uid_threshold < 0.0:
            raise ValueError("Invalid value for `system_uid_threshold`, must be a value greater than or equal to `0.0`")
    ...
    def uid_range_max(self, uid_range_max):
        ...
        if uid_range_max is not None  and uid_range_max > 4.294967295E9:
            raise ValueError("Invalid value for `uid_range_max`, must be a value less than or equal to `4.294967295E9`")
        if uid_range_max is not None and uid_range_max < 0.0:
            raise ValueError("Invalid value for `uid_range_max`, must be a value greater than or equal to `0.0`")
    ...
    def uid_range_min(self, uid_range_min):
        ...
        if uid_range_min is not None  and uid_range_min > 4.294967295E9:
            raise ValueError("Invalid value for `uid_range_min`, must be a value less than or equal to `4.294967295E9`")
        if uid_range_min is not None and uid_range_min < 0.0:
            raise ValueError("Invalid value for `uid_range_min`, must be a value greater than or equal to `0.0`")
    ...
    def uid_range_next(self, uid_range_next):
        ...
        if uid_range_next is not None  and uid_range_next > 4.294967295E9:
            raise ValueError("Invalid value for `uid_range_next`, must be a value less than or equal to `4.294967295E9`")
        if uid_range_next is not None and uid_range_next < 0.0:
            raise ValueError("Invalid value for `uid_range_next`, must be a value greater than or equal to `0.0`")
    ...
    def unknown_gid(self, unknown_gid):
        ...
        if unknown_gid is not None  and unknown_gid > 4.294967295E9:
            raise ValueError("Invalid value for `unknown_gid`, must be a value less than or equal to `4.294967295E9`")
        if unknown_gid is not None and unknown_gid < 0.0:
            raise ValueError("Invalid value for `unknown_gid`, must be a value greater than or equal to `0.0`")
    ...
    def unknown_uid(self, unknown_uid):
        ...
        if unknown_uid is not None  and unknown_uid > 4.294967295E9:
            raise ValueError("Invalid value for `unknown_uid`, must be a value less than or equal to `4.294967295E9`")
        if unknown_uid is not None and unknown_uid < 0.0:
            raise ValueError("Invalid value for `unknown_uid`, must be a value greater than or equal to `0.0`")
    ...
    def user_object_cache_size(self, user_object_cache_size):
        ...
        if user_object_cache_size is not None  and user_object_cache_size > 4.294967295E9:
            raise ValueError("Invalid value for `user_object_cache_size`, must be a value less than or equal to `4.294967295E9`")
        if user_object_cache_size is not None and user_object_cache_size < 0.0:
            raise ValueError("Invalid value for `user_object_cache_size`, must be a value greater than or equal to `0.0`")
    ...
    def workgroup(self, workgroup):
        ...
        if workgroup is not None and len(workgroup) > 255: 
            raise ValueError("Invalid value for `workgroup`, length must be less than `255`")
        if workgroup is not None and len(workgroup) < 0:
            raise ValueError("Invalid value for `workgroup`, length must be greater than or equal to `0`")
