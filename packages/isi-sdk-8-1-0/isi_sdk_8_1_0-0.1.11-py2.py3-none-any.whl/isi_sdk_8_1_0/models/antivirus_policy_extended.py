...
class AntivirusPolicyExtended(object):
    ...
    def description(self, description):
        ...
        if description is not None and len(description) > 255: 
            raise ValueError("Invalid value for `description`, length must be less than `255`")
    ...
    def impact(self, impact):
        ...
        if impact is not None and len(impact) > 255: 
            raise ValueError("Invalid value for `impact`, length must be less than `255`")
        if impact is not None and len(impact) < 0:
            raise ValueError("Invalid value for `impact`, length must be greater than or equal to `0`")
    ...
    def recursion_depth(self, recursion_depth):
        ...
        if recursion_depth is not None  and recursion_depth > 2.147483647E9:
            raise ValueError("Invalid value for `recursion_depth`, must be a value less than or equal to `2.147483647E9`")
        if recursion_depth is not None and recursion_depth < -1.0:
            raise ValueError("Invalid value for `recursion_depth`, must be a value greater than or equal to `-1.0`")
    ...
    def schedule(self, schedule):
        ...
        if schedule is not None and len(schedule) > 255: 
            raise ValueError("Invalid value for `schedule`, length must be less than `255`")
    ...
    def last_run(self, last_run):
        ...
        if last_run is not None  and last_run > 4.294967295E9:
            raise ValueError("Invalid value for `last_run`, must be a value less than or equal to `4.294967295E9`")
        if last_run is not None and last_run < 0.0:
            raise ValueError("Invalid value for `last_run`, must be a value greater than or equal to `0.0`")
