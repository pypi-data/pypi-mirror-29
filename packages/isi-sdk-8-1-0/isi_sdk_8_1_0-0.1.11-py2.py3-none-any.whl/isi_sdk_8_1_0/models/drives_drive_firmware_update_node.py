...
class DrivesDriveFirmwareUpdateNode(object):
    ...
    def error(self):
        """
        Gets the error of this DrivesDriveFirmwareUpdateNode.
        Error message, if the HTTP status returned from this node was not 200.

        :return: The error of this DrivesDriveFirmwareUpdateNode.
        :rtype: str
        """
        return self._error
    ...
    def error(self, error):
        ...
        :param error: The error of this DrivesDriveFirmwareUpdateNode.
        :type: str
        """
