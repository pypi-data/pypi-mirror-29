...
class SettingsKrb5DefaultsKrb5Settings(object):
    ...
    def allow_weak_crypto(self):
        """
        Gets the allow_weak_crypto of this SettingsKrb5DefaultsKrb5Settings.
        If true, allow the use of DES encryption

        :return: The allow_weak_crypto of this SettingsKrb5DefaultsKrb5Settings.
        :rtype: bool
        """
    ...
    def allow_weak_crypto(self, allow_weak_crypto):
        ...
        :param allow_weak_crypto: The allow_weak_crypto of this SettingsKrb5DefaultsKrb5Settings.
        :type: bool
        """
    ...
    def default_realm(self, default_realm):
        ...
        if default_realm is not None and len(default_realm) > 255: 
            raise ValueError("Invalid value for `default_realm`, length must be less than `255`")
        if default_realm is not None and len(default_realm) < 0:
            raise ValueError("Invalid value for `default_realm`, length must be greater than or equal to `0`")
