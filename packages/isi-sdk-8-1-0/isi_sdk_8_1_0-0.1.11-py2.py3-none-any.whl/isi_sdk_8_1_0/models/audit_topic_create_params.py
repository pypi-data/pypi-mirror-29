...
class AuditTopicCreateParams(object):
    ...
    def max_cached_messages(self, max_cached_messages):
        ...
        if max_cached_messages is not None  and max_cached_messages > 16384.0:
            raise ValueError("Invalid value for `max_cached_messages`, must be a value less than or equal to `16384.0`")
