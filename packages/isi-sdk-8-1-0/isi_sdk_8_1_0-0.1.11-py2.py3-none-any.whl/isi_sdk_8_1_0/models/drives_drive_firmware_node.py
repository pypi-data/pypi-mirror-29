...
class DrivesDriveFirmwareNode(object):
    ...
    def error(self):
        """
        Gets the error of this DrivesDriveFirmwareNode.
        Error message, if the HTTP status returned from this node was not 200.

        :return: The error of this DrivesDriveFirmwareNode.
        :rtype: str
        """
        return self._error
    ...
    def error(self, error):
        ...
        :param error: The error of this DrivesDriveFirmwareNode.
        :type: str
        """
    ...
    def status(self):
        """
        Gets the status of this DrivesDriveFirmwareNode.
        Status of the HTTP response from this node if not 200.  If 200, this field does not appear.

        :return: The status of this DrivesDriveFirmwareNode.
        :rtype: int
        """
        return self._status
    ...
    def status(self, status):
        ...
        :param status: The status of this DrivesDriveFirmwareNode.
        :type: int
        """
