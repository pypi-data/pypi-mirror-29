...
class SnapshotSnapshotExtended(object):
    ...
    def alias(self, alias):
        ...
        if alias is not None and len(alias) < 0:
            raise ValueError("Invalid value for `alias`, length must be greater than or equal to `0`")
    ...
    def expires(self, expires):
        ...
        if expires is not None  and expires > 4.294967295E9:
            raise ValueError("Invalid value for `expires`, must be a value less than or equal to `4.294967295E9`")
    ...
    def created(self, created):
        ...
        if created > 4.294967295E9:
            raise ValueError("Invalid value for `created`, must be a value less than or equal to `4.294967295E9`")
    ...
    def path(self, path):
        ...
        if path is not None and len(path) > 1024: 
            raise ValueError("Invalid value for `path`, length must be less than `1024`")
        if path is not None and len(path) < 4:
            raise ValueError("Invalid value for `path`, length must be greater than or equal to `4`")
        if path is not None and not re.search('^/ifs', path):
            raise ValueError("Invalid value for `path`, must be a follow pattern or equal to `/^/ifs/`")
    ...
    def schedule(self, schedule):
        ...
        if schedule is not None and len(schedule) < 0:
            raise ValueError("Invalid value for `schedule`, length must be greater than or equal to `0`")
    ...
    def shadow_bytes(self, shadow_bytes):
        ...
        if shadow_bytes is None:
            raise ValueError("Invalid value for `shadow_bytes`, must not be `None`")
        if shadow_bytes > 4.294967295E9:
            raise ValueError("Invalid value for `shadow_bytes`, must be a value less than or equal to `4.294967295E9`")
    ...
    def size(self, size):
        ...
        if size > 4.294967295E9:
            raise ValueError("Invalid value for `size`, must be a value less than or equal to `4.294967295E9`")
    ...
    def target_id(self, target_id):
        ...
        if target_id is not None  and target_id > 4.294967295E9:
            raise ValueError("Invalid value for `target_id`, must be a value less than or equal to `4.294967295E9`")
