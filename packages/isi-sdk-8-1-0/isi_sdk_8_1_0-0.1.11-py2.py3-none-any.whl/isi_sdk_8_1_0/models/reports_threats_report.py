...
class ReportsThreatsReport(object):
    ...
    def file(self, file):
        ...
        if file is not None and len(file) > 4096: 
            raise ValueError("Invalid value for `file`, length must be less than `4096`")
    ...
    def remediation(self, remediation):
        ...
        if remediation is not None and len(remediation) > 255: 
            raise ValueError("Invalid value for `remediation`, length must be less than `255`")
        if remediation is not None and len(remediation) < 0:
            raise ValueError("Invalid value for `remediation`, length must be greater than or equal to `0`")
    ...
    def scan_id(self, scan_id):
        ...
        if scan_id is not None and len(scan_id) > 255: 
            raise ValueError("Invalid value for `scan_id`, length must be less than `255`")
        if scan_id is not None and len(scan_id) < 0:
            raise ValueError("Invalid value for `scan_id`, length must be greater than or equal to `0`")
    ...
    def threat(self, threat):
        ...
        if threat is not None and len(threat) > 255: 
            raise ValueError("Invalid value for `threat`, length must be less than `255`")
        if threat is not None and len(threat) < 0:
            raise ValueError("Invalid value for `threat`, length must be greater than or equal to `0`")
    ...
    def time(self, time):
        ...
        if time is not None  and time > 4.294967295E9:
