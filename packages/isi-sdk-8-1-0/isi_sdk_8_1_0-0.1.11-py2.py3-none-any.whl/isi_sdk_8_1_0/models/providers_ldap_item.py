...
class ProvidersLdapItem(object):
    ...
    def alternate_security_identities_attribute(self, alternate_security_identities_attribute):
        ...
        if alternate_security_identities_attribute is not None and len(alternate_security_identities_attribute) > 255: 
            raise ValueError("Invalid value for `alternate_security_identities_attribute`, length must be less than `255`")
        if alternate_security_identities_attribute is not None and len(alternate_security_identities_attribute) < 0:
            raise ValueError("Invalid value for `alternate_security_identities_attribute`, length must be greater than or equal to `0`")
    ...
    def base_dn(self, base_dn):
        ...
        if len(base_dn) > 255: 
            raise ValueError("Invalid value for `base_dn`, length must be less than `255`")
        if len(base_dn) < 0:
            raise ValueError("Invalid value for `base_dn`, length must be greater than or equal to `0`")
    ...
    def bind_dn(self, bind_dn):
        ...
        if bind_dn is not None and len(bind_dn) > 255: 
            raise ValueError("Invalid value for `bind_dn`, length must be less than `255`")
        if bind_dn is not None and len(bind_dn) < 0:
            raise ValueError("Invalid value for `bind_dn`, length must be greater than or equal to `0`")
    ...
    def bind_password(self, bind_password):
        ...
        if bind_password is not None and len(bind_password) > 255: 
            raise ValueError("Invalid value for `bind_password`, length must be less than `255`")
        if bind_password is not None and len(bind_password) < 0:
            raise ValueError("Invalid value for `bind_password`, length must be greater than or equal to `0`")
    ...
    def bind_timeout(self, bind_timeout):
        ...
        if bind_timeout is not None  and bind_timeout > 3600.0:
            raise ValueError("Invalid value for `bind_timeout`, must be a value less than or equal to `3600.0`")
        if bind_timeout is not None and bind_timeout < 1.0:
            raise ValueError("Invalid value for `bind_timeout`, must be a value greater than or equal to `1.0`")
    ...
    def certificate_authority_file(self, certificate_authority_file):
        ...
        if certificate_authority_file is not None and len(certificate_authority_file) > 4096: 
            raise ValueError("Invalid value for `certificate_authority_file`, length must be less than `4096`")
        if certificate_authority_file is not None and len(certificate_authority_file) < 0:
            raise ValueError("Invalid value for `certificate_authority_file`, length must be greater than or equal to `0`")
    ...
    def check_online_interval(self, check_online_interval):
        ...
        if check_online_interval is not None  and check_online_interval > 3600.0:
            raise ValueError("Invalid value for `check_online_interval`, must be a value less than or equal to `3600.0`")
        if check_online_interval is not None and check_online_interval < 0.0:
            raise ValueError("Invalid value for `check_online_interval`, must be a value greater than or equal to `0.0`")
    ...
    def email_attribute(self, email_attribute):
        ...
        if email_attribute is not None and len(email_attribute) > 64: 
            raise ValueError("Invalid value for `email_attribute`, length must be less than `64`")
        if email_attribute is not None and len(email_attribute) < 4:
            raise ValueError("Invalid value for `email_attribute`, length must be greater than or equal to `4`")
    ...
    def group_base_dn(self, group_base_dn):
        ...
        if group_base_dn is not None and len(group_base_dn) > 255: 
            raise ValueError("Invalid value for `group_base_dn`, length must be less than `255`")
        if group_base_dn is not None and len(group_base_dn) < 0:
            raise ValueError("Invalid value for `group_base_dn`, length must be greater than or equal to `0`")
    ...
    def group_domain(self, group_domain):
        ...
        if group_domain is not None and len(group_domain) > 255: 
            raise ValueError("Invalid value for `group_domain`, length must be less than `255`")
        if group_domain is not None and len(group_domain) < 0:
            raise ValueError("Invalid value for `group_domain`, length must be greater than or equal to `0`")
    ...
    def groupnet(self, groupnet):
        ...
        if groupnet is not None and len(groupnet) > 255: 
            raise ValueError("Invalid value for `groupnet`, length must be less than `255`")
        if groupnet is not None and len(groupnet) < 0:
            raise ValueError("Invalid value for `groupnet`, length must be greater than or equal to `0`")
    ...
    def member_of_attribute(self, member_of_attribute):
        ...
        if member_of_attribute is not None and len(member_of_attribute) > 255: 
            raise ValueError("Invalid value for `member_of_attribute`, length must be less than `255`")
        if member_of_attribute is not None and len(member_of_attribute) < 0:
            raise ValueError("Invalid value for `member_of_attribute`, length must be greater than or equal to `0`")
    ...
    def netgroup_base_dn(self, netgroup_base_dn):
        ...
        if netgroup_base_dn is not None and len(netgroup_base_dn) > 255: 
            raise ValueError("Invalid value for `netgroup_base_dn`, length must be less than `255`")
        if netgroup_base_dn is not None and len(netgroup_base_dn) < 0:
            raise ValueError("Invalid value for `netgroup_base_dn`, length must be greater than or equal to `0`")
    ...
    def provider_domain(self, provider_domain):
        ...
        if provider_domain is not None and len(provider_domain) > 255: 
            raise ValueError("Invalid value for `provider_domain`, length must be less than `255`")
        if provider_domain is not None and len(provider_domain) < 0:
            raise ValueError("Invalid value for `provider_domain`, length must be greater than or equal to `0`")
    ...
    def search_timeout(self, search_timeout):
        ...
        if search_timeout is not None  and search_timeout > 3600.0:
            raise ValueError("Invalid value for `search_timeout`, must be a value less than or equal to `3600.0`")
        if search_timeout is not None and search_timeout < 10.0:
            raise ValueError("Invalid value for `search_timeout`, must be a value greater than or equal to `10.0`")
    ...
    def shadow_expire_attribute(self):
        """
        Gets the shadow_expire_attribute of this ProvidersLdapItem.
        Sets the attribute name that indicates the absolute date to expire the account.

        :return: The shadow_expire_attribute of this ProvidersLdapItem.
        :rtype: str
        """
    ...
    def shadow_expire_attribute(self, shadow_expire_attribute):
        ...
        :param shadow_expire_attribute: The shadow_expire_attribute of this ProvidersLdapItem.
        :type: str
        """
    ...
    def shadow_flag_attribute(self):
        """
        Gets the shadow_flag_attribute of this ProvidersLdapItem.
        Sets the attribute name that indicates the section of the shadow map that is used to store the flag value.

        :return: The shadow_flag_attribute of this ProvidersLdapItem.
        :rtype: str
        """
    ...
    def shadow_flag_attribute(self, shadow_flag_attribute):
        ...
        :param shadow_flag_attribute: The shadow_flag_attribute of this ProvidersLdapItem.
        :type: str
        """
    ...
    def shadow_inactive_attribute(self):
        """
        Gets the shadow_inactive_attribute of this ProvidersLdapItem.
        Sets the attribute name that indicates the number of days of inactivity that is allowed for the user.

        :return: The shadow_inactive_attribute of this ProvidersLdapItem.
        :rtype: str
        """
    ...
    def shadow_inactive_attribute(self, shadow_inactive_attribute):
        ...
        :param shadow_inactive_attribute: The shadow_inactive_attribute of this ProvidersLdapItem.
        :type: str
        """
    ...
    def shadow_last_change_attribute(self):
        """
        Gets the shadow_last_change_attribute of this ProvidersLdapItem.
        Sets the attribute name that indicates the last change of the shadow information.

        :return: The shadow_last_change_attribute of this ProvidersLdapItem.
        :rtype: str
        """
    ...
    def shadow_last_change_attribute(self, shadow_last_change_attribute):
        ...
        :param shadow_last_change_attribute: The shadow_last_change_attribute of this ProvidersLdapItem.
        :type: str
        """
    ...
    def shadow_max_attribute(self):
        """
        Gets the shadow_max_attribute of this ProvidersLdapItem.
        Sets the attribute name that indicates the maximum number of days a password can be valid.

        :return: The shadow_max_attribute of this ProvidersLdapItem.
        :rtype: str
        """
    ...
    def shadow_max_attribute(self, shadow_max_attribute):
        ...
        :param shadow_max_attribute: The shadow_max_attribute of this ProvidersLdapItem.
        :type: str
        """
    ...
    def shadow_min_attribute(self):
        """
        Gets the shadow_min_attribute of this ProvidersLdapItem.
        Sets the attribute name that indicates the minimum number of days between shadow changes.

        :return: The shadow_min_attribute of this ProvidersLdapItem.
        :rtype: str
        """
    ...
    def shadow_min_attribute(self, shadow_min_attribute):
        ...
        :param shadow_min_attribute: The shadow_min_attribute of this ProvidersLdapItem.
        :type: str
        """
    ...
    def shadow_user_filter(self):
        """
        Gets the shadow_user_filter of this ProvidersLdapItem.
        Sets LDAP filter for shadow user objects.

        :return: The shadow_user_filter of this ProvidersLdapItem.
        :rtype: str
        """
    ...
    def shadow_user_filter(self, shadow_user_filter):
        ...
        :param shadow_user_filter: The shadow_user_filter of this ProvidersLdapItem.
        :type: str
        """
    ...
    def shadow_warning_attribute(self):
        """
        Gets the shadow_warning_attribute of this ProvidersLdapItem.
        Sets the attribute name that indicates the number of days before the password expires to warn the user.

        :return: The shadow_warning_attribute of this ProvidersLdapItem.
        :rtype: str
        """
    ...
    def shadow_warning_attribute(self, shadow_warning_attribute):
        ...
        :param shadow_warning_attribute: The shadow_warning_attribute of this ProvidersLdapItem.
        :type: str
        """
    ...
    def template(self):
        """
        Gets the template of this ProvidersLdapItem.
        ...
        :return: The template of this ProvidersLdapItem.
        :rtype: str
        """
    ...
    def template(self, template):
        ...
        :param template: The template of this ProvidersLdapItem.
        :type: str
        """
        
        if template is not None and len(template) > 255: 
            raise ValueError("Invalid value for `template`, length must be less than `255`")
        if template is not None and len(template) < 0:
            raise ValueError("Invalid value for `template`, length must be greater than or equal to `0`")
    ...
    def user_base_dn(self, user_base_dn):
        ...
        if user_base_dn is not None and len(user_base_dn) > 255: 
            raise ValueError("Invalid value for `user_base_dn`, length must be less than `255`")
        if user_base_dn is not None and len(user_base_dn) < 0:
            raise ValueError("Invalid value for `user_base_dn`, length must be greater than or equal to `0`")
    ...
    def user_domain(self, user_domain):
        ...
        if user_domain is not None and len(user_domain) > 255: 
            raise ValueError("Invalid value for `user_domain`, length must be less than `255`")
        if user_domain is not None and len(user_domain) < 0:
            raise ValueError("Invalid value for `user_domain`, length must be greater than or equal to `0`")
