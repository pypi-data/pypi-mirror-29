...
class HardwareFcportsNode(object):
    ...
    def __init__(self):
        """
        HardwareFcportsNode - a model defined in Swagger
    ...
    def error(self):
        """
        Gets the error of this HardwareFcportsNode.
        Error message, if the HTTP status returned from this node was not 200.

        :return: The error of this HardwareFcportsNode.
        :rtype: str
        """
        return self._error
    ...
    def error(self, error):
        ...
        :param error: The error of this HardwareFcportsNode.
        :type: str
        """
    ...
    def fcports(self):
        """
        Gets the fcports of this HardwareFcportsNode.
        A list of the FC ports on this node.

        :return: The fcports of this HardwareFcportsNode.
    ...
    def fcports(self, fcports):
        ...
        :param fcports: The fcports of this HardwareFcportsNode.
    ...
    def id(self):
        """
        Gets the id of this HardwareFcportsNode.
        Node ID of the node reporting this information.

        :return: The id of this HardwareFcportsNode.
        :rtype: int
        """
        return self._id
    ...
    def id(self, id):
        ...
        :param id: The id of this HardwareFcportsNode.
        :type: int
        """
    ...
    def lnn(self):
        """
        Gets the lnn of this HardwareFcportsNode.
        Logical node number of the node reporting this information.

        :return: The lnn of this HardwareFcportsNode.
        :rtype: int
        """
        return self._lnn
    ...
    def lnn(self, lnn):
        ...
        :param lnn: The lnn of this HardwareFcportsNode.
        :type: int
        """
    ...
    def status(self):
        """
        Gets the status of this HardwareFcportsNode.
        Status of the HTTP response from this node if not 200.  If 200, this field does not appear.

        :return: The status of this HardwareFcportsNode.
        :rtype: int
        """
        return self._status
    ...
    def status(self, status):
        ...
        :param status: The status of this HardwareFcportsNode.
        :type: int
        """
