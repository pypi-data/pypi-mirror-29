...
class SummaryProtocolStatsProtocolStatsNetworkIn(object):
    ...
    def __init__(self):
        """
        SummaryProtocolStatsProtocolStatsNetworkIn - a model defined in Swagger
    ...
    def errors_per_sec(self):
        """
        Gets the errors_per_sec of this SummaryProtocolStatsProtocolStatsNetworkIn.
        Network input errors per-second

        :return: The errors_per_sec of this SummaryProtocolStatsProtocolStatsNetworkIn.
        :rtype: float
        """
    ...
    def errors_per_sec(self, errors_per_sec):
        ...
        :param errors_per_sec: The errors_per_sec of this SummaryProtocolStatsProtocolStatsNetworkIn.
        :type: float
        """
    ...
    def megabytes_per_sec(self):
        """
        Gets the megabytes_per_sec of this SummaryProtocolStatsProtocolStatsNetworkIn.
        Network input megabytes per-second

        :return: The megabytes_per_sec of this SummaryProtocolStatsProtocolStatsNetworkIn.
        :rtype: float
        """
    ...
    def megabytes_per_sec(self, megabytes_per_sec):
        ...
        :param megabytes_per_sec: The megabytes_per_sec of this SummaryProtocolStatsProtocolStatsNetworkIn.
        :type: float
        """
    ...
    def packets_per_sec(self):
        """
        Gets the packets_per_sec of this SummaryProtocolStatsProtocolStatsNetworkIn.
        Network input packets per-second

        :return: The packets_per_sec of this SummaryProtocolStatsProtocolStatsNetworkIn.
        :rtype: float
        """
    ...
    def packets_per_sec(self, packets_per_sec):
        ...
        :param packets_per_sec: The packets_per_sec of this SummaryProtocolStatsProtocolStatsNetworkIn.
        :type: float
        """
