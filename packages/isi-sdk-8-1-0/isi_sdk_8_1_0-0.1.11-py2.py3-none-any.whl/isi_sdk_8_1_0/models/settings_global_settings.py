...
class SettingsGlobalSettings(object):
    ...
    def cee_log_time(self, cee_log_time):
        ...
        if cee_log_time is not None and len(cee_log_time) > 255: 
            raise ValueError("Invalid value for `cee_log_time`, length must be less than `255`")
        if cee_log_time is not None and len(cee_log_time) < 0:
            raise ValueError("Invalid value for `cee_log_time`, length must be greater than or equal to `0`")
    ...
    def syslog_log_time(self, syslog_log_time):
        ...
        if syslog_log_time is not None and len(syslog_log_time) > 255: 
            raise ValueError("Invalid value for `syslog_log_time`, length must be less than `255`")
        if syslog_log_time is not None and len(syslog_log_time) < 0:
            raise ValueError("Invalid value for `syslog_log_time`, length must be greater than or equal to `0`")
