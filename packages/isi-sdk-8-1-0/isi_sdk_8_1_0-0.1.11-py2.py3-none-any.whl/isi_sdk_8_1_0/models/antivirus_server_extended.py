...
class AntivirusServerExtended(object):
    ...
    def url(self, url):
        ...
        if url is not None and len(url) > 2048: 
            raise ValueError("Invalid value for `url`, length must be less than `2048`")
    ...
    def definitions(self, definitions):
        ...
        if definitions is not None and len(definitions) > 255: 
            raise ValueError("Invalid value for `definitions`, length must be less than `255`")
        if definitions is not None and len(definitions) < 0:
            raise ValueError("Invalid value for `definitions`, length must be greater than or equal to `0`")
