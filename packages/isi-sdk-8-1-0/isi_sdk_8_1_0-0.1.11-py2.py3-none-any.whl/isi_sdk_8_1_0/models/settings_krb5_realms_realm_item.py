...
class SettingsKrb5RealmsRealmItem(object):
    ...
    def admin_server(self, admin_server):
        ...
        if admin_server is not None and len(admin_server) > 255: 
            raise ValueError("Invalid value for `admin_server`, length must be less than `255`")
        if admin_server is not None and len(admin_server) < 0:
            raise ValueError("Invalid value for `admin_server`, length must be greater than or equal to `0`")
    ...
    def default_domain(self, default_domain):
        ...
        if default_domain is not None and len(default_domain) > 255: 
            raise ValueError("Invalid value for `default_domain`, length must be less than `255`")
        if default_domain is not None and len(default_domain) < 0:
            raise ValueError("Invalid value for `default_domain`, length must be greater than or equal to `0`")
