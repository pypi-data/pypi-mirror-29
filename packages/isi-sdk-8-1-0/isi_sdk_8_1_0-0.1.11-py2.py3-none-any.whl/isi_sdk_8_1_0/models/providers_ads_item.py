...
class ProvidersAdsItem(object):
    ...
    def account(self, account):
        ...
        if account is not None and len(account) > 255: 
            raise ValueError("Invalid value for `account`, length must be less than `255`")
    ...
    def dns_domain(self, dns_domain):
        ...
        if dns_domain is not None and len(dns_domain) < 2:
            raise ValueError("Invalid value for `dns_domain`, length must be greater than or equal to `2`")
    ...
    def organizational_unit(self, organizational_unit):
        ...
        if organizational_unit is not None and len(organizational_unit) > 255: 
            raise ValueError("Invalid value for `organizational_unit`, length must be less than `255`")
        if organizational_unit is not None and len(organizational_unit) < 0:
            raise ValueError("Invalid value for `organizational_unit`, length must be greater than or equal to `0`")
    ...
    def password(self, password):
        ...
        if len(password) > 255: 
            raise ValueError("Invalid value for `password`, length must be less than `255`")
        if len(password) < 0:
    ...
    def user(self, user):
        ...
        if len(user) > 256: 
            raise ValueError("Invalid value for `user`, length must be less than `256`")
        if len(user) < 0:
