...
class AntivirusSettingsSettings(object):
    ...
    def report_expiry(self, report_expiry):
        ...
        if report_expiry is not None  and report_expiry > 4.294967295E9:
            raise ValueError("Invalid value for `report_expiry`, must be a value less than or equal to `4.294967295E9`")
    ...
    def scan_size_maximum(self, scan_size_maximum):
        ...
        if scan_size_maximum is not None  and scan_size_maximum > 4.294967295E9:
            raise ValueError("Invalid value for `scan_size_maximum`, must be a value less than or equal to `4.294967295E9`")
