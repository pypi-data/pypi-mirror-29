...
class QuotaApi(object):
    ...
    def delete_quota_quotas(self, **kwargs):
        ...
        all_params = ['enforced', 'include_snapshots', 'zone', 'recurse_path_children', 'recurse_path_parents', 'persona', 'path', 'type']
        all_params.append('callback')
    ...
    def get_quota_license(self, **kwargs):
        ...
        resource_path = '/platform/5/quota/license'.replace('{format}', 'json')
        path_params = {}
    ...
    def list_quota_quotas(self, **kwargs):
        ...
        if 'limit' in params and params['limit'] > 4.294967295E9: 
            raise ValueError("Invalid value for parameter `limit` when calling `list_quota_quotas`, must be a value less than or equal to  `4.294967295E9`")
    ...
    def list_quota_reports(self, **kwargs):
        ...
        if 'limit' in params and params['limit'] > 4.294967295E9: 
            raise ValueError("Invalid value for parameter `limit` when calling `list_quota_reports`, must be a value less than or equal to  `4.294967295E9`")
        if 'limit' in params and params['limit'] < 1.0: 
