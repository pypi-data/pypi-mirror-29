...
class EventApi(object):
    ...
    def get_event_categories(self, **kwargs):
        ...
        if 'limit' in params and params['limit'] > 4.294967295E9: 
            raise ValueError("Invalid value for parameter `limit` when calling `get_event_categories`, must be a value less than or equal to  `4.294967295E9`")
    ...
    def get_event_eventgroup_definitions(self, **kwargs):
        ...
        if 'limit' in params and params['limit'] > 4.294967295E9: 
            raise ValueError("Invalid value for parameter `limit` when calling `get_event_eventgroup_definitions`, must be a value less than or equal to  `4.294967295E9`")
        if 'limit' in params and params['limit'] < 1.0: 
    ...
    def get_event_eventgroup_occurrences(self, **kwargs):
        ...
        all_params = ['resolved', 'sort', 'begin', 'end', 'event_count', 'resume', 'ignore', 'limit', 'resolver', 'cause', 'dir']
        all_params.append('callback')
        ...
        if 'limit' in params and params['limit'] > 4.294967295E9: 
            raise ValueError("Invalid value for parameter `limit` when calling `get_event_eventgroup_occurrences`, must be a value less than or equal to  `4.294967295E9`")
        if 'limit' in params and params['limit'] < 1.0: 
        ...
        if 'resolver' in params:
            query_params['resolver'] = params['resolver']
        if 'cause' in params:
    ...
    def get_event_eventlists(self, **kwargs):
        ...
        if 'limit' in params and params['limit'] > 4.294967295E9: 
            raise ValueError("Invalid value for parameter `limit` when calling `get_event_eventlists`, must be a value less than or equal to  `4.294967295E9`")
        if 'limit' in params and params['limit'] < 1.0: 
    ...
    def list_event_alert_conditions(self, **kwargs):
        ...
        all_params = ['channels', 'sort', 'limit', 'dir', 'resume']
        all_params.append('callback')
        ...
        if 'limit' in params and params['limit'] > 4.294967295E9: 
            raise ValueError("Invalid value for parameter `limit` when calling `list_event_alert_conditions`, must be a value less than or equal to  `4.294967295E9`")
        if 'limit' in params and params['limit'] < 1.0: 
    ...
    def list_event_channels(self, **kwargs):
        ...
        if 'limit' in params and params['limit'] > 4.294967295E9: 
            raise ValueError("Invalid value for parameter `limit` when calling `list_event_channels`, must be a value less than or equal to  `4.294967295E9`")
        if 'limit' in params and params['limit'] < 1.0: 
