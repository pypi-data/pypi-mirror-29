...
class NetworkGroupnetsSubnetsApi(object):
    ...
    def get_pools_pool_interfaces(self, groupnet, subnet, pool, **kwargs):
        ...
        if 'limit' in params and params['limit'] > 4.294967295E9: 
            raise ValueError("Invalid value for parameter `limit` when calling `get_pools_pool_interfaces`, must be a value less than or equal to  `4.294967295E9`")
        ...
        resource_path = '/platform/4/network/groupnets/{Groupnet}/subnets/{Subnet}/pools/{Pool}/interfaces'.replace('{format}', 'json')
        path_params = {}
        if 'groupnet' in params:
            path_params['Groupnet'] = params['groupnet']
        if 'subnet' in params:
    ...
    def list_pools_pool_rules(self, groupnet, subnet, pool, **kwargs):
        ...
        if 'limit' in params and params['limit'] > 4.294967295E9: 
            raise ValueError("Invalid value for parameter `limit` when calling `list_pools_pool_rules`, must be a value less than or equal to  `4.294967295E9`")
        if 'limit' in params and params['limit'] < 1.0: 
