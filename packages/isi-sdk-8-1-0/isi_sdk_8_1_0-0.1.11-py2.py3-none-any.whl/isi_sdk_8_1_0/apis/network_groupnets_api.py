...
class NetworkGroupnetsApi(object):
    ...
    def create_groupnet_subnet(self, groupnet_subnet, groupnet, **kwargs):
        ...
        resource_path = '/platform/4/network/groupnets/{Groupnet}/subnets'.replace('{format}', 'json')
        path_params = {}
    ...
    def delete_groupnet_subnet(self, groupnet_subnet_id, groupnet, **kwargs):
        ...
        resource_path = '/platform/4/network/groupnets/{Groupnet}/subnets/{GroupnetSubnetId}'.replace('{format}', 'json')
        path_params = {}
    ...
    def list_groupnet_subnets(self, groupnet, **kwargs):
        ...
        if 'limit' in params and params['limit'] > 4.294967295E9: 
            raise ValueError("Invalid value for parameter `limit` when calling `list_groupnet_subnets`, must be a value less than or equal to  `4.294967295E9`")
    ...
    def list_subnets_subnet_pools(self, groupnet, subnet, **kwargs):
        ...
        if 'limit' in params and params['limit'] > 4.294967295E9: 
            raise ValueError("Invalid value for parameter `limit` when calling `list_subnets_subnet_pools`, must be a value less than or equal to  `4.294967295E9`")
        if 'limit' in params and params['limit'] < 1.0: 
