...
class UpgradeApi(object):
    ...
    def create_cluster_assess_item(self, cluster_assess_item, **kwargs):
        ...
        resource_path = '/platform/5/upgrade/cluster/assess'.replace('{format}', 'json')
        path_params = {}
    ...
    def create_cluster_patch_patche(self, cluster_patch_patche, **kwargs):
        """
        ...
        >>>     pprint(response)
        >>>
        >>> thread = api.create_cluster_patch_patche(cluster_patch_patche, callback=callback_function)

        :param callback function: The callback function
            for asynchronous request. (optional)
        :param ClusterPatchPatche cluster_patch_patche:  (required)
        ...
        all_params = ['cluster_patch_patche', 'override', 'rolling']
        all_params.append('callback')
        ...
        for key, val in iteritems(params['kwargs']):
            if key not in all_params:
                raise TypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method create_cluster_patch_patche" % key
                )
            params[key] = val
        del params['kwargs']

        # verify the required parameter 'cluster_patch_patche' is set
        if ('cluster_patch_patche' not in params) or (params['cluster_patch_patche'] is None):
            raise ValueError("Missing the required parameter `cluster_patch_patche` when calling `create_cluster_patch_patche`")


        resource_path = '/platform/3/upgrade/cluster/patch/patches'.replace('{format}', 'json')
        path_params = {}
        ...
        if 'rolling' in params:
            query_params['rolling'] = params['rolling']
        ...
        body_params = None
        if 'cluster_patch_patche' in params:
            body_params = params['cluster_patch_patche']
    ...
    def create_cluster_upgrade_item(self, cluster_upgrade_item, **kwargs):
        ...
        resource_path = '/platform/5/upgrade/cluster/upgrade'.replace('{format}', 'json')
        path_params = {}
    ...
    def delete_cluster_patch_patche(self, cluster_patch_patche_id, **kwargs):
        """
        ...
        >>>     pprint(response)
        >>>
        >>> thread = api.delete_cluster_patch_patche(cluster_patch_patche_id, callback=callback_function)

        :param callback function: The callback function
            for asynchronous request. (optional)
        :param str cluster_patch_patche_id: Uninstall a patch. (required)
        ...
        all_params = ['cluster_patch_patche_id', 'override', 'rolling']
        all_params.append('callback')
        ...
        for key, val in iteritems(params['kwargs']):
            if key not in all_params:
                raise TypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method delete_cluster_patch_patche" % key
                )
            params[key] = val
        del params['kwargs']

        # verify the required parameter 'cluster_patch_patche_id' is set
        if ('cluster_patch_patche_id' not in params) or (params['cluster_patch_patche_id'] is None):
            raise ValueError("Missing the required parameter `cluster_patch_patche_id` when calling `delete_cluster_patch_patche`")


        resource_path = '/platform/3/upgrade/cluster/patch/patches/{ClusterPatchPatcheId}'.replace('{format}', 'json')
        path_params = {}
        if 'cluster_patch_patche_id' in params:
            path_params['ClusterPatchPatcheId'] = params['cluster_patch_patche_id']
    ...
    def get_cluster_patch_patche(self, cluster_patch_patche_id, **kwargs):
        """
        ...
        >>>     pprint(response)
        >>>
        >>> thread = api.get_cluster_patch_patche(cluster_patch_patche_id, callback=callback_function)

        :param callback function: The callback function
            for asynchronous request. (optional)
        :param str cluster_patch_patche_id: View a single patch. (required)
        ...
        all_params = ['cluster_patch_patche_id', 'local', 'location']
        all_params.append('callback')
        ...
        for key, val in iteritems(params['kwargs']):
            if key not in all_params:
                raise TypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method get_cluster_patch_patche" % key
                )
            params[key] = val
        del params['kwargs']
        ...
        # verify the required parameter 'cluster_patch_patche_id' is set
        if ('cluster_patch_patche_id' not in params) or (params['cluster_patch_patche_id'] is None):
            raise ValueError("Missing the required parameter `cluster_patch_patche_id` when calling `get_cluster_patch_patche`")
        ...
        query_params = {}
        if 'local' in params:
            query_params['local'] = params['local']
        ...
        response = self.api_client.call_api(resource_path, 'GET',
                                            ...
                                            post_params=form_params,
                                            files=local_var_files,
                                            response_type='ClusterPatchPatches',
                                            auth_settings=auth_settings,
                                            callback=params.get('callback'))
        return response

    def get_hardware_status(self, **kwargs):
        """
        ...
        >>>     pprint(response)
        >>>
        >>> thread = api.get_hardware_status(callback=callback_function)
        ...
        resource_path = '/platform/5/upgrade/hardware/status'.replace('{format}', 'json')
        path_params = {}
    ...
    def get_upgrade_cluster(self, **kwargs):
        ...
        resource_path = '/platform/4/upgrade/cluster'.replace('{format}', 'json')
        path_params = {}
    ...
    def list_cluster_patch_patches(self, **kwargs):
        """
        ...
        >>>     pprint(response)
        >>>
        >>> thread = api.list_cluster_patch_patches(callback=callback_function)
        ...
        all_params = ['sort', 'resume', 'limit', 'location', 'local', 'dir']
        all_params.append('callback')
        ...
        if 'limit' in params and params['limit'] > 4.294967295E9: 
            raise ValueError("Invalid value for parameter `limit` when calling `list_cluster_patch_patches`, must be a value less than or equal to  `4.294967295E9`")
        if 'limit' in params and params['limit'] < 1.0: 
            raise ValueError("Invalid value for parameter `limit` when calling `list_cluster_patch_patches`, must be a value greater than or equal to `1.0`")
        ...
        response = self.api_client.call_api(resource_path, 'GET',
                                            ...
                                            post_params=form_params,
                                            files=local_var_files,
                                            response_type='ClusterPatchPatchesExtended',
                                            auth_settings=auth_settings,
                                            callback=params.get('callback'))
        return response
