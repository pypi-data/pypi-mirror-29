...
class HardwareApi(object):
    ...
    def create_hardware_tape_name(self, hardware_tape_name, **kwargs):
        ...
        all_params = ['hardware_tape_name', 'lnn', 'port', 'timeout', 'reconcile']
        ...
        response = self.api_client.call_api(resource_path, 'POST',
                                            ...
                                            response_type='CreateHardwareTapeNameResponse',
    ...
    def get_hardware_fcports(self, **kwargs):
        """
        ...
        >>>     pprint(response)
        >>>
        >>> thread = api.get_hardware_fcports(callback=callback_function)
        ...
        if 'limit' in params and params['limit'] > 4.294967295E9: 
            raise ValueError("Invalid value for parameter `limit` when calling `get_hardware_fcports`, must be a value less than or equal to  `4.294967295E9`")
        if 'limit' in params and params['limit'] < 1.0: 
            raise ValueError("Invalid value for parameter `limit` when calling `get_hardware_fcports`, must be a value greater than or equal to `1.0`")

        resource_path = '/platform/3/hardware/fcports'.replace('{format}', 'json')
        path_params = {}
    ...
    def get_hardware_tapes(self, **kwargs):
        ...
        if 'limit' in params and params['limit'] > 4.294967295E9: 
            raise ValueError("Invalid value for parameter `limit` when calling `get_hardware_tapes`, must be a value less than or equal to  `4.294967295E9`")
        if 'limit' in params and params['limit'] < 1.0: 
