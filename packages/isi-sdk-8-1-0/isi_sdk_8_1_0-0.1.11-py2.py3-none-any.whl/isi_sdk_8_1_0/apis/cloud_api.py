...
class CloudApi(object):
    ...
    def create_settings_encryption_key_item(self, settings_encryption_key_item, **kwargs):
        """
        ...
        >>>     pprint(response)
        >>>
        >>> thread = api.create_settings_encryption_key_item(settings_encryption_key_item, callback=callback_function)
        ...
        all_params = ['settings_encryption_key_item']
        all_params.append('callback')
        ...
        if ('settings_encryption_key_item' not in params) or (params['settings_encryption_key_item'] is None):
            raise ValueError("Missing the required parameter `settings_encryption_key_item` when calling `create_settings_encryption_key_item`")
    ...
    def delete_cloud_account(self, cloud_account_id, **kwargs):
        ...
        all_params = ['cloud_account_id', 'acknowledge_force_delete']
        all_params.append('callback')
        ...
        if 'acknowledge_force_delete' in params:
            query_params['acknowledge_force_delete'] = params['acknowledge_force_delete']
    ...
    def delete_cloud_pool(self, cloud_pool_id, **kwargs):
        ...
        all_params = ['cloud_pool_id', 'acknowledge_force_delete']
        all_params.append('callback')
    ...
    def get_cloud_jobs_file(self, cloud_jobs_file_id, **kwargs):
        ...
        if 'limit' in params and params['limit'] > 4.294967295E9: 
            raise ValueError("Invalid value for parameter `limit` when calling `get_cloud_jobs_file`, must be a value less than or equal to  `4.294967295E9`")
    ...
    def list_cloud_access(self, **kwargs):
        ...
        if 'limit' in params and params['limit'] > 4.294967295E9: 
            raise ValueError("Invalid value for parameter `limit` when calling `list_cloud_access`, must be a value less than or equal to  `4.294967295E9`")
        if 'limit' in params and params['limit'] < 1.0: 
    ...
    def list_cloud_accounts(self, **kwargs):
        ...
        if 'limit' in params and params['limit'] > 4.294967295E9: 
            raise ValueError("Invalid value for parameter `limit` when calling `list_cloud_accounts`, must be a value less than or equal to  `4.294967295E9`")
        if 'limit' in params and params['limit'] < 1.0: 
    ...
    def list_cloud_jobs(self, **kwargs):
        ...
        if 'limit' in params and params['limit'] > 4.294967295E9: 
            raise ValueError("Invalid value for parameter `limit` when calling `list_cloud_jobs`, must be a value less than or equal to  `4.294967295E9`")
        if 'limit' in params and params['limit'] < 1.0: 
    ...
    def list_cloud_pools(self, **kwargs):
        ...
        if 'limit' in params and params['limit'] > 4.294967295E9: 
            raise ValueError("Invalid value for parameter `limit` when calling `list_cloud_pools`, must be a value less than or equal to  `4.294967295E9`")
        if 'limit' in params and params['limit'] < 1.0: 
    ...
    def list_cloud_proxies(self, **kwargs):
        ...
        if 'limit' in params and params['limit'] > 4.294967295E9: 
            raise ValueError("Invalid value for parameter `limit` when calling `list_cloud_proxies`, must be a value less than or equal to  `4.294967295E9`")
        if 'limit' in params and params['limit'] < 1.0: 
