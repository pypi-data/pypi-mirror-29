...
class ClusterApi(object):
    ...
    def get_cluster_identity(self, **kwargs):
        ...
        resource_path = '/platform/5/cluster/identity'.replace('{format}', 'json')
        path_params = {}
    ...
    def get_cluster_node(self, cluster_node_id, **kwargs):
        ...
        all_params = ['cluster_node_id', 'timeout']
        all_params.append('callback')
        ...
        if 'timeout' in params and params['timeout'] > 4.294967295E9: 
            raise ValueError("Invalid value for parameter `timeout` when calling `get_cluster_node`, must be a value less than or equal to  `4.294967295E9`")
        if 'timeout' in params and params['timeout'] < 0.0: 
            raise ValueError("Invalid value for parameter `timeout` when calling `get_cluster_node`, must be a value greater than or equal to `0.0`")

        resource_path = '/platform/5/cluster/nodes/{ClusterNodeId}'.replace('{format}', 'json')
        path_params = {}
    ...
    def get_cluster_nodes(self, **kwargs):
        ...
        if 'timeout' in params and params['timeout'] > 4.294967295E9: 
            raise ValueError("Invalid value for parameter `timeout` when calling `get_cluster_nodes`, must be a value less than or equal to  `4.294967295E9`")
        if 'timeout' in params and params['timeout'] < 0.0: 
            raise ValueError("Invalid value for parameter `timeout` when calling `get_cluster_nodes`, must be a value greater than or equal to `0.0`")

        resource_path = '/platform/5/cluster/nodes'.replace('{format}', 'json')
        path_params = {}
    ...
    def get_diagnostics_netlogger(self, **kwargs):
        ...
        response = self.api_client.call_api(resource_path, 'GET',
                                            ...
                                            post_params=form_params,
                                            files=local_var_files,
                                            response_type='DiagnosticsNetloggerStatus',
                                            auth_settings=auth_settings,
                                            callback=params.get('callback'))
        return response
    ...
    def get_timezone_region(self, timezone_region_id, **kwargs):
        ...
        if 'limit' in params and params['limit'] > 4.294967295E9: 
            raise ValueError("Invalid value for parameter `limit` when calling `get_timezone_region`, must be a value less than or equal to  `4.294967295E9`")
