...
class AuthProvidersApi(object):
    ...
    def get_ads_provider_controllers(self, id, **kwargs):
        ...
        resource_path = '/platform/3/auth/providers/ads/{Id}/controllers'.replace('{format}', 'json')
        path_params = {}
        if 'id' in params:
    ...
    def get_ads_provider_search(self, id, **kwargs):
        ...
        if 'limit' in params and params['limit'] > 4.294967295E9: 
            raise ValueError("Invalid value for parameter `limit` when calling `get_ads_provider_search`, must be a value less than or equal to  `4.294967295E9`")
