...
class LicenseApi(object):
    ...
    def create_license_license(self, license_license, **kwargs):
        ...
        resource_path = '/platform/5/license/licenses'.replace('{format}', 'json')
        path_params = {}
    ...
    def get_license_eula(self, **kwargs):
        """
        ...
        >>>     pprint(response)
        >>>
        >>> thread = api.get_license_eula(callback=callback_function)
        ...
        for key, val in iteritems(params['kwargs']):
            if key not in all_params:
                raise TypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method get_license_eula" % key
                )
            params[key] = val
        del params['kwargs']
        ...
        resource_path = '/platform/1/license/eula'.replace('{format}', 'json')
        path_params = {}
    ...
    def get_license_generate(self, **kwargs):
        """
        ...
        >>>     pprint(response)
        >>>
        >>> thread = api.get_license_generate(callback=callback_function)
        ...
        all_params = ['action', 'licenses_to_include', 'licenses_to_exclude', 'only_these_licenses']
        all_params.append('callback')
        ...
        resource_path = '/platform/5/license/generate'.replace('{format}', 'json')
        path_params = {}
        ...
        if 'licenses_to_include' in params:
            query_params['licenses_to_include'] = params['licenses_to_include']
        if 'licenses_to_exclude' in params:
            query_params['licenses_to_exclude'] = params['licenses_to_exclude']
        if 'only_these_licenses' in params:
            query_params['only_these_licenses'] = params['only_these_licenses']
    ...
    def get_license_license(self, license_license_id, **kwargs):
        ...
        resource_path = '/platform/5/license/licenses/{LicenseLicenseId}'.replace('{format}', 'json')
        path_params = {}
    ...
    def list_license_licenses(self, **kwargs):
        ...
        response = self.api_client.call_api(resource_path, 'GET',
                                            ...
                                            post_params=form_params,
                                            files=local_var_files,
                                            response_type='LicenseLicensesExtended',
                                            auth_settings=auth_settings,
                                            callback=params.get('callback'))
        return response
