    ...
    if not file:
        ...
        try:
            with open(file) as setting_file:
                ...
                data, not_found = LocationGrouping().group_locations(locations, schedules, settings.get('mergeIdentical'))
                ...
                Routing.merge_routes(inhouse_routes=inhouse, public_routes=public, drivers=drivers)
