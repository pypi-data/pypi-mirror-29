...
def run():
	if CheckConnection() == False:
		...
		print
		print "enter unsigned transaction data:"
		data = raw_input()
		print 
		print "enter sender private key (NEVER save or input on a connected computer!):"
		try:
			signed_data = sign_tx(data, raw_input())
			os.system('reset')
			if signed_data != -1:
				...
				print signed_data
				print
				print "Copy the data above to broadcast the transaction.\nFor maximal security exit Shell before going back online." 
			else:
