...
class CourseRegistrationAdmin(SubjectRegistrationBaseAdmin):
    ...
    def course_discounts(self, obj):
        ...
        for period in obj.get_period_payment_statuses():
            html.append(format_html(
                '{period}: <a class="related-lookup" href="{href}"><b>{amount}</b></a>',
        ...
        if obj.approved:
            html.append(format_html(
                ' &nbsp; <a class="related-lookup" class="addlink" href="{href}"'
    ...
    def course_payments(self, obj):
        ...
        for period in obj.get_period_payment_statuses():
            html.append(format_html(
                '{period}: <a class="related-lookup" style="color: {color}" href="{href}" title="{title}"><b>{amount}</b></a>',
                period  = period.period.name,
