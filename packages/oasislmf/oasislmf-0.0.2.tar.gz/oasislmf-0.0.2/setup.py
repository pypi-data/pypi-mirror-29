...
setup(
    ...
    description='Loss modeling framework.',
    long_description=readme,
    url='https://github.com/OasisLMF/oasislmf',
    author='Dan Bate, Oasis Loss Modeling Framework',
    author_email="Dan Bate <dan.bate@wildfish.com>,Oasis LMF <support@oasislmf.org>",
    keywords='oasis loss modeling framework catastrophe risk insurance reinsurance',
