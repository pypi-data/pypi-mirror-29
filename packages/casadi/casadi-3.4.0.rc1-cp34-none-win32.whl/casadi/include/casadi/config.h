...
#define CASADI_VERSION_STRING "3.4.0-rc1"
#define CASADI_GIT_REVISION "d3e0d8d3caa8cd7dcc4d20b35c0504c101ad63b0"  // NOLINT(whitespace/line_length)
#define CASADI_GIT_DESCRIBE "3.3.0-204.d3e0d8d3c"  // NOLINT(whitespace/line_length)
