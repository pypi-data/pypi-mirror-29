...
def entry(
    ...
    '''
    Function for create, updating, and deleting Knack records.
    '''
    ...
    if method == 'create':
        ...
        raise Exception('Invalid methond: {}'.format(method))
...
def _request(data, endpoint, headers, method, timeout=10, max_attempts=5):
