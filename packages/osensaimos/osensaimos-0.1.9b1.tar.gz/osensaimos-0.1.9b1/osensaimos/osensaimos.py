...
class IMOS():
    ...
    def start_stream(self, param1, param2, param3, stream_rate, update_function=None, save_to_flash=False):
        ...
        Args:
            ...
            * save_to_flash (boolean): Boolean to indicate whether or not to save stream settings to flash
        ...
        try:
            ...
            self.setup_stream([param1, param2, param3],stream_rate, saveToFlash=save_to_flash) 
