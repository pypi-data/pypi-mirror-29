...
setup(
    ...
    description='A many job submission tool',  # Required
    ...
    source_url = "https://github.com/samkos/yalla/commit/1fb08feff378d736d0f32b05dbbd8abcbe379825",
...
#                ('scripts', ['decimate/scripts/end_job.sh']),
                ...
                ('yalla/avanti', glob.glob('yalla/avanti/*')),
                ('yalla/pp', glob.glob('yalla/pp/*')),
                # ('docs', glob.glob('docs/*'))
    ],  # Optional
