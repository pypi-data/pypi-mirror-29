...
class RestServerConnection(object):
    ...
    def get_run_id(api_key, project_name):
        ...
        r = requests.post(url=endpoint_url, data=json.dumps(payload),
...
class Reporting(object):
    ...
    @staticmethod
    def report(event_name=None,api_key=None,run_id=None,experiment_key=None,project_id=None,err_msg=None, is_alive=None):

        try:
            if event_name is not None:
                endpoint_url = server_address + "notify"
                headers = {'Content-Type': 'application/json;charset=utf-8'}
