...
setup(
    ...
    keywords=['django'],
    packages=['pipinator', 'pipinator.website'],
    data_files=[
        ('pipinator/website/templates', ['pipinator/website/templates/index.html']),
      #  ('pipinator/website/static', ['pipinator/website/static/mountain-big.jpg']),
    ],
    entry_points={
        'console_scripts': [
