...
class PyMysqlDB:
    def __init__(self, host=None, user=None, pwd=None, port=3306, base_path=None, backup_path=None):
        self.host = host
        self.user = user
        self.pwd = pwd
        self.port = int(port)
    ...
    def backup_all(self):
        ...
        db_list = [val for val in self.select_database() if val not in exclude]
