    ...
    for residue in location_dict:
        ...
        for offset, location in zip(offsets, locations):
            ...
            if not use_actual_sections:
                ## Slightly horrible hack to address Issue #5 http://hcp004.hartree.stfc.ac.uk/RobFirth/PDB-protein-res/issues/5
                if "results" in annsdict["section"].lower():
                    annsdict["section"] = "Results"
                else:
                    annsdict["section"] = "Discussion"
