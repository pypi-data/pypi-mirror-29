...
def get_processed_files_list(db_host, db_user_name, db_password, db_schema, db_port, db_driver, days_back,
    ...
    with pyodbc.connect('DRIVER=' + db_driver + ';PORT=' + str(db_port) + ';SERVER=' + db_host + ';PORT=' + str(
            db_port) + ';DATABASE=' + db_schema + ';UID=' + db_user_name + ';PWD=' + db_password).cursor() as cursor:
...
def update_processed_files_list(db_host, db_user_name, db_password, db_schema, db_port, db_driver, file_name, file_date,
...
def update_processed_time(db_host, db_user_name, db_password, db_schema, db_port, file_date, processed_time,
                          data_source, db_driver, file_name=None):
    """
