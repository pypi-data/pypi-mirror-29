...
class ModelOutputEntity(object):
    ...
    """
    def __init__(self, name=None, description=None, author=None, type=None, runtime_environment=None, training_data_schema=None, label_col=None, input_data_schema=None, pipeline_version=None, versions_href=None, latest_version=None):
        """
