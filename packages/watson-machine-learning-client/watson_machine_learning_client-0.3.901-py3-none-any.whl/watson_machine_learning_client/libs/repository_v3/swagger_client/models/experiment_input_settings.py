...
class ExperimentInputSettings(object):
    ...
    """
    def __init__(self, name=None, description=None, author=None, label_column=None, hyper_parameters_optimization=None, evaluation_definition=None):
        """
    ...
    def hyper_parameters_optimization(self):
        """
        Gets the hyper_parameters_optimization of this ExperimentInputSettings.


        :return: The hyper_parameters_optimization of this ExperimentInputSettings.
    ...
    def hyper_parameters_optimization(self, hyper_parameters_optimization):
        """
        Sets the hyper_parameters_optimization of this ExperimentInputSettings.


        :param hyper_parameters_optimization: The hyper_parameters_optimization of this ExperimentInputSettings.
