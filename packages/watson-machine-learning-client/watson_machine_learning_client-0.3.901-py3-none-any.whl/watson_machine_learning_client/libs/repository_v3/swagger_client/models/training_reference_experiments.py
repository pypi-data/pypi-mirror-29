...
class TrainingReferenceExperiments(object):
    ...
    """
    def __init__(self, name=None, training_definition_url=None, command=None, hyper_parameters=None, compute_configuration=None, pretrained_model_url=None):
        """
    ...
    def hyper_parameters(self):
        """
        Gets the hyper_parameters of this TrainingReferenceExperiments.
        It is not used for model_definition

        :return: The hyper_parameters of this TrainingReferenceExperiments.
    ...
    def hyper_parameters(self, hyper_parameters):
        """
        Sets the hyper_parameters of this TrainingReferenceExperiments.
        It is not used for model_definition

        :param hyper_parameters: The hyper_parameters of this TrainingReferenceExperiments.
