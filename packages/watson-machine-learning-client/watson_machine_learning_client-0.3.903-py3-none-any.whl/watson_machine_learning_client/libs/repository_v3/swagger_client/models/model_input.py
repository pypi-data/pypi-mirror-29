...
class ModelInput(object):
    ...
    """
    def __init__(self, name=None, description=None, author=None, pipeline_version_href=None, type=None, runtime_environment=None, training_data_schema=None, label_col=None, input_data_schema=None):
        """
