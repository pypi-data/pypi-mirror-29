...
def arg_parse():
    ...
    parser_bind.add_argument("-u", dest="namespace", help='namespace to add.')
    ...
    parser_bind.add_argument("-n", dest="alias", help="alias of the endpoint.")
    ...
    parser_add.add_argument("namespace", default=None, help='namespace to add.')
