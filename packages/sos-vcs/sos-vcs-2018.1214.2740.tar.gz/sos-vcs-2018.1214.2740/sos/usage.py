...
Usage: {cmd} <command> [<argument>] [<option1>, ...]        When operating in offline mode, or command is one of "help", "offline", "version"
  ...
  User configuration:
    config [set/unset/show/add/rm] [<param> [<value>]] [--local]  Configure user-global defaults.
  ...
  Common options:
    ...
    --verbose                    Enable verbose output, including show compression ratios""".format(appname=appname, cmd="sos", CMD="SOS"))  # line 89
    sys.exit(0)  # line 90
