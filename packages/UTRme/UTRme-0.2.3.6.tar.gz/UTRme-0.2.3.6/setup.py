...
setup(name='UTRme',
      ...
      install_requires=['xlsxwriter','gooey==0.9.5.2','scipy','python-levenshtein','fuzzywuzzy','regex','pyfaidx','pysam','gooey','pandas','BioPython','argparse','twine','matplotlib','seaborn'],
