...
setup(name='UTRme',
      ...
      install_requires=['wxPython==4.0.0b1','xlsxwriter','gooey','scipy','python-levenshtein','fuzzywuzzy','regex','pyfaidx','pysam','gooey','pandas','BioPython','argparse','twine','matplotlib','seaborn'],
