...
setup(name='UTRme',
      ...
      install_requires=['wxPython','xlsxwriter','gooey','scipy','python-levenshtein','fuzzywuzzy','regex','pyfaidx','pysam','gooey','pandas','BioPython','argparse','twine','matplotlib','seaborn'],
