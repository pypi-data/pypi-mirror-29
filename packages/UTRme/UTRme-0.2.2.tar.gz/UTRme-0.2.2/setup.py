...
setup(name='UTRme',
      ...
      install_requires=['sys','wxPython','xlsxwriter','gooey','scipy','python-levenshtein','fuzzywuzzy','regex','pyfaidx','pysam','gooey','pandas','BioPython','argparse','twine','psutil','matplotlib','seaborn'],
