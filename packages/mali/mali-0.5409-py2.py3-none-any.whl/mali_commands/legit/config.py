...
default_resource_management_socket_server = 'ws://rm-ws-staging.missinglink.ai'
...
class Config(object):
    ...
    def resource_management_config(self):
        return self.readonly_items('resource_management', most_exists=self.config_prefix is not None)
