            ...
            for pages in pages_all:
                for page in pages:
                    ...
                    if file_path_pattern:
                        ...
                        generic_file_path = filename_path.replace(source_lang_code + slash, file_path_pattern_complete)
                        cut_generic_file_path = slash.join(generic_file_path.split(slash)[:-1])
