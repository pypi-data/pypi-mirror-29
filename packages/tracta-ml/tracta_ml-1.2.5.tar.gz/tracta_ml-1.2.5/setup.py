...
ext_modules += [
    Extension("tracta_ml.evolve", ["tracta_ml/evolve.pyx"]),
    Extension("tracta_ml.genetic_operators", ["tracta_ml/genetic_operators.pyx"]),
    Extension("tracta_ml.model_optimizer", ["tracta_ml/model_optimizer.pyx"]),
    Extension("tracta_ml.pool_maintenance", ["tracta_ml/pool_maintenance.pyx"]),
]
