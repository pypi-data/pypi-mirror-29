"""Setup module for Robot Framework Couchbase Library package."""
...
setup(
    ...
    version='1.0.1',
    description='Robot Framework Couchbase Library',
    ...
    keywords='testing testautomation robotframework couchbase',
    package_dir={'': 'src'},
