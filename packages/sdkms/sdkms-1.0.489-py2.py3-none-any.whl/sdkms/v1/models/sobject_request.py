...
class SobjectRequest(object):
    ...
    def __init__(self, name=None, description=None, key_size=None, pub_exponent=None, elliptic_curve=None, rsa=None, group_id=None, obj_type=None, attributes=None, key_ops=None, custom_metadata=None, value=None, enabled=None, transient=None):
        """
