...
class ObjectManager:
    ...
    def __init__(self):
        ...
        # DEBUGGING
        self._preliminary_identifier_ids = {}
        # / DEBUGGING
    ...
    def register_mapping_for_preliminary_identifier_to_real_identifier(self, preliminary, real):
        ...
        # DEBUGGING
        if preliminary.id in self._preliminary_identifier_ids:
            raise ValueError("DEBUG this preliminary identifier is already registered. / DEBUG\n---\n%s\n---\n%s\n" % (preliminary, '\n'.join([str(k) for k,v in self._preliminary_identifier_mapping.items()])))
        self._preliminary_identifier_ids[preliminary.id] = True
        # / DEBUGGING
