...
HH_AlphaIncome = 0.6000                                               # [AlphaIncome] Parameter for consumption out of income
   ...
   BUS_DEM_LAB = GOOD_SUP_GOOD                                        # [DEM_LAB] Demand for labour
     ...
     BUS_LAG_F = BUS_F (k -1 )                                        # [LAG_F] Previous periods financial assets.
      BUS_PROF = BUS_SUP_GOOD -BUS_DEM_LAB                            # [PROF] Profits
...
class SFCModel(BaseSolver):
    ...
    BUS_PROF = BUS_SUP_GOOD -BUS_DEM_LAB,
    ...
    """
    def __init__(self):
        BaseSolver.__init__(self, ['GOV_F', 'GOV_FISC_BAL', 'GOV_T', 'HH_AfterTax', 'HH_AlphaFin', 'HH_AlphaIncome', 'HH_DEM_GOOD', 'HH_F', 'HH_PreTax', 'HH_SUP_LAB', 'HH_T', 'BUS_DEM_LAB', 'BUS_F', 'BUS_PROF', 'BUS_SUP_GOOD', 'TF_T', 'TF_TaxRate', 'LAB_DEM_LAB', 'LAB_SUP_LAB', 'GOOD_DEM_GOOD', 'GOOD_SUP_GOOD', 't', 'GOV_DEM_GOOD'])
    ...
    @staticmethod
    def Iterator(in_vec):
        GOV_F, GOV_FISC_BAL, GOV_T, HH_AfterTax, HH_AlphaFin, HH_AlphaIncome, HH_DEM_GOOD, HH_F, HH_PreTax, HH_SUP_LAB, HH_T, BUS_DEM_LAB, BUS_F, BUS_PROF, BUS_SUP_GOOD, TF_T, TF_TaxRate, LAB_DEM_LAB, LAB_SUP_LAB, GOOD_DEM_GOOD, GOOD_SUP_GOOD, t, GOV_LAG_F, HH_LAG_F, BUS_LAG_F, t_minus_1, GOV_DEM_GOOD = in_vec 
        ...
        return NEW_GOV_F, NEW_GOV_FISC_BAL, NEW_GOV_T, NEW_HH_AfterTax, NEW_HH_AlphaFin, NEW_HH_AlphaIncome, NEW_HH_DEM_GOOD, NEW_HH_F, NEW_HH_PreTax, NEW_HH_SUP_LAB, NEW_HH_T, NEW_BUS_DEM_LAB, NEW_BUS_F, NEW_BUS_PROF, NEW_BUS_SUP_GOOD, NEW_TF_T, NEW_TF_TaxRate, NEW_LAB_DEM_LAB, NEW_LAB_SUP_LAB, NEW_GOOD_DEM_GOOD, NEW_GOOD_SUP_GOOD, NEW_t, NEW_GOV_LAG_F, NEW_HH_LAG_F, NEW_BUS_LAG_F, NEW_t_minus_1, NEW_GOV_DEM_GOOD
    ...
    def RunOneStep(self):
        ...
        orig_vector = (GOV_F, GOV_FISC_BAL, GOV_T, HH_AfterTax, HH_AlphaFin, HH_AlphaIncome, HH_DEM_GOOD, HH_F, HH_PreTax, HH_SUP_LAB, HH_T, BUS_DEM_LAB, BUS_F, BUS_PROF, BUS_SUP_GOOD, TF_T, TF_TaxRate, LAB_DEM_LAB, LAB_SUP_LAB, GOOD_DEM_GOOD, GOOD_SUP_GOOD, t, GOV_LAG_F, HH_LAG_F, BUS_LAG_F, t_minus_1, GOV_DEM_GOOD)
        err = 1.
        cnt = 0
