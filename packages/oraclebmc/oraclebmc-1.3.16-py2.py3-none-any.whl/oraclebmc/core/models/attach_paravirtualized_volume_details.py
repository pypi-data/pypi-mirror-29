...
class AttachParavirtualizedVolumeDetails(AttachVolumeDetails):
    ...
    def __init__(self, **kwargs):
        """
        Initializes a new AttachParavirtualizedVolumeDetails object with values from values from keyword arguments. The default value of the :py:attr:`~oraclebmc.core.models.AttachParavirtualizedVolumeDetails.type` attribute
