...
class ParavirtualizedVolumeAttachment(VolumeAttachment):
    ...
    def __init__(self, **kwargs):
        """
        Initializes a new ParavirtualizedVolumeAttachment object with values from values from keyword arguments. The default value of the :py:attr:`~oraclebmc.core.models.ParavirtualizedVolumeAttachment.attachment_type` attribute
