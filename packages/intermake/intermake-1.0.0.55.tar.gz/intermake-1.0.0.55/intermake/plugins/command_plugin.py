...
from intermake.engine.plugin_arguments import PluginArg, HFunctionParameterType
...
def iter_args_as_pluginargs( function_info: FnInspect ) -> Iterator[PluginArg]:
    """
    Yields a series of :class:`PluginArg`s from a function's parameters.
    """
    for arg in function_info.args:
        ...
        if arg.name != "self":
            yield PluginArg( arg.name, HFunctionParameterType[arg.type], arg.default, arg.description )
