...
from mhelper import MEnum, ansi_format_helper
...
class RunHostArgs:
    ...
    def __init__( self, can_return: bool = True ):
        """
        CONSTRUCTOR
...
class PluginHost:
    ...
    def __init__( self ):
        ...
        self.last_result = AsyncResult( None, None, None, None, None, None )
        self.last_error = AsyncResult( None, None, None, None, None, None )
