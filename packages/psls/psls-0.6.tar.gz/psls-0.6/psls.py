...
StarModelType = cfg['StarModelType']
StarModelName = cfg['StarModelName']
...
if (UP):
    ...
    time,ts,f,ps,mps_nf,opar,_ = sls.gen_adipls(StarID,StarFreqFile,StarTeff,Sampling,Duration,StarMag,verbose=Verbose,seed=seeds[0],
                                            ...
                                            incl = cfg['Inclination'] , activity = activity, granulation=cfg['Granulation'], path = OutDir )
