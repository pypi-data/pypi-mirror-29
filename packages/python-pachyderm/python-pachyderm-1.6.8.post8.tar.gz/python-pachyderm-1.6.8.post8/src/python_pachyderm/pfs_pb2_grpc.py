...
class APIStub(object):
  ...
  def __init__(self, channel):
    ...
    self.ListRepo = channel.unary_unary(
        ...
        response_deserializer=pfs__pb2.ListRepoResponse.FromString,
        )
    ...
    self.CopyFile = channel.unary_unary(
        '/pfs.API/CopyFile',
        request_serializer=pfs__pb2.CopyFileRequest.SerializeToString,
        response_deserializer=google_dot_protobuf_dot_empty__pb2.Empty.FromString,
        )
...
def add_APIServicer_to_server(servicer, server):
  rpc_method_handlers = {
      ...
      'ListRepo': grpc.unary_unary_rpc_method_handler(
          ...
          response_serializer=pfs__pb2.ListRepoResponse.SerializeToString,
      ),
      ...
      'CopyFile': grpc.unary_unary_rpc_method_handler(
          servicer.CopyFile,
          request_deserializer=pfs__pb2.CopyFileRequest.FromString,
          response_serializer=google_dot_protobuf_dot_empty__pb2.Empty.SerializeToString,
      ),
...
class ObjectAPIStub(object):
  ...
  def __init__(self, channel):
    ...
    self.PutObjectSplit = channel.stream_unary(
        ...
        request_serializer=pfs__pb2.PutObjectRequest.SerializeToString,
        response_deserializer=pfs__pb2.Objects.FromString,
        )
...
def add_ObjectAPIServicer_to_server(servicer, server):
  rpc_method_handlers = {
      ...
      'PutObjectSplit': grpc.stream_unary_rpc_method_handler(
          ...
          request_deserializer=pfs__pb2.PutObjectRequest.FromString,
          response_serializer=pfs__pb2.Objects.SerializeToString,
      ),
