...
void InitDefaultsFeatureFunctionDescriptorImpl() {
  ...
  ::google::protobuf::internal::InitProtobufDefaults();
#endif  // GOOGLE_PROTOBUF_ENFORCE_UNIQUENESS
  protobuf_src_2ffeature_5fextractor_2eproto::InitDefaultsParameter();
  {
...
void InitDefaultsFeatureExtractorDescriptorImpl() {
  ...
  ::google::protobuf::internal::InitProtobufDefaults();
#endif  // GOOGLE_PROTOBUF_ENFORCE_UNIQUENESS
  protobuf_src_2ffeature_5fextractor_2eproto::InitDefaultsFeatureFunctionDescriptor();
  {
...
FeatureExtractorDescriptor::FeatureExtractorDescriptor()
  : ::google::protobuf::MessageLite(), _internal_metadata_(NULL) {
  if (GOOGLE_PREDICT_TRUE(this != internal_default_instance())) {
    ::protobuf_src_2ffeature_5fextractor_2eproto::InitDefaultsFeatureExtractorDescriptor();
  }
  SharedCtor();
