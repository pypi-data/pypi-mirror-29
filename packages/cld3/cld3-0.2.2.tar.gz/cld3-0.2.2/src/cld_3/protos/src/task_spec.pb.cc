...
void InitDefaultsTaskInputImpl() {
  ...
  ::google::protobuf::internal::InitProtobufDefaults();
#endif  // GOOGLE_PROTOBUF_ENFORCE_UNIQUENESS
  protobuf_src_2ftask_5fspec_2eproto::InitDefaultsTaskInput_Part();
  {
...
void InitDefaultsTaskSpecImpl() {
  ...
  ::google::protobuf::internal::InitProtobufDefaults();
#endif  // GOOGLE_PROTOBUF_ENFORCE_UNIQUENESS
  protobuf_src_2ftask_5fspec_2eproto::InitDefaultsTaskSpec_Parameter();
  protobuf_src_2ftask_5fspec_2eproto::InitDefaultsTaskInput();
  protobuf_src_2ftask_5fspec_2eproto::InitDefaultsTaskOutput();
  {
...
TaskSpec::TaskSpec()
  : ::google::protobuf::MessageLite(), _internal_metadata_(NULL) {
  if (GOOGLE_PREDICT_TRUE(this != internal_default_instance())) {
    ::protobuf_src_2ftask_5fspec_2eproto::InitDefaultsTaskSpec();
  }
  SharedCtor();
