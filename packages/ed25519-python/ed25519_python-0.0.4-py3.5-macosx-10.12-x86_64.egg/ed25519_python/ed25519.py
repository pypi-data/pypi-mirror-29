...
def sign(message, public, private):
    ...
    print("msg len:{}".format(len(message)))
    ...
    print("sign public :{}".format(binascii.hexlify(base64.b64decode(public))))
    print("sign private:{}".format(binascii.hexlify(base64.b64decode(private))))
