...
if __name__ == '__main__':
    ...
    wnd = ui.ColorWindow(display, Params.margin, Params.size, Params.border)
    ...
    with ui.WindowMapper(wnd) as mapper,\
            ui.create_font_cursor(display, Xcursorfont.tcross) as cursor,\
            ui.pick_coordinate(display, cursor):
        for e in ui.events(display):
