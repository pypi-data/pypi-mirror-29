...
class MetaView(Resource,Jurisdiction,Check):
    ...
    def __init__(self):
        ...
        self.META_UPDATE_EXCLUDE = ("meta_id", 'level','create_time','meta_code', 'modify_time', 'creator_uuid', 'creator_ugid', 'creator_user', 'creator_group','tenant_id')
    ...
    def put(self, meta_id):
        ...
        data, errors = MetaSchema(exclude=self.META_UPDATE_EXCLUDE).load(data)
        if errors:
            return errors, 400
