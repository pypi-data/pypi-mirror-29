...
class Message:
    ...
    def __init__(self, message_id: str, recipients: List[str], sender: str, size: str, subject: str, type: Optional[str], source: Optional[str], created_at: str):
        ...
        Arguments:
            ...
            type {Optional[str]}    -- text type like text/plain, text/html
            source {Optional[str]}  -- message row sourse.
...
class Mailcatcher:
    ...
    def parse_message(m):
        ...
        return Message(
            ...
            m['size'],
            m['subject'],
            m['type'] if 'type' in m else None,
            m['source'] if 'source' in m else None,
            m['created_at'])
