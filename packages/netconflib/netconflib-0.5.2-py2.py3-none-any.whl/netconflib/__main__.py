...
from netconflib.client import Client
...
def main(args=None):
    ...
    parser.add_argument('-sniff', nargs=1, type=str,
    ...
    parser.add_argument('--version', action='version', version='Netconf  v0.5.2')
