...
copyright = """    __________________________________________________________________
""" + Colors.LTGRAY + """
    Copyright 2017-2018, Blake Huber.  This program distributed under
    GPL v3.  This copyright notice must remain with derivative works.""" + Colors.RESET + """
