...
def pdf2docx(pdf_filepath,docx_filepath=None):
    ...
    doc = word.Documents.Open(os.path.abspath(pdf_filepath))
...
def docx2pdf(docx_filepath,pdf_filepath):
    ...
    word.Visible = False
    doc = word.Documents.Open(os.path.abspath(docx_filepath))
...
def doc2docx(doc_filepath,docx_filepath=None):
    ...
    word.Visible = False
    word.DisplayAlerts = 0
    doc = word.Documents.Open(os.path.abspath(doc_filepath))
    if docx_filepath is None:
