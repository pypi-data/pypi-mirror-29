...
def traffic(namespace, ingress, backend, weight):
    ...
    try:
        if backend is None:
            ...
            weights = zalando_kubectl.traffic.get_ingress_info(namespace, ingress)
            ...
            current_weights = zalando_kubectl.traffic.get_ingress_info(namespace, ingress)
            ...
            zalando_kubectl.traffic.set_ingress_weights(namespace, ingress, new_weights)
            zalando_kubectl.traffic.print_weights_table(new_weights)
    except subprocess.CalledProcessError as e:
        click_exc = click.ClickException(e.stderr)
