...
from pyjsonmodels import __version__, __author__, __email__

from setuptools import setup

PROJECT_NAME = 'pyjsonmodels'
...
setup(
    name=PROJECT_NAME,
    version=__version__,
    description='方便处理模型转换的工具',
    long_description=readme + '\n\n' + history,
    author=__author__,
    author_email=__email__,
    url='https://gitee.com/huichengip_chenxf/jsonmodels.git',
    packages=[
        PROJECT_NAME,
    ],
