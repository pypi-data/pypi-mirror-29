...
def get_params():
    ...
    parser = argparse.ArgumentParser(description='Copies a the MMseqs2 binary inside the SonicParanoid root directory, and check the version compatibility',  usage='%(prog)s -o <MMSEQS_PATH>', prog='sonicparanoid-set-mmseqs2')
