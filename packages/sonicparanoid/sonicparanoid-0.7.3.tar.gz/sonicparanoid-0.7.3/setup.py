...
try:
    ...
    _CYTHON_INSTALLED = False
    raise ImportError('SonicParanoid requires a version of Cython higher than {:s}:\npip install cython=={:s}\n'.format(min_cython_ver, min_cython_ver))
...
setup(
    ...
    # required packages
    #install_requires=['numpy>=1.14.0', 'pandas>=0.22.0', 'cython>=0.27.0', 'sh>=1.12.14', 'setuptools>=24.2.0', 'pip>=9.0.1', 'biopython>=1.70',], # specify minimum version
    install_requires=['numpy>=1.14.0', 'pandas>=0.22.0', 'sh>=1.12.14', 'setuptools>=24.2.0', 'pip>=9.0.1', 'biopython>=1.70',], # specify minimum version
