...
class AuthAccessAccessItemPermissions(object):
    ...
    def dacl(self):
        ...
        Status message if the Null ACL is set.
    ...
    def delete_child(self):
        ...
        Status message if the parent directory allows the delete_child for the user.
    ...
    def ownership(self):
        ...
        Status message if the user owns the file
    ...
    def sticky(self):
        ...
        Status message if the sticky bit is set.
