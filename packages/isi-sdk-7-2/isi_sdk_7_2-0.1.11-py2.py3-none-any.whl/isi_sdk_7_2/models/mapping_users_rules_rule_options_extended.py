...
class MappingUsersRulesRuleOptionsExtended(object):
    ...
    def _break(self):
        ...
        If this rule applies successfully, stop processing further.
    ...
    def group(self):
        ...
        Specifies that the primary GID and primary group SID should be copied to the existing credential.
    ...
    def groups(self):
        ...
        Specifies that all additional identifiers should be copied to the existing credential.
    ...
    def user(self):
        ...
        Specifies that the primary UID and primary user SID should be copied to the existing credential.
