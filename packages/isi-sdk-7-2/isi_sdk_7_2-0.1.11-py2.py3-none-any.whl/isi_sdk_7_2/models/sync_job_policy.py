...
class SyncJobPolicy(object):
    ...
    def __init__(self):
        """
        SyncJobPolicy - a model defined in Swagger
    ...
    def action(self, action):
        ...
        :param action: The action of this SyncJobPolicy.
        :type: str
        """
    ...
    def file_matching_pattern(self):
        """
        Gets the file_matching_pattern of this SyncJobPolicy.
        ...
        :return: The file_matching_pattern of this SyncJobPolicy.
    ...
    def file_matching_pattern(self, file_matching_pattern):
        ...
        :param file_matching_pattern: The file_matching_pattern of this SyncJobPolicy.
    ...
    def name(self):
        """
        Gets the name of this SyncJobPolicy.
        User-assigned name of this sync policy.

        :return: The name of this SyncJobPolicy.
        :rtype: str
        """
        return self._name
    ...
    def name(self, name):
        ...
        :param name: The name of this SyncJobPolicy.
        :type: str
        """
    ...
    def source_exclude_directories(self, source_exclude_directories):
        ...
        :param source_exclude_directories: The source_exclude_directories of this SyncJobPolicy.
        :type: list[str]
        """
    ...
    def source_include_directories(self):
        """
        Gets the source_include_directories of this SyncJobPolicy.
        Directories that will be included in the sync.  Modifying this field will result in a full synchronization of all data.

        :return: The source_include_directories of this SyncJobPolicy.
        :rtype: list[str]
        """
    ...
    def source_include_directories(self, source_include_directories):
        ...
        :param source_include_directories: The source_include_directories of this SyncJobPolicy.
        :type: list[str]
        """
    ...
    def source_root_path(self):
        """
        Gets the source_root_path of this SyncJobPolicy.
        ...
        :return: The source_root_path of this SyncJobPolicy.
        :rtype: str
        """
    ...
    def source_root_path(self, source_root_path):
        ...
        :param source_root_path: The source_root_path of this SyncJobPolicy.
        :type: str
        """
    ...
    def target_host(self):
        """
        Gets the target_host of this SyncJobPolicy.
        ...
        :return: The target_host of this SyncJobPolicy.
        :rtype: str
        """
    ...
    def target_host(self, target_host):
        ...
        :param target_host: The target_host of this SyncJobPolicy.
        :type: str
        """
    ...
    def target_path(self):
        """
        Gets the target_path of this SyncJobPolicy.
        Absolute filesystem path on the target cluster for the sync destination.

        :return: The target_path of this SyncJobPolicy.
        :rtype: str
        """
    ...
    def target_path(self, target_path):
        ...
        :param target_path: The target_path of this SyncJobPolicy.
        :type: str
        """
