...
class SnapshotApi(object):
    ...
    def create_snapshot_schedule(self, snapshot_schedule, **kwargs):
        ...
        resource_path = '/platform/1/snapshot/schedules'.replace('{format}', 'json')
        path_params = {}
    ...
    def delete_snapshot_schedule(self, snapshot_schedule_id, **kwargs):
        ...
        resource_path = '/platform/1/snapshot/schedules/{SnapshotScheduleId}'.replace('{format}', 'json')
        path_params = {}
    ...
    def get_snapshot_changelists(self, **kwargs):
        """
        ...
        >>>     pprint(response)
        >>>
        >>> thread = api.get_snapshot_changelists(callback=callback_function)
    ...
    def get_snapshot_repstates(self, **kwargs):
        """
        ...
        >>>     pprint(response)
        >>>
        >>> thread = api.get_snapshot_repstates(callback=callback_function)
