...
class ZoneCreateParams(object):
    ...
    def all_auth_providers(self):
        """
        Gets the all_auth_providers of this ZoneCreateParams.
        Use all authentication providers available.

        :return: The all_auth_providers of this ZoneCreateParams.
        :rtype: bool
        """
    ...
    def all_auth_providers(self, all_auth_providers):
        ...
        :param all_auth_providers: The all_auth_providers of this ZoneCreateParams.
        :type: bool
        """
    ...
    def audit_failure(self):
        """
        Gets the audit_failure of this ZoneCreateParams.
        List of failed operations to audit.

        :return: The audit_failure of this ZoneCreateParams.
        :rtype: list[str]
        """
    ...
    def audit_failure(self, audit_failure):
        ...
        :param audit_failure: The audit_failure of this ZoneCreateParams.
        :type: list[str]
        """
    ...
    def audit_success(self):
        """
        Gets the audit_success of this ZoneCreateParams.
        List of successful operations to audit.

        :return: The audit_success of this ZoneCreateParams.
        :rtype: list[str]
        """
    ...
    def audit_success(self, audit_success):
        ...
        :param audit_success: The audit_success of this ZoneCreateParams.
        :type: list[str]
        """
    ...
    def cache_size(self):
        """
        Gets the cache_size of this ZoneCreateParams.
        Specifies the maximum size of zone in-memory cache.

        :return: The cache_size of this ZoneCreateParams.
        :rtype: int
        """
    ...
    def cache_size(self, cache_size):
        ...
        :param cache_size: The cache_size of this ZoneCreateParams.
        :type: int
        """
    ...
    def hdfs_ambari_namenode(self):
        """
        Gets the hdfs_ambari_namenode of this ZoneCreateParams.
        The SmartConnect name of this cluster that will be used for the HDFS service.

        :return: The hdfs_ambari_namenode of this ZoneCreateParams.
        :rtype: str
        """
    ...
    def hdfs_ambari_namenode(self, hdfs_ambari_namenode):
        ...
        :param hdfs_ambari_namenode: The hdfs_ambari_namenode of this ZoneCreateParams.
        :type: str
        """
    ...
    def hdfs_ambari_server(self):
        """
        Gets the hdfs_ambari_server of this ZoneCreateParams.
        A valid hostname, FQDN, IPv4, or IPv6 string of the Ambari server.

        :return: The hdfs_ambari_server of this ZoneCreateParams.
        :rtype: str
        """
    ...
    def hdfs_ambari_server(self, hdfs_ambari_server):
        ...
        :param hdfs_ambari_server: The hdfs_ambari_server of this ZoneCreateParams.
        :type: str
        """
    ...
    def hdfs_authentication(self):
        """
        Gets the hdfs_authentication of this ZoneCreateParams.
        Authentication type for HDFS protocol.

        :return: The hdfs_authentication of this ZoneCreateParams.
        :rtype: str
        """
    ...
    def hdfs_authentication(self, hdfs_authentication):
        ...
        :param hdfs_authentication: The hdfs_authentication of this ZoneCreateParams.
        :type: str
        """
    ...
    def hdfs_odp_version(self):
        """
        Gets the hdfs_odp_version of this ZoneCreateParams.
        ODP stack repository version number.

        :return: The hdfs_odp_version of this ZoneCreateParams.
        :rtype: str
        """
    ...
    def hdfs_odp_version(self, hdfs_odp_version):
        ...
        :param hdfs_odp_version: The hdfs_odp_version of this ZoneCreateParams.
        :type: str
        """
    ...
    def hdfs_root_directory(self):
        """
        Gets the hdfs_root_directory of this ZoneCreateParams.
        Root directory for HDFS protocol.

        :return: The hdfs_root_directory of this ZoneCreateParams.
        :rtype: str
        """
    ...
    def hdfs_root_directory(self, hdfs_root_directory):
        ...
        :param hdfs_root_directory: The hdfs_root_directory of this ZoneCreateParams.
        :type: str
        """
    ...
    def protocol_audit_enabled(self):
        """
        Gets the protocol_audit_enabled of this ZoneCreateParams.
        Indicates whether I/O auditing is set on this zone.

        :return: The protocol_audit_enabled of this ZoneCreateParams.
        :rtype: bool
        """
    ...
    def protocol_audit_enabled(self, protocol_audit_enabled):
        ...
        :param protocol_audit_enabled: The protocol_audit_enabled of this ZoneCreateParams.
        :type: bool
        """
    ...
    def syslog_audit_events(self):
        """
        Gets the syslog_audit_events of this ZoneCreateParams.
        List of audit operations to forward to syslog.

        :return: The syslog_audit_events of this ZoneCreateParams.
        :rtype: list[str]
        """
    ...
    def syslog_audit_events(self, syslog_audit_events):
        ...
        :param syslog_audit_events: The syslog_audit_events of this ZoneCreateParams.
        :type: list[str]
        """
    ...
    def syslog_forwarding_enabled(self):
        """
        Gets the syslog_forwarding_enabled of this ZoneCreateParams.
        Enable syslog forwarding of zone audit events.

        :return: The syslog_forwarding_enabled of this ZoneCreateParams.
        :rtype: bool
        """
    ...
    def syslog_forwarding_enabled(self, syslog_forwarding_enabled):
        ...
        :param syslog_forwarding_enabled: The syslog_forwarding_enabled of this ZoneCreateParams.
        :type: bool
        """
    ...
    def webhdfs_enabled(self):
        """
        Gets the webhdfs_enabled of this ZoneCreateParams.
        Indicates whether WebHDFS is enabled on this zone.

        :return: The webhdfs_enabled of this ZoneCreateParams.
        :rtype: bool
        """
    ...
    def webhdfs_enabled(self, webhdfs_enabled):
        ...
        :param webhdfs_enabled: The webhdfs_enabled of this ZoneCreateParams.
        :type: bool
        """
