...
class AuditSettingsSettings(object):
    ...
    def audited_zones(self):
        """
        Gets the audited_zones of this AuditSettingsSettings.
        Zones that are audited when protocol auditing is enabled.

        :return: The audited_zones of this AuditSettingsSettings.
        :rtype: list[str]
        """
    ...
    def audited_zones(self, audited_zones):
        ...
        :param audited_zones: The audited_zones of this AuditSettingsSettings.
        :type: list[str]
        """
    ...
    def cee_log_time(self):
        """
        Gets the cee_log_time of this AuditSettingsSettings.
        Sets audit CEE forwarder to forward events past a specified date in 'Topic@YYYY-MM-DD HH:MM:SS' format

        :return: The cee_log_time of this AuditSettingsSettings.
        :rtype: str
        """
    ...
    def cee_log_time(self, cee_log_time):
        ...
        :param cee_log_time: The cee_log_time of this AuditSettingsSettings.
        :type: str
        """
    ...
    def cee_server_uris(self):
        """
        Gets the cee_server_uris of this AuditSettingsSettings.
        URIs of backend CEE servers to which to send audit logs

        :return: The cee_server_uris of this AuditSettingsSettings.
        :rtype: list[str]
        """
    ...
    def cee_server_uris(self, cee_server_uris):
        ...
        :param cee_server_uris: The cee_server_uris of this AuditSettingsSettings.
        :type: list[str]
        """
    ...
    def config_auditing_enabled(self):
        """
        Gets the config_auditing_enabled of this AuditSettingsSettings.
        Enables/disables PAPI configuration audit

        :return: The config_auditing_enabled of this AuditSettingsSettings.
        :rtype: bool
        """
    ...
    def config_auditing_enabled(self, config_auditing_enabled):
        ...
        :param config_auditing_enabled: The config_auditing_enabled of this AuditSettingsSettings.
        :type: bool
        """
    ...
    def config_syslog_enabled(self):
        """
        Gets the config_syslog_enabled of this AuditSettingsSettings.
        Enables/disables config audit syslog forwarding.

        :return: The config_syslog_enabled of this AuditSettingsSettings.
        :rtype: bool
        """
    ...
    def config_syslog_enabled(self, config_syslog_enabled):
        ...
        :param config_syslog_enabled: The config_syslog_enabled of this AuditSettingsSettings.
        :type: bool
        """
    ...
    def hostname(self):
        """
        Gets the hostname of this AuditSettingsSettings.
        Hostname reported in protocol events from this cluster

        :return: The hostname of this AuditSettingsSettings.
        :rtype: str
        """
    ...
    def hostname(self, hostname):
        ...
        :param hostname: The hostname of this AuditSettingsSettings.
        :type: str
        """
    ...
    def protocol_auditing_enabled(self):
        """
        Gets the protocol_auditing_enabled of this AuditSettingsSettings.
        Enables/disables auditing of I/O requests

        :return: The protocol_auditing_enabled of this AuditSettingsSettings.
        :rtype: bool
        """
    ...
    def protocol_auditing_enabled(self, protocol_auditing_enabled):
        ...
        :param protocol_auditing_enabled: The protocol_auditing_enabled of this AuditSettingsSettings.
        :type: bool
        """
    ...
    def syslog_log_time(self):
        """
        Gets the syslog_log_time of this AuditSettingsSettings.
        Sets audit syslog forwarder to forward events past a specified date in 'Topic@YYYY-MM-DD HH:MM:SS' format

        :return: The syslog_log_time of this AuditSettingsSettings.
        :rtype: str
        """
    ...
    def syslog_log_time(self, syslog_log_time):
        ...
        :param syslog_log_time: The syslog_log_time of this AuditSettingsSettings.
        :type: str
        """
