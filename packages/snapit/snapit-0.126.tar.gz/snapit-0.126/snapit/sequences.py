...
def translate_dna(sequence, readthrough = False, start = 0):
    ...
    :return: Translated protein sequence (string)
    """
    codon_table = {
...
def reverse_complement(seq):
    ...
    :return: Reverse complemented DNA sequence (string)
    """
    seq = seq.upper()
...
def makeFasta(sequences):
    ...
    :param sequences: List of AA sequences (list[string, ...])
    :return: Each element of sequences as an individual fasta entry (string)
    """
    output = ""
    # x = index, y = sequence
