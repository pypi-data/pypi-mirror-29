"""
setup6_Make_TMHMM_Input_from_ENSG_Canonical_AA_GRCh38.py
...
input_file = data_folder + "/ENSG_to_Canonical_AA_GRCh38.fa"
TMHMM_output = setup_folder + "/TMHMM_Result_GRCh38.txt"
output_file = data_folder + "/TMHMM_TM_Only_GRCh38.txt"
