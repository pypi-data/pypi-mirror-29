"""
setup2_ENSG_CDS_FASTA_List_GRCh38.py
...
fasta_file = download_folder + "/Homo_sapiens.GRCh38.cds.all.fa"
file_parsed = SeqIO.parse(open(fasta_file, "r"), "fasta")
output_ENSG_fasta = output_folder + "/ENSG_CDS_GRCh38.fa"
output_ENSG_list = output_folder + "/ENSG_List_GRCh38.txt"
