...
class QueryDataGeneratorFactory(object):
    def __init__(self, multi_process_control, storage, data_callback, volume_id, batch_size, shuffle):
...
class QueryDataGenerator(Iterator):
    def __init__(self, creator, query):
        ...
        super(QueryDataGenerator, self).__init__(self._metadata_index.total_items, creator.batch_size, creator.shuffle)
