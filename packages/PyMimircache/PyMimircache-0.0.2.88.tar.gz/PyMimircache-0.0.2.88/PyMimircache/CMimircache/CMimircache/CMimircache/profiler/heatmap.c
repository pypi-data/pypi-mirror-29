...
extern "C"
{
    ...
    draw_dict* heatmap_computation(reader_t* reader,
        ...
        if (plot_type == hr_st_et){
            ...
            g_slist_free(last_access_gslist);
            return hm_hr_interval_size(reader, cache, bin_size,
                                       decay_coefficient_lf,
                                       num_of_threads);
        }
        ...
        else if (plot_type == opt_effective_size){
            return hm_opt_effective_size(reader, cache, bin_size, num_of_threads);
        }
...
//            fprintf(stderr, "\033[A\033[2K\r");
    ...
    draw_dict* hm_opt_effective_size(reader_t* reader,
        ...
        // build the thread pool
        GThreadPool *gthread_pool = g_thread_pool_new ( (GFunc) hm_Optimal_effective_size_thread,
                                              (gpointer)params, num_of_threads, TRUE, NULL);
