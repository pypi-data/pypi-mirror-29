...
def stream_http_produce(stream_url,
                        stream_topic,
                        test_request_path,
                        test_request_concurrency=1,
                        test_request_mime_type='application/json',
    ...
    print("")
    print("Producing messages for stream_url '%s' and stream_topic '%s'." % (stream_url, stream_topic))
    print("")
...
def stream_kube_produce(model_name,
    ...
    # TODO: Enrich return_dict with model_name and model_tag
    return stream_http_produce(stream_url=stream_url,
                               stream_topic=stream_topic,
                               test_request_path=test_request_path,
                               test_request_concurrency=test_request_concurrency,
                               test_request_mime_type=test_request_mime_type,
