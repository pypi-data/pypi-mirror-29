...
def predict_sage_route(model_name,
    ...
    _validate_and_prep_model_split_tag_and_weight_dict(model_tag_and_weight_dict)
...
def _main():
    ...
    if len(_sys.argv) >= 2 and _sys.argv[1] == 'http':
        ...
        cmd = 'gunicorn --bind 0.0.0.0:6970 --pythonpath %s -k eventlet cli_pipeline:app' % cli_pipeline_module_path
        _subprocess.call(cmd, shell=True)
