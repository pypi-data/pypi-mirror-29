...
# ie. http://localhost:6970/predict-server-init/ensemble/a/python/python/cpu/bW9kZWxzL21vZGVscy9weXRob24vZW5zZW1ibGU=/ZGVmIHByZWRpY3QoKToKICAgIHByaW50KCJlbnNlbWJsZSBmbiEiKQ==/
#
...
# This should be called locally, fixed to your specification, then tar.gz'd, then predict-server-uploaded
def predict_server_init(model_name,
                        model_tag,
                        model_type,
                        new_model_path=None, # must be empty and relative to cwd (ie. models/models/)
                        model_runtime=None,
                        model_chip=None):
    ...
    if not new_model_path:
        new_model_path = _os.path.normpath('%s/%s/%s-%s/' % (new_model_base_path, model_type, model_name, model_tag))
    else:
    ...
    # TODO:  Use jinja template rendering here - instead of _shutil.copytree()
...
# http://localhost:6970/predict-server-push/mnist/025
...
# TODO:  This should invoke build, but doesn't have to right now
...
# ie. http://localhost:6970/predict-kube-start/mnist/025
...
#
# http://localhost:6970/predict-kube-test/mnist/dGVuc29yZmxvdy9tbmlzdC0wLjAyNS9pbnB1dC9wcmVkaWN0L3Rlc3RfcmVxdWVzdC5qc29u/100
#
...
# ie. http://localhost:6970/predict-kube-stop/mnist/025
