...
def env_conda_switch(model_name,
                     model_tag,
                     yaml_path='.'):
    ...
    cmd = 'source activate root && conda env create --name %s-%s -f %s/pipeline_conda_environment.yml' % (model_name, model_tag, yaml_path)
    print(cmd)
...
# TODO: Deprecate and remove from docs and slides
def predict_server_push(model_name,
    ...
    predict_server_register(model_name=model_name,
                            model_tag=model_tag,
                            image_registry_url=image_registry_url,
                            image_registry_repo=image_registry_repo,
                            image_registry_namespace=image_registry_namespace)
...
def train_server_push(model_name,
    ...
    train_server_register(model_name=model_name,
                          model_tag=model_tag,
                          image_registry_url=image_registry_url,
                          image_registry_repo=image_registry_repo,
                          image_registry_namespace=image_registry_namespace)
