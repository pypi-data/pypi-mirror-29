...
public:
	MP3Encoder() : parameters(), data(nullptr), nSamples(0), mp3Size(0), mp3Out(nullptr), gf(nullptr), output() {};
	MP3Encoder(const pylame::Parameters &parameters_,const pcm::file_t &data_);
	virtual ~MP3Encoder();
