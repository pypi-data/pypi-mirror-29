...
global DT_DEFAULT_OPTION
DT_DEFAULT_OPTION = {}
DT_DEFAULT_OPTION["flags"] = "direct"
DT_DEFAULT_OPTION["oncerr"] = "abort"
DT_DEFAULT_OPTION["iodir"] = "forward"
DT_DEFAULT_OPTION["align"] = "0"
DT_DEFAULT_OPTION["min"] = "b"
DT_DEFAULT_OPTION["max"] = "256k"
DT_DEFAULT_OPTION["pattern"] = "incr"
DT_DEFAULT_OPTION["dispose"] = "keep"
global DT_RW_OPTION
DT_RW_OPTION = DT_DEFAULT_OPTION
DT_RW_OPTION.update({"disable" : "eof,pstats"})
global DT_INIT_OPTION
DT_INIT_OPTION = DT_DEFAULT_OPTION
DT_INIT_OPTION.update({"disable" : "eof,pstats,compare,verify"})
global DT_VERIFY_OPTION
...
def dt_init_data(of, log=None, limit=None, timeout=None, verbose=False):
    ...
    dt_option = ""
    for key in DT_INIT_OPTION.keys():
