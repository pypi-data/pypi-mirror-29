...
class GiuliaResultsDBHandler(fedmsg.consumers.FedmsgConsumer):
    """
    Handle a new result.
    ...
    config_key = 'giuliaresultsdb_handler'
    ...
    def __init__(self, hub, *args, **kwargs):
        ...
        super(GiuliaResultsDBHandler, self).__init__(hub, *args, **kwargs)
    ...
    def consume(self, message):
        ...
        decision = {
            'subject': 'test',
            'decision_context': collections.defaultdict(set),
