...
score = sacrebleu.corpus_chrf([segment], [segment], 6, True, 3.0)
assert(score == 1.0)

ref = "AAAAAA"
sys = "BBBB"
score = sacrebleu.corpus_chrf([sys], [ref], 3, True, 3.0)
assert(score == 0.0)

ref = ""
sys = ""
score = sacrebleu.corpus_chrf([sys], [ref], 6, True, 3)
print(score)
#assert(score == 1.0)
...
score = sacrebleu.corpus_chrf([sys], [ref], 6, False, 3)
print(score)
assert('{0:.12f}'.format(score) == 0.652414427449)
