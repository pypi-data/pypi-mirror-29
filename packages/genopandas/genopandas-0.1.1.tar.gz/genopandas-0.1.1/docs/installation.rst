...
To install genopandas, run this command in your terminal:

.. code-block:: console

    $ pip install genopandas

This is the preferred method to install genopandas, as it will always install
