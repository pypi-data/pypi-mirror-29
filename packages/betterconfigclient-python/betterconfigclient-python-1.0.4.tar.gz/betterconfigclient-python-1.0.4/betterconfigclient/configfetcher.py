...
from .interfaces import ConfigFetcher, BetterConfigClientException
from .version import BETTERCONFIGCLIENT_VERSION

BASE_URI = 'http://cdn.betterconfig.com/configuration-files/'
...
class CacheControlConfigFetcher(ConfigFetcher):
    ...
    def __init__(self, project_secret, mode):
        ...
        self._headers = {'User-Agent': 'BetterConfigClient-Python/' + mode + '-'+BETTERCONFIGCLIENT_VERSION,
