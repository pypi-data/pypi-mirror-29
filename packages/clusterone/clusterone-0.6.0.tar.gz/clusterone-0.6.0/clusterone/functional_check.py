...
def main():
    ...
    try:
        ...
        call(just("create job distributed --worker-type t2.small --ps-type t2.small --name clusterone-test-bob --project clusterone-test-mnist --module mnist --framework-version 1.0.0"))
        sleep(5)
        job_state = str(call(just("get jobs")), 'utf-8')
