...
class Equation(utils.ReprObject):
    ...
    Args:
        ...
        variable (InterfaceValue, optional): the variable obtained by solving
            the equation
    ...
    def variable(self):
        ...
        :type: :any:`InterfaceValue`
        """
        try:
            self._variable
        except AttributeError:
            self._variable = self._default_variable
        return self._variable

    @variable.setter
    def variable(self, newvar):
        assert isinstance(newvar, InterfaceValue), \
            "variable has to be instance of InterfaceValue"
    ...
    def input(self, newinput):
        self._input = newinput \
            if isinstance(newinput, SetOfInterfaceValues) \
            else SetOfInterfaceValues(iter(newinput))
