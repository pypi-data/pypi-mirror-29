...
class GenericModel(utils.ReprObject):
    ...
    def name(self):
        ...
        try:
            ...
            self._name = "unnamed model"  # default
    ...
    def description(self):
        ...
        """
        try:
            self._description  # already defined?
        except AttributeError:
    ...
    def long_description(self):
        ...
        """
        try:
            self._long_description  # already defined?
        except AttributeError:
            self._long_description = ""  # default
    ...
    def version(self):
        ...
        """
        try:
            self._version  # already defined?
        except AttributeError:
            self._version = "0.0.1"  # default
    ...
    def authors(self):
        ...
        """
        try:
            self._authors  # already defined?
        except AttributeError:
            self._authors = "anonymous"  # default
        return self._authors  # return

    @authors.setter
    def authors(self, newauthors):
        assert isinstance(
            newauthors, str) or isinstance(
            newauthors, list) or isinstance(
            newauthors, dict), "authors has to be str, list or dict"
