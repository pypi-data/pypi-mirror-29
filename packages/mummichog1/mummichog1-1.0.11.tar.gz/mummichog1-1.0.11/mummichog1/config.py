...
Changes from v1.0.7 to 1.0.10:
* fixing Cytoscape.js link for network visualization.
* fixing float export in .xlsx
* upated footer information
* removed test import pygraphviz
* packaging for Pypi
