...
class PackageController(ArgparseController):
  ...
  def firme(self):
    ...
    # install flappy
    os.system('git clone git@git.souche-inc.com:flappy/flappy-cli.git && cd flappy-cli && gem build flappy-cli.gemspec && gem install flappy-cli-0.3.2.gem')

    # download slave file
    print('例子：%s' % 'slave.jar -jnlpUrl http://jenkins.souche-inc.com/computer/mac-pro/slave-agent.jnlp -secret 1a35dec8f55c89ded1a84725ac2fb4d900c43533c8042f0f26fb23681796498f')
