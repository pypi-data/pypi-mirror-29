...
class Downloader(Emitter):
    ...
    def __init__(self, url, path=None, restart_wait=-1, chunk_size=128*2**10, update_period=1, timeout=10, rate_limit=0):
        ...
        if rate_limit > 0:
            self.chunk_size = max(self.chunk_size, rate_limit)
