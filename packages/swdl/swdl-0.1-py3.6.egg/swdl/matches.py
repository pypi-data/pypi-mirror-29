...
class Match:
    ...
    """
    def __init__(self, matchId=None, swcsId="", name="", location="", userStreamLink="", gridStreamLink="", state=""):
    ...
    def download_user_stream(self, download_directory="."):
        ...
        NoEndlistError: If stream has not endlist tag. This means the stream is not correctly finished and can note be
        downlaoded with ffmpeg
        """
    ...
    def push_labels(self):
        ...
        if not self.data_service:
            raise SWLoginError("Not logged into Soccerwatch Data Service")
        self.data_service.push_labels(self)
