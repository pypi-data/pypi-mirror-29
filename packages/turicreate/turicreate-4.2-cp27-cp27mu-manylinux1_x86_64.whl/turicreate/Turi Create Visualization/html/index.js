...
function useEmbeddedVega(data) {
    ...
    for (var y = 0; y < newData.length; y++) {
        if (newData[y]["a"] != null) {
            // hack to determine whether SFrame summary view
...
window.updateData = function updateData(data) {
    if (tableSpec) {
        ...
        _reactDom2.default.render(_react2.default.createElement(_Table2.default, { spec: tableSpec, data: data, size: max_sframe, enterHandler: jumpToRowCallback, tableTitle: table_title, starting_height: window_height }), document.getElementById('table_vis'), function () {
...
var jumpToRowCallback = function jumpToRowCallback(event) {
...
var _reactStickyTable = __webpack_require__(7);
...
var Tctable = function (_Component) {
  _inherits(Tctable, _Component);

  function Tctable() {
    _classCallCheck(this, Tctable);

    return _possibleConstructorReturn(this, (Tctable.__proto__ || Object.getPrototypeOf(Tctable)).apply(this, arguments));
  }

  _createClass(Tctable, [{
    key: 'renderCell',
    value: function renderCell(value, type) {
      switch (type) {
        case "string":
        ...
        case "image":
          return _react2.default.createElement(
            'div',
            { className: 'image_val' },
            _react2.default.createElement('img', { src: "data:image/" + value.format + ";base64," + value.data, height: 32, 'data-image-row': value.idx, 'data-image-column': value.column, alt: value.width + "x" + value.height + " image" })
          );
        case "dictionary":
          return _react2.default.createElement(
            'div',
            { className: 'dictionary_value' },
            _react2.default.createElement(
              'span',
              null,
              value
    ...
    key: 'enterPressJumpRow',
    value: function enterPressJumpRow(param) {
      return function (e) {
        if (e.keyCode == 13) {
          param(e);
        }
    ...
    key: 'hoverImage',
    value: function hoverImage(result) {
      return function (e) {
        if (result == "image") {
    ...
    key: 'hoverOutImage',
    value: function hoverOutImage(result) {
      return function (e) {
        if (result == "image") {
          if (document.getElementById("image_source_container") != null && e.target.getElementsByTagName("img")[0] && e.target.classList.contains('elements')) {
    ...
    value: function render() {
      ...
      for (var r = 0; r < data.length + 1; r++) {
        ...
        for (var c = 0; c < spec["column_names"].length + 1; c++) {
          if (c === 0) {
            cells.push(r === 0 ? _react2.default.createElement(_reactStickyTable.Cell, { className: 'header', key: c }) : _react2.default.createElement(
              _reactStickyTable.Cell,
              { className: 'header_element', key: c },
              data[r - 1]["__idx"]
            ));
          } else {
            cells.push(r === 0 ? _react2.default.createElement(
              _reactStickyTable.Cell,
              { className: "header", key: c },
              _react2.default.createElement(
                'span',
                null,
                spec["column_names"][c - 1]
              )
            ) : _react2.default.createElement(
              _reactStickyTable.Cell,
              { className: 'elements', onMouseEnter: this.hoverImage(spec["column_types"][c - 1]), onMouseLeave: this.hoverOutImage(spec["column_types"][c - 1]), key: c },
              this.renderCell(data[r - 1][spec["column_names"][c - 1]], spec["column_types"][c - 1])
            ));
          }
        }
        rows.push(_react2.default.createElement(
          _reactStickyTable.Row,
          { key: r },
          cells
        ));
      }
      ...
      if (tableTitleString) {
        ...
        tableTitle = _react2.default.createElement(
          'h1',
          { className: 'tableTitle', key: 'tableTitle' },
          tableTitleString
        );
...
var __WEBPACK_AMD_DEFINE_FACTORY__, __WEBPACK_AMD_DEFINE_ARRAY__, __WEBPACK_AMD_DEFINE_RESULT__;(function (global, factory) {
  if (true) {
    !(__WEBPACK_AMD_DEFINE_ARRAY__ = [exports, __webpack_require__(0), __webpack_require__(10), __webpack_require__(14), __webpack_require__(24), __webpack_require__(25), __webpack_require__(26)], __WEBPACK_AMD_DEFINE_FACTORY__ = (factory),
...
*/
var aa=__webpack_require__(0),l=__webpack_require__(16),B=__webpack_require__(3),C=__webpack_require__(1),ba=__webpack_require__(17),da=__webpack_require__(18),ea=__webpack_require__(19),fa=__webpack_require__(20),ia=__webpack_require__(23),D=__webpack_require__(4);
