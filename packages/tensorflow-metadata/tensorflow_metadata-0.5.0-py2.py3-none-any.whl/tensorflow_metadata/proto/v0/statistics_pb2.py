...
_FEATURENAMESTATISTICS = _descriptor.Descriptor(
  ...
  fields=[
    ...
    _descriptor.FieldDescriptor(
      ...
      options=None),
    _descriptor.FieldDescriptor(
      name='custom_stats', full_name='tensorflow.metadata.v0.FeatureNameStatistics.custom_stats', index=5,
