...
def scan_to_precision(kat, DOF, pretune_precision, minmax="max", phi=0.0, precision=60.0, debug=None):
...
def pretune(_kat, pretune_precision=1.0e-4, verbose=False, debug={}):
    ...
    phi, precision = scan_to_precision(kat, IFO.preSRCL, pretune_precision, phi=0, precision = 10, debug=("SRCL" in debug))
    phi=round(phi/pretune_precision)*pretune_precision
