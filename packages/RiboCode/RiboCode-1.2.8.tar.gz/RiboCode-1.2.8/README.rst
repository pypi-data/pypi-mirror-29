...
1. **Required files**
   ...
   **Note**: *RiboCode* requires the GTF file which includes the three-level hierarchy
   ...
   annotation information which can be added by using the "GTFupdate" command in *RiboCode*.
...
5. **Running RiboCode to identify translated ORFs**
   ...
   **Explanation of final result files**
   ...
   Some column names of the result file::
    ...
    - ORF_type: The type of ORF which is annotated according the relative location to associated CDS. The following ORF categories are reported:
...
.. |Build Status| image:: https://img.shields.io/travis/xzt41/RiboCode/master.svg?style=flat
   :target: https://travis-ci.org/xzt41/RiboCode

.. |PyPI| image:: https://img.shields.io/pypi/v/RiboCode.svg?style=flat
   :target: https://pypi.python.org/pypi/RiboCode

.. |Python Versions| image:: https://img.shields.io/pypi/pyversions/RiboCode.svg?style=flat
   :target: https://pypi.python.org/pypi/RiboCode

.. |BioConda| image:: https://img.shields.io/badge/install-bioconda-green.svg?style=flat
   :target: http://bioconda.github.io/recipes/ribocode/README.html

.. |Publish| image:: https://img.shields.io/badge/publish-biorxiv-orange.svg?style=flat
