...
To install Docker Dynamic Inventory, run this command in your terminal:
...
The sources for Docker Dynamic Inventory can be downloaded from the `Github repo`_.
