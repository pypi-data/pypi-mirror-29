...
class InceptionFlow():
    ...
    def classifyCustom(self,image):
        ...
        with tf.Session() as sess:
            ...
            softmaxTensor = sess.graph.get_tensor_by_name('softmax:0')
    ...
    def trainModel(self,classifier):
        ...
        class_count = len(image_lists.keys())
        if class_count == 0:
            print('No valid folders of images found at ' + FACIAL_IMAGES_DIR)
            return -1
        if class_count == 1:
            print('Only one valid folder of images found at ' + FACIAL_IMAGES_DIR +
        ...
        if do_distort_images:
            ...
            self.cache_bottlenecks(sess, image_lists, FACIAL_IMAGES_DIR, BOTTLENECK_DIR,
                            jpeg_data_tensor, bottleneck_tensor)
        ...
        for i in range(TRAINING_STEPS):
            if do_distort_images:
                ...
                FACIAL_IMAGES_DIR, distorted_jpeg_data_tensor,
                distorted_image_tensor, resized_image_tensor, bottleneck_tensor)
            else:
                train_bottlenecks, train_ground_truth = self.get_random_cached_bottlenecks(
                sess, image_lists, TRAIN_BATCH_SIZE, 'training',
                BOTTLENECK_DIR, FACIAL_IMAGES_DIR, jpeg_data_tensor,
                bottleneck_tensor)
        ...
        with gfile.FastGFile(FACIAL_MODEL_PATH, 'wb') as f:
    ...
    def testModel(self,classifier):
        ...
        for file in os.listdir(rootdir):
            ...
            if file.endswith(".jpg"):
                ...
                if Confidence > self.confs["ClassifierSettings"]["OBJECT_THRESHOLD"]:
