...
FACIAL_IMAGES_DIR = "model/training"
...
class InceptionFlow():
    ...
    def createGraph(self,graphType="CustomTest"):
    
        if graphType == "ObjectTest" or graphType == "ObjectCamera":
        ...
        elif graphType == "CustomTest" or graphType == "CustomCamera":
    ...
    def testModel(self,directory):
        
        print("TESTING")
        print("")
        rootdir=os.getcwd()+directory
