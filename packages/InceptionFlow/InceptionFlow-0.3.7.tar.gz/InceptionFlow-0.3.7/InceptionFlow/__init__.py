...
CUSTOM_MODEL_DIR = os.getcwd()+"/model"
CUSTOM_MODEL_PATH = os.getcwd()+"/model/InceptionFlow.pb"
CUSTOM_MODEL_LABELS_PATH = os.getcwd()+"/model/InceptionFlow.txt"
...
class InceptionFlow():
    ...
    def trainModel(self,classifier):
        ...
        if class_count == 0:
            ...
            tf.logging.error('No valid folders of images found at ' + trainingImageDir)
            return -1
    ...
    def trainModel(self,classifier):
        ...
        with tf.Session(graph=graph) as sess:
            ...
            # Write out the trained graph and labels with the weights stored as constants.
            self.save_graph_to_file(sess, graph, trainingModelPath)
