...
class DeviceItem(IndexItem):
    ...
    def __init__(self, **kwargs):
        ...
        self.services = SystemServices(aos=self.index.rqst.client, system=self)
...
class DeviceInventory(Indexer):
    name_by_options = ['hostname', 'ipaddr', 'serialnumber']

    def __init__(self, aos, name_by='ipaddr'):
        ...
        super(DeviceInventory, self).__init__(
            rqst=aos.request.systems.all_systems,
            name_from=name_from,
