...
###############################################################################
"""
$Id: chunker.py 4798 2018-03-08 04:04:28Z roger.ineichen $
"""
...
class ChunkReaderBase(ChunkLogging):
    ...
    def read(self, size=-1):
        ...
        if self._buffer is None:
            self._buffer = zlib.decompress(self.data, zlib.MAX_WBITS)
...
def getChunkDataReader(collection, query):
    """Lookup file data and return a ChunkDataReader

    NOTE: this will raise a KeyError if no data get found
    """
    # get data
