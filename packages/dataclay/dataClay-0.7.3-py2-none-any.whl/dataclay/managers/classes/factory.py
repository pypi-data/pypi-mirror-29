...
from dataclay.core.management import UserType
from . import DataClayObject, loaded_classes
...
class MetaClassFactory(object):
    ...
    def add_class(self, klass):
        ...
        """
        assert issubclass(klass, DataClayObject), "Can only use DataClayObject classes"
