...
class LogicModuleStub(object):
  ...
  def __init__(self, channel):
    ...
    self.checkObjectFederatedWithDataClayInstance = channel.unary_unary(
        '/dataclay.communication.grpc.logicmodule.LogicModule/checkObjectFederatedWithDataClayInstance',
    ...
    self.updateRefs = channel.unary_unary(
        '/dataclay.communication.grpc.logicmodule.LogicModule/updateRefs',
...
class LogicModuleServicer(object):
  ...
  def checkObjectFederatedWithDataClayInstance(self, request, context):
    # missing associated documentation comment in .proto file
    pass
    context.set_code(grpc.StatusCode.UNIMPLEMENTED)
    context.set_details('Method not implemented!')
...
def add_LogicModuleServicer_to_server(servicer, server):
  rpc_method_handlers = {
      ...
      'checkObjectFederatedWithDataClayInstance': grpc.unary_unary_rpc_method_handler(
          servicer.checkObjectFederatedWithDataClayInstance,
