...
def worker():
    ...
    try:
        ### GRPC NOT SUPPORTING MULTIPROCESSING: remove line to reproduce ERRORS
        dataclay.runtime.ready_clients["@LM"] = LMClient(settings.logicmodule_host, settings.logicmodule_port)
