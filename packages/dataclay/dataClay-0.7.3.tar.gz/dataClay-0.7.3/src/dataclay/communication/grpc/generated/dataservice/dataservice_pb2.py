...
_DATASERVICE = _descriptor.ServiceDescriptor(
  ...
  _descriptor.MethodDescriptor(
    name='diskCollect',
    full_name='dataclay.communication.grpc.dataservice.DataService.diskCollect',
    index=33,
    containing_service=None,
    input_type=dataclay_dot_communication_dot_grpc_dot_messages_dot_dataservice_dot_dataservice__messages__pb2._DISKCOLLECTREQUEST,
    output_type=dataclay_dot_communication_dot_grpc_dot_messages_dot_common_dot_common__messages__pb2._EXCEPTIONINFO,
    options=None,
  ),
  _descriptor.MethodDescriptor(
