...
def ansi_to_html( text: Optional[str], lookup: Optional[AnsiHtmlScheme] = None, *, debug: bool = False ) -> str:
    ...
    html.append( '<p style="background:{}; color:{}; font-style:{}; font-family:{};">'.format( current_style.back, current_style.fore, current_style.style, current_style.family ) )
    iterations = 0
    ...
    while not parser.end():
        ...
        if code is not None:
            ...
            html.append( '</span><span style="{}">'.format( current_style.to_style() ) )
