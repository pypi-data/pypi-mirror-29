...
API_ROOT = f"https://{API_HOST}/test"
API_RESOURCE_QUERY = f"{API_ROOT}/vcfquery"
    ...
    for propname, optname, destname in names:
        ...
        if cli_value is not None:  # could be 0 or ''
            try:
                ...
                json_validation_errors.append(f"{optname}: {str(e)}")
...
def basicjson2py(typename):
    ...
    try:
        ...
        raise ValueError(f"Unsupported JSON type: '{typename}'")
