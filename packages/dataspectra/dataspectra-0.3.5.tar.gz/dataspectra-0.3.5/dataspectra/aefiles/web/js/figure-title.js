function create_title_bootstrap(figureInfo, dataArray, divid){
    ...
    document.getElementById(divid).innerHTML = `
        <div class="col-xs-12 text-left"  style="color: ` + themeElements["dark"]["titlecolor"] + `" >
...
function create_title(figureInfo, dataArray, divid){
    var geneCol = figureInfo["gene"];
    document.getElementById(divid).classList.add("panel-title");
    document.getElementById(divid).style.height = null;
    //document.getElementById(divid).style.marginBottom="20px"; #Only when margin bottom is specified.
    var matchingTerm = "no match found"
    ...
    document.getElementById(divid).innerHTML = `<p>` + searchTerm + `</p>`;
}
