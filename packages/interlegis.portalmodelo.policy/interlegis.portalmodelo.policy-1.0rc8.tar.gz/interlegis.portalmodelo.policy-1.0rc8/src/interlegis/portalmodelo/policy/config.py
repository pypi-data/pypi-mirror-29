...
#HOME_TILE_TEXT_NOTICE = u'<h2>Notas Importantes</h2><h3>Transparência</h3><p>Informações sobre transparência são constantemente auditadas pelos TCEs dos estados. Para garantir uma boa nota e estar conforme a <a href="http://www.acessoainformacao.gov.br/assuntos/conheca-seu-direito/a-lei-de-acesso-a-informacao">Lei de Acesso à Informação</a>, deve-se levar em consideração alguns itens.</p><ul><li>Preservar link de <a href="ouvidoria">Ouvidoria</a>, ou seja, não deve ser privado ou apagado. Há uma divergência sobre conceito de Ouvidoria e E-SIC. As ferramentas são as mesmas, se o site possui uma Ouvidoria que, em seu formulário de preenchimento, possui opção de pedir informações sobre "<strong>Acesso à Informação</strong>", já está conforme a lei, não necessitando de um E-SIC.</li><li><a class="internal-link" href="resolveuid/202620acd5af45b79667478892beb05a" target="_self" title=""Perguntas Frequentes</a> é um link que poucas casas preenchem e de suma importância para avaliação do TCE. Deve conter perguntas e repostas para, por exemplo, horário de funcionamento, telefone, funcionamentos de comissões, votações, etc.</li><li>A área de Transparência do portal deve ser mantida, ou seja, não deve ser privada ou apagada. Nesta, há informações para os dados abertos do portal (scripts que fazem com que os dados possam ser extraídos do portal), informações sobre licitações e contratos (que devem ser preenchidos nem que seja com uma mensagem, ex: Este mês/ano/semestre não foram feitas licitações nem contratos.)</li></ul><p>No portal há um link para a <a href="https://portal.tce.rs.gov.br/portal/page/portal/tcers/publicacoes/orientacoes_gestores/acesso_informacao_pratica.pdf">cartilha de boas práticas do TCE/RS</a>, o que publicar no portal.</p>'
