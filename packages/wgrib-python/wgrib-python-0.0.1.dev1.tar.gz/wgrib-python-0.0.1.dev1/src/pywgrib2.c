/* Dumb Python C extension wrapper around wgrib2 */
#include <stdlib.h>
...
// forward declare wgrib2 entry point
...
static PyMethodDef Methods[] = {
    {"main", py_main, METH_VARARGS, "wgrib2 main() python wrapper"},
    {"system_call", system_call, METH_VARARGS, "system() wrapper"},
    {NULL, NULL, 0, NULL}
};

PyMODINIT_FUNC initwgrib2(void) {
    (void) Py_InitModule("wgrib2", Methods);
}
