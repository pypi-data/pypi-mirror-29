...
setup(
  ...
  url='http://aliqat.readthedocs.io/en/latest/index.html',  # Use the URL to the github repo.
  download_url='https://github.com/patdaburu/aliqat/archive/{version}.tar.gz'.format(version=version),
  keywords=[
